...
["\u0477","\u0475"],["\u04c2","\u0436"],["\u04d1","\u0430"],["\u04d3","\u0430"],["\u04d7","\u0435"],["\u04db","\u04d9"],["\u04dd","\u0436"],["\u04df","\u0437"],["\u04e3","\u0438"],["\u04e5","\u0438"],["\u04e7","\u043e"],["\u04eb","\u04e9"],["\u04ed","\u044d"],["\u04ef","\u0443"],["\u04f1","\u0443"],["\u04f3","\u0443"],["\u04f5","\u0447"]];var Ba=/[^\p{L}\p{N}]+/u,Ca=/(\d{3})/g,Da=/(\D)(\d{3})/g,Ea=/(\d{3})(\D)/g,Fa="".normalize&&/[\u0300-\u036f]/g;function Ga(a){if(!this||this.constructor!==Ga){var b=Function.prototype.bind,c=b.apply,d=[null],e=d.concat;if(arguments instanceof Array)var g=arguments;else{g=w(arguments);for(var f,h=[];!(f=g.next()).done;)h.push(f.value);g=h}return new (c.call(b,Ga,e.call(d,g)))}for(b=0;b<arguments.length;b++)this.assign(arguments[b])}u=Ga.prototype;
...
m){for(q=m-1;0<q;q--)p=l[q]+p,r=this.score?this.score(b,l,k,p,q):Jb(h,d,k,m,q),Kb(this,g,p,r,a,c);p=""}case "forward":if(1<m){for(q=0;q<m;q++)p+=l[q],Kb(this,g,p,n,a,c);break}default:if(Kb(this,g,l,n,a,c),f&&1<d&&k<d-1)for(m=J(),p=this.da,n=l,q=Math.min(f+1,d-k),r=m[n]=1;r<q;r++)if((l=b[this.rtl?d-1-k-r:k+r])&&!m[l]){m[l]=1;var x=this.score?this.score(b,n,k,l,r):Jb(p+(d/2>p?0:1),d,k,q-1,r-1),t=this.bidirectional&&l>n;Kb(this,e,t?n:l,x,a,c,t?l:n)}}}}this.fastupdate||this.reg.add(a)}else b=""}this.db&&
...
1}m||0===m||(m=t?this.da:this.resolution);if(this.db){if(this.db.search&&(a=this.db.search(this,p,b,e,h,g,k,n),!1!==a))return a;var A=this;return function(){var z,v;return ta(function(y){switch(y.h){case 1:v=z=void 0;case 2:if(!(x<q)){y.h=4;break}v=p[x];if(!v||r[v]){y.h=5;break}r[v]=1;return E(y,Nb(A,v,t,0,0,!1,!1),6);case 6:z=y.D;if(z=Ob(z,d,h,m)){d=z;y.h=4;break}t&&(h&&z&&d.length||(t=v));case 5:h&&t&&x===q-1&&!d.length&&(t="",x=-1,r=J());x++;y.h=2;break;case 4:return y.return(Pb(d,m,b,e,h,l,g))}})}()}for(c=
a=void 0;x<q;x++){if((c=p[x])&&!r[c]){r[c]=1;a=Nb(this,c,t,0,0,!1,!1);if(a=Ob(a,d,h,m)){d=a;break}t&&(h&&a&&d.length||(t=c))}h&&t&&x===q-1&&!d.length&&(t="",x=-1,r=J())}return Pb(d,m,b,e,h,l,g)};function Pb(a,b,c,d,e,g,f){var h=a.length,k=a;if(1<h)k=ib(a,b,c,d,e,g,f);else if(1===h)return f?lb.call(null,a[0],c,d):new Y(a[0]);return f?k:new Y(k)}
...
function Xb(a){return new Promise(function(b,c){a.onsuccess=function(){b(this.result)};a.oncomplete=function(){b(this.result)};a.onerror=c;a=null})};var Zb={Index:R,Charset:Hb,Encoder:Ga,Document:W,Worker:Ra,Resolver:Y,IndexedDB:Ub,Language:{}},$b="undefined"!==typeof self?self:"undefined"!==typeof global?global:"undefined"!==typeof window?window:{},ac;(ac=$b.define)&&ac.amd?ac([],function(){return Zb}):"object"===typeof $b.exports?$b.exports=Zb:$b.FlexSearch=Zb;}(this||self));

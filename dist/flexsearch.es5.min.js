...
typeof window?window._factory:null;c&&(c=c.toString());var d="undefined"===typeof window,e=this,h=rb(c,d,a.worker);h.worker=!0;return h.then?h.then(function(f){return b.call(e,f)}):b.call(this,h)}sb("add");sb("append");sb("search");sb("update");sb("remove");

...
this.G(f)}};b.prototype.ga=function(f){var g=void 0;try{g=f.then}catch(k){this.F(k);return}"function"==typeof g?this.ka(g,f):this.G(f)};b.prototype.F=function(f){this.ca(2,f)};b.prototype.G=function(f){this.ca(1,f)};b.prototype.ca=function(f,g){if(0!=this.A)throw Error("Cannot settle("+f+", "+g+"): Promise already settled in state"+this.A);this.A=f;this.B=g;2===this.A&&this.ia();this.ea()};b.prototype.ia=function(){var f=this;e(function(){if(f.fa()){var g=B.console;"undefined"!==typeof g&&g.error(f.B)}},
...
while(!k.done)})};return b});function ta(a,b){a instanceof String&&(a+="");var c=0,d=!1,e={next:function(){if(!d&&c<a.length){var h=c++;return{value:b(h,a[h]),done:!1}}d=!0;return{done:!0,value:void 0}}};e[Symbol.iterator]=function(){return e};return e}C("Array.prototype.values",function(a){return a?a:function(){return ta(this,function(b,c){return c})}});function J(a,b){return Object.prototype.hasOwnProperty.call(a,b)}
C("WeakMap",function(a){function b(k){this.h=(g+=Math.random()+1).toString();if(k){k=w(k);for(var l;!(l=k.next()).done;)l=l.value,this.set(l[0],l[1])}}function c(){}function d(k){var l=typeof k;return"object"===l&&null!==k||"function"===l}function e(k){if(!J(k,f)){var l=new c;ba(k,f,{value:l})}}function h(k){var l=Object[k];l&&(Object[k]=function(m){if(m instanceof c)return m;Object.isExtensible(m)&&e(m);return l(m)})}if(function(){if(!a||!Object.seal)return!1;try{var k=Object.seal({}),l=Object.seal({}),
...
m.value,g.call(k,m[1],m[0],this)};e.prototype[Symbol.iterator]=e.prototype.entries;var f=0;return e});C("Array.prototype.keys",function(a){return a?a:function(){return ta(this,function(b){return b})}});
...
b.prototype.values;b.prototype.forEach=function(c,d){var e=this;this.h.forEach(function(h){return c.call(d,h,h,e)})};return b});C("Array.prototype.entries",function(a){return a?a:function(){return ta(this,function(b,c){return[b,c]})}});C("Object.is",function(a){return a?a:function(b,c){return b===c?0!==b||1/b===1/c:b!==b&&c!==c}});
C("Array.prototype.includes",function(a){return a?a:function(b,c){var d=this;d instanceof String&&(d=String(d));var e=d.length;c=c||0;for(0>c&&(c=Math.max(c+e,0));c<e;c++){var h=d[c];if(h===b||Object.is(h,b))return!0}return!1}});
...
["\u0477","\u0475"],["\u04c2","\u0436"],["\u04d1","\u0430"],["\u04d3","\u0430"],["\u04d7","\u0435"],["\u04db","\u04d9"],["\u04dd","\u0436"],["\u04df","\u0437"],["\u04e3","\u0438"],["\u04e5","\u0438"],["\u04e7","\u043e"],["\u04eb","\u04e9"],["\u04ed","\u044d"],["\u04ef","\u0443"],["\u04f1","\u0443"],["\u04f3","\u0443"],["\u04f5","\u0447"]];var Aa=/[^\p{L}\p{N}]+/u,Ba=/(\d{3})/g,Ca=/(\D)(\d{3})/g,Da=/(\d{3})(\D)/g,Ea="".normalize&&/[\u0300-\u036f]/g;function Fa(a){if(!this){var b=Function.prototype.bind,c=b.apply,d=[null],e=d.concat;if(arguments instanceof Array)var h=arguments;else{h=w(arguments);for(var f,g=[];!(f=h.next()).done;)g.push(f.value);h=g}return new (c.call(b,Fa,e.call(d,h)))}for(b=0;b<arguments.length;b++)this.assign(arguments[b])}
Fa.prototype.assign=function(a){this.normalize=L(a.normalize,!0,this.normalize);var b=a.include,c=b||a.exclude||a.split;if("object"===typeof c){var d=!b,e="";a.include||(e+="\\p{Z}");c.letter&&(e+="\\p{L}");c.number&&(e+="\\p{N}",d=!!b);c.symbol&&(e+="\\p{S}");c.punctuation&&(e+="\\p{P}");c.control&&(e+="\\p{C}");if(c=c.char)e+="object"===typeof c?c.join(""):c;try{this.split=new RegExp("["+(b?"^":"")+e+"]+","u")}catch(h){this.split=/\s+/}this.numeric=d}else{try{this.split=L(c,Aa,this.split)}catch(h){this.split=
/\s+/}this.numeric=L(this.numeric,!0)}this.prepare=L(a.prepare,null,this.prepare);this.finalize=L(a.finalize,null,this.finalize);Ea||(this.mapper=new Map(za));this.rtl=a.rtl||!1;this.dedupe=L(a.dedupe,!0,this.dedupe);this.filter=L((c=a.filter)&&new Set(c),null,this.filter);this.matcher=L((c=a.matcher)&&new Map(c),null,this.matcher);this.mapper=L((c=a.mapper)&&new Map(c),null,this.mapper);this.stemmer=L((c=a.stemmer)&&new Map(c),null,this.stemmer);this.replacer=L(a.replacer,null,this.replacer);this.minlength=
L(a.minlength,1,this.minlength);this.maxlength=L(a.maxlength,0,this.maxlength);if(this.cache=c=L(a.cache,!0,this.cache))this.U=null,this.L="number"===typeof c?c:2E5,this.N=new Map,this.S=new Map,this.A=this.h=128;this.B="";this.F=null;this.C="";this.G=null;if(this.matcher)for(a=w(this.matcher.keys()),b=a.next();!b.done;b=a.next())this.B+=(this.B?"|":"")+b.value;if(this.stemmer)for(a=w(this.stemmer.keys()),b=a.next();!b.done;b=a.next())this.C+=(this.C?"|":"")+b.value;return this};
Fa.prototype.encode=function(a){var b=this;if(this.cache&&a.length<=this.h)if(this.U){if(this.N.has(a))return this.N.get(a)}else this.U=setTimeout(Ga,50,this);this.normalize&&(a="function"===typeof this.normalize?this.normalize(a):Ea?a.normalize("NFKD").replace(Ea,"").toLowerCase():a.toLowerCase());this.prepare&&(a=this.prepare(a));this.numeric&&3<a.length&&(a=a.replace(Ca,"$1 $2").replace(Da,"$1 $2").replace(Ba,"$1 "));for(var c=!(this.dedupe||this.mapper||this.filter||this.matcher||this.stemmer||
this.replacer),d=[],e=this.split||""===this.split?a.split(this.split):a,h=0,f=void 0,g=void 0;h<e.length;h++)if((f=g=e[h])&&!(f.length<this.minlength))if(c)d.push(f);else if(!this.filter||!this.filter.has(f)){if(this.cache&&f.length<=this.A)if(this.U){var k=this.S.get(f);if(k||""===k){k&&d.push(k);continue}}else this.U=setTimeout(Ga,50,this);k=void 0;this.stemmer&&2<f.length&&(this.G||(this.G=new RegExp("(?!^)("+this.C+")$")),f=f.replace(this.G,function(q){return b.stemmer.get(q)}),k=1);f&&k&&(f.length<
...
this.replacer[k+1]);this.cache&&g.length<=this.A&&(this.S.set(g,f),this.S.size>this.L&&(this.S.clear(),this.A=this.A/1.1|0));f&&d.push(f)}this.finalize&&(d=this.finalize(d)||d);this.cache&&a.length<=this.h&&(this.N.set(a,d),this.N.size>this.L&&(this.N.clear(),this.h=this.h/1.1|0));return d};function Ga(a){a.U=null;a.N.clear();a.S.clear()};function Ha(a){var b,c,d,e,h,f,g,k;return I(function(l){a=a.data;b=self._index;c=a.args;d=a.task;switch(d){case "init":e=a.options||{};(h=e.config)&&(e=(await import(h))["default"]);(f=a.factory)?(Function("return "+f)()(self),self._index=new self.FlexSearch.Index(e),delete self.FlexSearch):self._index=new R(e);postMessage({id:a.id});break;default:g=a.id,k=b[d].apply(b,c),postMessage("search"===d?{id:g,msg:k}:{id:g})}l.h=0})};var Ia=0;
function Ja(a){function b(f){function g(k){k=k.data||k;var l=k.id,m=l&&e.h[l];m&&(m(k.msg),delete e.h[l])}this.worker=f;this.h=M();if(this.worker){d?this.worker.on("message",g):this.worker.onmessage=g;if(a.config)return new Promise(function(k){e.h[++Ia]=function(){k(e)};e.worker.postMessage({id:Ia,task:"init",factory:c,options:a})});this.worker.postMessage({task:"init",factory:c,options:a});return this}}a=void 0===a?{}:a;if(!this)return new Ja(a);var c="undefined"!==typeof self?self._factory:"undefined"!==
typeof window?window._factory:null;c&&(c=c.toString());var d="undefined"===typeof window,e=this,h=Ka(c,d,a.worker);return h.then?h.then(function(f){return b.call(e,f)}):b.call(this,h)}La("add");La("append");La("search");La("update");La("remove");
function La(a){Ja.prototype[a]=Ja.prototype[a+"Async"]=function(){var b=this,c=arguments,d,e,h,f,g;return I(function(k){d=b;e=[].slice.call(c);h=e[e.length-1];"function"===typeof h&&(f=h,e.splice(e.length-1,1));g=new Promise(function(l){d.h[++Ia]=l;d.worker.postMessage({task:a,id:Ia,args:e})});return f?(g.then(f),k.return(b)):k.return(g)})}}
function Ka(a,b,c){return b?"undefined"!==typeof module?new (require("worker_threads")["Worker"])(__dirname + "/node/node.js"):import("worker_threads").then(function(worker){ return new worker["Worker"]((1,eval)("import.meta.dirname") + "/node/node.mjs"); }):a?new window.Worker(URL.createObjectURL(new Blob(["onmessage="+Ha.toString()],{type:"text/javascript"}))):new window.Worker(N(c)?c:(0,eval)("import.meta.url").replace("/worker.js","/worker/worker.js").replace("flexsearch.bundle.module.min.js",
"module/worker/worker.js"),{type:"module"})};function Ma(a){Na.call(a,"add");Na.call(a,"append");Na.call(a,"search");Na.call(a,"update");Na.call(a,"remove")}function Na(a){this[a+"Async"]=function(){var b=arguments,c=b[b.length-1];if("function"===typeof c){var d=c;delete b[b.length-1]}b=this[a].apply(this,b);d&&(b.then?b.then(d):d(b));return b}};function Oa(a,b,c,d,e,h,f,g){(d=a(c?c+"."+d:d,JSON.stringify(f)))&&d.then?d.then(function(){b.export(a,b,c,e,h+1,g)}):b.export(a,b,c,e,h+1,g)};function Pa(a,b,c,d){for(var e=[],h=0,f;h<a.index.length;h++)if(f=a.index[h],b>=f.length)b-=f.length;else{b=f[d?"splice":"slice"](b,c);if(f=b.length)if(e=e.length?e.concat(b):b,c-=f,d&&(a.length-=f),!c)break;b=0}return e}
...
d)return function(e){for(var h=0;h<b.index.length;h++)if(b.index[h].includes(e))return!0;return!1};if("slice"===d)return function(e,h){return Pa(b,e||0,h||b.length,!1)};if("splice"===d)return function(e,h){return Pa(b,e||0,h||b.length,!0)};if("constructor"===d)return Array;if("symbol"!==typeof d)return(c=b.index[d/Math.pow(2,31)|0])&&c[d]},set:function(c,d,e){c=d/Math.pow(2,31)|0;(b.index[c]||(b.index[c]=[]))[d]=e;b.length++;return!0}})}S.prototype.clear=function(){this.index.length=0};
S.prototype.destroy=function(){this.proxy=this.index=null};S.prototype.push=function(){};function T(a){a=void 0===a?8:a;if(!this)return new T(a);this.index=M();this.B=[];this.size=0;32<a?(this.h=Qa,this.A=BigInt(a)):(this.h=Ra,this.A=a)}T.prototype.get=function(a){var b=this.h(a);return(b=this.index[b])&&b.get(a)};T.prototype.set=function(a,b){var c=this.h(a),d=this.index[c];d?(c=d.size,d.set(a,b),(c-=d.size)&&this.size++):(this.index[c]=d=new Map([[a,b]]),this.B.push(d))};
function U(a){a=void 0===a?8:a;if(!this)return new U(a);this.index=M();this.h=[];32<a?(this.B=Qa,this.A=BigInt(a)):(this.B=Ra,this.A=a)}U.prototype.add=function(a){var b=this.B(a),c=this.index[b];c?(b=c.size,c.add(a),(b-=c.size)&&this.size++):(this.index[b]=c=new Set([a]),this.h.push(c))};t=T.prototype;t.has=U.prototype.has=function(a){var b=this.B(a);return(b=this.index[b])&&b.has(a)};t.delete=U.prototype.delete=function(a){var b=this.B(a);(b=this.index[b])&&b.delete(a)&&this.size--};
t.clear=U.prototype.clear=function(){this.index=M();this.h=[];this.size=0};t.values=U.prototype.values=function Sa(){var b,c=this,d,e,h;return qa(Sa,function(f){switch(f.h){case 1:b=0;case 2:if(!(b<c.h.length)){f.h=0;break}d=w(c.h[b].values());e=d.next();case 5:if(e.done){b++;f.h=2;break}h=e.value;return G(f,h,6);case 6:e=d.next(),f.h=5}})};
t.keys=U.prototype.keys=function Ta(){var b,c=this,d,e,h;return qa(Ta,function(f){switch(f.h){case 1:b=0;case 2:if(!(b<c.h.length)){f.h=0;break}d=w(c.h[b].keys());e=d.next();case 5:if(e.done){b++;f.h=2;break}h=e.value;return G(f,h,6);case 6:e=d.next(),f.h=5}})};
t.entries=U.prototype.entries=function Ua(){var b,c=this,d,e,h;return qa(Ua,function(f){switch(f.h){case 1:b=0;case 2:if(!(b<c.h.length)){f.h=0;break}d=w(c.h[b].entries());e=d.next();case 5:if(e.done){b++;f.h=2;break}h=e.value;return G(f,h,6);case 6:e=d.next(),f.h=5}})};function Ra(a){var b=Math.pow(2,this.A)-1;if("number"==typeof a)return a&b;for(var c=0,d=this.A+1,e=0;e<a.length;e++)c=(c*d^a.charCodeAt(e))&b;return 32===this.A?c+Math.pow(2,31):c}
function Qa(){throw Error("The keystore is limited to 32 for EcmaScript5");};V.prototype.add=function(a,b,c){O(a)&&(b=a,a=xa(b,this.key));if(b&&(a||0===a)){if(!c&&this.reg.has(a))return this.update(a,b);for(var d=0,e;d<this.field.length;d++){e=this.I[d];var h=this.index.get(this.field[d]);if("function"===typeof e)(e=e(b))&&h.add(a,e,!1,!0);else{var f=e.R;if(!f||f(b))e.constructor===String?e=[""+e]:N(e)&&(e=[e]),Va(b,e,this.T,0,h,a,e[0],c)}}if(this.tag)for(d=0;d<this.M.length;d++){f=this.M[d];h=this.tag.get(this.$[d]);e=M();if("function"===typeof f){if(f=f(b),!f)continue}else{var g=
f.R;if(g&&!g(b))continue;f.constructor===String&&(f=""+f);f=xa(b,f)}if(h&&f){N(f)&&(f=[f]);g=0;for(var k,l=void 0;g<f.length;g++)if(k=f[g],!e[k]){e[k]=1;var m;(m=h.get(k))?l=m:h.set(k,l=[]);if(!c||!l.includes(a)){if(l.length===Math.pow(2,31)-1){m=new S(l);if(this.fastupdate)for(var n=w(this.reg.values()),p=n.next();!p.done;p=n.next())p=p.value,p.includes(l)&&(p[p.indexOf(l)]=m);h.set(k,l=m)}l.push(a);this.fastupdate&&((k=this.reg.get(a))?k.push(l):this.reg.set(a,[l]))}}}}if(this.store&&(!c||!this.store.has(a))){if(this.H){var q=
M();for(c=0;c<this.H.length;c++)if(d=this.H[c],h=d.R,!h||h(b)){h=void 0;if("function"===typeof d){h=d(b);if(!h)continue;d=[d.la]}else if(N(d)||d.constructor===String){q[d]=b[d];continue}Wa(b,q,d,0,d[0],h)}}this.store.set(a,q||b)}}return this};function Wa(a,b,c,d,e,h){a=a[e];if(d===c.length-1)b[e]=h||a;else if(a)if(a.constructor===Array)for(b=b[e]=Array(a.length),e=0;e<a.length;e++)Wa(a,b,c,d,e);else b=b[e]||(b[e]=M()),e=c[++d],Wa(a,b,c,d,e)}
function Va(a,b,c,d,e,h,f,g){if(a=a[f])if(d===b.length-1){if(a.constructor===Array){if(c[d]){for(b=0;b<a.length;b++)e.add(h,a[b],!0,!0);return}a=a.join(" ")}e.add(h,a,g,!0)}else if(a.constructor===Array)for(f=0;f<a.length;f++)Va(a,b,c,d,e,h,f,g);else f=b[++d],Va(a,b,c,d,e,h,f,g);else e.db&&e.remove(h)};function Xa(a,b,c,d,e,h,f){var g=a.length,k=[],l;var m=M();for(var n=0,p=void 0,q;n<b;n++)for(var r=0;r<g;r++)if(q=a[r],n<q.length&&(p=q[n]))for(var v=0;v<p.length;v++){q=p[v];(l=m[q])?m[q]++:(l=0,m[q]=1);l=k[l]||(k[l]=[]);if(!f){var x=n+(r?0:h||0);l=l[x]||(l[x]=[])}l.push(q)}if(a=k.length)if(e)k=1<k.length?Ya(k,d,c,f,0):k[0];else{if(a<g)return[];k=k[a-1];if(c||d)if(f){if(k.length>c||d)k=k.slice(d,c+d)}else{e=[];for(f=0;f<k.length;f++)if(g=k[f],g.length>d)d-=g.length;else{if(g.length>c||d)g=g.slice(d,
c+d),c-=g.length,d&&(d-=g.length);e.push(g);if(!c)break}return 1<e.length?[].concat.apply([],e):e[0]}}return k}
...
function Za(a,b){for(var c=M(),d=[],e=0,h;e<b.length;e++){h=b[e];for(var f=0;f<h.length;f++)c[h[f]]=1}for(b=0;b<a.length;b++)e=a[b],1===c[e]&&(d.push(e),c[e]=2);return d};V.prototype.search=function(a,b,c,d){c||(!b&&O(a)?(c=a,a=""):O(b)&&(c=b,b=0));var e=[],h=[],f=0;if(c){c.constructor===Array&&(c={index:c});a=c.query||a;var g=c.pluck;var k=c.merge;var l=g||c.field||c.index;var m=this.tag&&c.tag;var n=this.store&&c.enrich;var p=c.suggest;var q=c.na;b=c.limit||b;var r=c.offset||0;b||(b=100);if(m&&(!this.db||!d)){m.constructor!==Array&&(m=[m]);for(var v=[],x=0,y=void 0;x<m.length;x++)if(y=m[x],y.field&&y.tag){var u=y.tag;if(u.constructor===Array)for(var z=0;z<u.length;z++)v.push(y.field,
u[z]);else v.push(y.field,u)}else{u=Object.keys(y);z=0;for(var A=void 0,D=void 0;z<u.length;z++)if(A=u[z],D=y[A],D.constructor===Array)for(var F=0;F<D.length;F++)v.push(A,D[F]);else v.push(A,D)}m=v;if(!a){h=[];if(v.length)for(g=0;g<v.length;g+=2){p=void 0;if(this.db){p=this.index.get(v[g]);if(!p)continue;h.push(p=p.db.tag(v[g+1],b,r,n))}else p=ab.call(this,v[g],v[g+1],b,r,n);e.push({field:v[g],tag:v[g+1],result:p})}return h.length?Promise.all(h).then(function(P){for(var Q=0;Q<P.length;Q++)e[Q].result=
P[Q];return e}):e}}N(l)&&(l=[l])}l||(l=this.field);v=!d&&(this.worker||this.db)&&[];x=0;for(z=y=u=void 0;x<l.length;x++)if(y=l[x],!this.db||!this.tag||this.I[x]){u=void 0;N(y)||(u=y,y=u.field,a=u.query||a,b=u.limit||b,r=u.offset||r,p=u.suggest||p,n=this.store&&(u.enrich||n));if(d)u=d[x];else{z=u||c;u=this.index.get(y);if(m){if(this.db){z.tag=m;var E=u.db.support_tag_search;z.field=l}E||(z.enrich=!1)}if(v){v[x]=u.search(a,b,z);z&&n&&(z.enrich=n);continue}else u=u.search(a,b,z),z&&n&&(z.enrich=n)}z=
u&&u.length;if(m&&z){A=[];D=0;if(this.db&&d){if(!E)for(F=l.length;F<d.length;F++){var K=d[F];if(K&&K.length)D++,A.push(K);else if(!p)return e}}else{F=0;for(var Hb=K=void 0;F<m.length;F+=2){K=this.tag.get(m[F]);if(!K)if(p)continue;else return e;if(Hb=(K=K&&K.get(m[F+1]))&&K.length)D++,A.push(K);else if(!p)return e}}if(D){u=Za(u,A);z=u.length;if(!z&&!p)return e;D--}}if(z)h[f]=y,e.push(u),f++;else if(1===l.length)return e}if(v){if(this.db&&m&&m.length&&!E)for(n=0;n<m.length;n+=2){h=this.index.get(m[n]);
if(!h)if(p)continue;else return e;v.push(h.db.tag(m[n+1],b,r,!1))}var Ib=this;return Promise.all(v).then(function(P){return P.length?Ib.search(a,b,c,P):P})}if(!f)return e;if(g&&(!n||!this.store))return e[0];v=[];r=0;for(p=void 0;r<h.length;r++){p=e[r];n&&p.length&&!p[0].doc&&(this.db?v.push(p=this.index.get(this.field[0]).db.enrich(p)):p.length&&(p=bb.call(this,p)));if(g)return p;e[r]={field:h[r],result:p}}if(n&&this.db&&v.length){var $a=this;return Promise.all(v).then(function(P){for(var Q=0;Q<P.length;Q++)e[Q].result=
P[Q];return k?cb(e,b):q?db(e,a,$a.index,$a.I,q):e})}return k?cb(e,b):q?db(e,a,this.index,this.I,q):e};function db(a,b,c,d,e){for(var h,f=0,g,k,l;f<a.length;f++)for(g=a[f].result,k=a[f].field,l=c.get(k).encoder,k=d[k.indexOf(k)],l!==h&&(h=l,h.encode(b)),l=0;l<g.length;l++){for(var m="",n=xa(g[l].doc,k),p=h.encode(n),q=0;q<p.length;q++)m+=p[q].replace(new RegExp("("+p[q]+")","g"),e.replace("$1",n));console.log(a,c,e);g[l].na=m}return a}
function cb(a,b){for(var c=[],d=M(),e=0,h,f;e<a.length;e++){h=a[e];f=h.result;for(var g=0,k,l,m;g<f.length;g++)if(l=f[g],k=l.id,m=d[k])m.push(h.field);else{if(c.length===b)return c;l.field=d[k]=[h.field];c.push(l)}}return c}function ab(a,b,c,d,e){a=this.tag.get(a);if(!a)return[];if((b=(a=a&&a.get(b))&&a.length-d)&&0<b){if(b>c||d)a=a.slice(d,d+c);e&&(a=bb.call(this,a));return a}}function bb(a){for(var b=Array(a.length),c=0,d;c<a.length;c++)d=a[c],b[c]={id:d,doc:this.store.get(d)};return b};function V(a){if(!this)return new V(a);var b=a.document||a.doc||a,c,d;this.I=[];this.field=[];this.T=[];this.key=(c=b.key||b.id)&&eb(c,this.T)||"id";(d=a.keystore||0)&&(this.keystore=d);this.reg=(this.fastupdate=!!a.fastupdate)?d?new T(d):new Map:d?new U(d):new Set;this.H=(c=b.store||null)&&!0!==c&&[];this.store=c&&(d?new T(d):new Map);this.cache=(c=a.cache||null)&&new W(c);a.cache=!1;this.worker=a.worker;this.index=fb.call(this,a,b);this.tag=null;if(c=b.tag)if("string"===typeof c&&(c=[c]),c.length){this.tag=
...
0,k=w(h.index.entries()),l=k.next();!l.done;l=k.next()){l=l.value;var m=l[0];l[1].then&&h.index.set(m,f[g++])}return h})}}else a.db&&this.mount(a.db)}t=V.prototype;
...
t.commit=function(a,b){var c=this,d,e,h,f;return I(function(g){if(1==g.h){d=[];e=w(c.index.values());for(h=e.next();!h.done;h=e.next())f=h.value,d.push(f.db.commit(f,a,b));return G(g,Promise.all(d),2)}c.reg.clear();g.h=0})};t.destroy=function(){for(var a=[],b=w(this.index.values()),c=b.next();!c.done;c=b.next())a.push(c.value.destroy());return Promise.all(a)};
...
t.get=function(a){return this.db?this.index.get(this.field[0]).db.enrich(a).then(function(b){return b[0]&&b[0].doc}):this.store.get(a)};t.set=function(a,b){this.store.set(a,b);return this};t.searchCache=gb;
t.export=function(a,b,c,d,e,h){var f;"undefined"===typeof h&&(f=new Promise(function(k){h=k}));e||(e=0);d||(d=0);if(d<this.field.length){c=this.field[d];var g=this.index[c];b=this;g.export(a,b,e?c:"",d,e++,h)||(d++,b.export(a,b,c,d,1,h))}else{switch(e){case 1:b="tag";g=this.A;c=null;break;case 2:b="store";g=this.store;c=null;break;default:h();return}Oa(a,this,c,b,d,e,g,h)}return f};
t.import=function(a,b){if(b)switch(N(b)&&(b=JSON.parse(b)),a){case "tag":this.A=b;break;case "reg":this.fastupdate=!1;this.reg=b;a=0;for(var c;a<this.field.length;a++)c=this.index[this.field[a]],c.reg=b,c.fastupdate=!1;break;case "store":this.store=b;break;default:a=a.split("."),c=a[0],a=a[1],c&&a&&this.index[c].import(a,b)}};Ma(V.prototype);function gb(a,b,c){a=("object"===typeof a?""+a.query:a).toLowerCase();var d=this.cache.get(a);if(!d){d=this.search(a,b,c);if(d.then){var e=this;d.then(function(h){e.cache.set(a,h);return h})}this.cache.set(a,d)}return d}function W(a){this.limit=a&&!0!==a?a:1E3;this.cache=new Map;this.h=""}W.prototype.set=function(a,b){this.cache.set(this.h=a,b);this.cache.size>this.limit&&this.cache.delete(this.cache.keys().next().value)};
...
R.prototype.search=function(a,b,c){c||(!b&&O(a)?(c=a,a=""):O(b)&&(c=b,b=0));var d=[],e=0,h;if(c){a=c.query||a;b=c.limit||b;e=c.offset||0;var f=c.context;var g=c.suggest;(h=zb&&!1!==c.resolve)||(zb=0);var k=h&&c.enrich;var l=c.boost;var m=this.db&&c.tag}else h=this.resolve||zb;a=this.encoder.encode(a);var n=a.length;b||!h||(b=100);if(1===n)return Ab.call(this,a[0],"",b,e,h,k,m);f=this.depth&&!1!==f;if(2===n&&f&&!g)return Ab.call(this,a[0],a[1],b,e,h,k,m);var p=c=0;if(1<n){for(var q=M(),r=[],v=0,x=
void 0;v<n;v++)if((x=a[v])&&!q[x]){if(g||this.db||Z(this,x))r.push(x),q[x]=1;else return h?d:new Y(d);x=x.length;c=Math.max(c,x);p=p?Math.min(p,x):x}a=r;n=a.length}if(!n)return h?d:new Y(d);var y=0;if(1===n)return Ab.call(this,a[0],"",b,e,h,k,m);if(2===n&&f&&!g)return Ab.call(this,a[0],a[1],b,e,h,k,m);if(1<n)if(f){var u=a[0];y=1}else 9<c&&3<c/p&&a.sort(va);if(this.db){if(this.db.search&&(f=this.db.search(this,a,b,e,g,h,k,m),!1!==f))return f;var z=this;return function(){var A,D,F;return I(function(E){switch(E.h){case 1:D=
A=void 0;case 2:if(!(y<n)){E.h=4;break}D=a[y];return u?G(E,Z(z,D,u,0,0,!1,!1),8):G(E,Z(z,D,"",0,0,!1,!1),7);case 7:A=E.F;A=Bb(A,d,g,z.resolution);E.h=6;break;case 8:A=E.F,A=Bb(A,d,g,z.aa),g&&!1===A&&d.length||(u=D);case 6:if(A)return E.return(A);if(g&&y===n-1){F=d.length;if(!F){if(u){u="";y=-1;E.h=3;break}return E.return(d)}if(1===F)return E.return(h?X(d[0],b,e):new Y(d[0]))}case 3:y++;E.h=2;break;case 4:return E.return(h?Xa(d,z.resolution,b,e,g,l,h):new Y(d[0]))}})}()}for(k=f=void 0;y<n;y++){k=a[y];
u?(f=Z(this,k,u,0,0,!1,!1),f=Bb(f,d,g,this.aa),g&&!1===f&&d.length||(u=k)):(f=Z(this,k,"",0,0,!1,!1),f=Bb(f,d,g,this.resolution));if(f)return f;if(g&&y===n-1){f=d.length;if(!f){if(u){u="";y=-1;continue}return d}if(1===f)return h?X(d[0],b,e):new Y(d[0])}}d=Xa(d,this.resolution,b,e,g,l,h);return h?d:new Y(d)};
...
function Db(a){var b=0;if(a.constructor===Array)for(var c=0,d=void 0;c<a.length;c++)(d=a[c])&&(b+=d.length);else for(c=w(a),d=c.next();!d.done;d=c.next()){var e=d.value;d=e[0];(e=Db(e[1]))?b+=e:a.delete(d)}return b}t.cleanup=function(){if(!this.fastupdate)return this;Db(this.map);this.depth&&Db(this.ctx);return this};t.searchCache=gb;
t.export=function(a,b,c,d,e,h){var f=!0;"undefined"===typeof h&&(f=new Promise(function(n){h=n}));switch(e||(e=0)){case 0:var g="reg";if(this.fastupdate){var k=M();for(var l=w(this.reg.keys()),m=l.next();!m.done;m=l.next())k[m.value]=1}else k=this.reg;break;case 1:g="cfg";k={doc:0,opt:this.h?1:0};break;case 2:g="map";k=this.map;break;case 3:g="ctx";k=this.ctx;break;default:"undefined"===typeof c&&h&&h();return}Oa(a,b||this,c,g,d,e,k,h);return f};
t.import=function(a,b){if(b)switch(N(b)&&(b=JSON.parse(b)),a){case "cfg":this.h=!!b.opt;break;case "reg":this.fastupdate=!1;this.reg=b;break;case "map":this.map=b;break;case "ctx":this.ctx=b}};
...
b+d+e+"}":b+d+e};Ma(R.prototype);var Eb="undefined"!==typeof window&&(window.indexedDB||window.mozIndexedDB||window.webkitIndexedDB||window.msIndexedDB),Fb=["map","ctx","tag","reg","cfg"];
function Gb(a,b){b=void 0===b?{}:b;if(!this)return new Gb(a,b);"object"===typeof a&&(b=a=a.name);a||console.info("Default storage space was used, because a name was not passed.");this.id="flexsearch"+(a?":"+a.toLowerCase().replace(/[^a-z0-9_\-]/g,""):"");this.field=b.field?b.field.toLowerCase().replace(/[^a-z0-9_\-]/g,""):"";this.support_tag_search=!1;this.db=null;this.h={}}t=Gb.prototype;t.mount=function(a){if(!a.encoder)return a.mount(this);a.db=this;return this.open()};
...
t.close=function(){this.db.close();this.db=null};t.destroy=function(){return Eb.deleteDatabase(this.id+(this.field?":"+this.field:""))};t.clear=function(){for(var a=this.db.transaction(Fb,"readwrite"),b=0;b<Fb.length;b++)a.objectStore(Fb[b]).clear();return Jb(a)};
...
f.enrich(k):k}return g})};t.tag=function(a,b,c,d){b=void 0===b?0:b;c=void 0===c?0:c;d=void 0===d?!1:d;a=this.db.transaction("tag","readonly").objectStore("tag").get(a);var e=this;return Jb(a).then(function(h){if(!h||!h.length||c>=h.length)return[];if(!b&&!c)return h;h=h.slice(c,c+b);return d?e.enrich(h):h})};
t.enrich=function(a){"object"!==typeof a&&(a=[a]);for(var b=this.db.transaction("reg","readonly").objectStore("reg"),c=[],d=0;d<a.length;d++)c[d]=Jb(b.get(a[d]));return Promise.all(c).then(function(e){for(var h=0;h<e.length;h++)e[h]={id:a[h],doc:e[h]?JSON.parse(e[h]):null};return e})};t.has=function(a){a=this.db.transaction("reg","readonly").objectStore("reg").getKey(a);return Jb(a)};t.search=null;t.info=function(){};
...
t.commit=function(a,b,c){var d=this,e,h,f;return I(function(g){switch(g.h){case 1:if(b)return G(g,d.clear(),12);e=a.commit_task;a.commit_task=[];h=0;f=void 0;case 4:if(!(h<e.length)){g.h=6;break}f=e[h];if(!f.clear){e[h]=f.pa;g.h=5;break}return G(g,d.clear(),8);case 8:b=!0;g.h=6;break;case 5:h++;g.h=4;break;case 6:if(b){g.h=3;break}c||(e=e.concat(wa(a.reg)));if(!e.length){g.h=10;break}return G(g,d.remove(e),11);case 11:case 10:g.h=3;break;case 12:a.commit_task=[];case 3:return a.reg.size?G(g,d.transaction("map",
"readwrite",function(k){for(var l=w(a.map),m=l.next(),n={};!m.done;n={O:void 0,Y:void 0},m=l.next())m=m.value,n.Y=m[0],n.O=m[1],n.O.length&&(b?k.put(n.O,n.Y):k.get(n.Y).onsuccess=function(p){return function(){var q=this.result,r;if(q&&q.length)for(var v=Math.max(q.length,p.O.length),x=0,y;x<v;x++){if((y=p.O[x])&&y.length){if((r=q[x])&&r.length)for(var u=0;u<y.length;u++)r.push(y[u]);else q[x]=y;r=1}}else q=p.O,r=1;r&&k.put(q,p.Y)}}(n))}),13):g.return();case 13:return G(g,d.transaction("ctx","readwrite",
function(k){for(var l=w(a.ctx),m=l.next(),n={};!m.done;n={W:void 0},m=l.next()){m=m.value;n.W=m[0];m=w(m[1]);for(var p=m.next(),q={};!p.done;q={P:void 0,Z:void 0},p=m.next())p=p.value,q.Z=p[0],q.P=p[1],q.P.length&&(b?k.put(q.P,n.W+":"+q.Z):k.get(n.W+":"+q.Z).onsuccess=function(r,v){return function(){var x=this.result,y;if(x&&x.length)for(var u=Math.max(x.length,r.P.length),z=0,A;z<u;z++){if((A=r.P[z])&&A.length){if((y=x[z])&&y.length)for(var D=0;D<A.length;D++)y.push(A[D]);else x[z]=A;y=1}}else x=
r.P,y=1;y&&k.put(x,v.W+":"+r.Z)}}(q,n))}}),14);case 14:if(a.store)return G(g,d.transaction("reg","readwrite",function(k){for(var l=w(a.store),m=l.next();!m.done;m=l.next()){var n=m.value;m=n[0];n=n[1];k.put("object"===typeof n?JSON.stringify(n):1,m)}}),16);if(a.bypass){g.h=16;break}return G(g,d.transaction("reg","readwrite",function(k){for(var l=w(a.reg.keys()),m=l.next();!m.done;m=l.next())k.put(1,m.value)}),16);case 16:if(!a.tag){g.h=20;break}return G(g,d.transaction("tag","readwrite",function(k){for(var l=
...
function Jb(a){return new Promise(function(b,c){a.onsuccess=function(){b(this.result)};a.oncomplete=function(){b(this.result)};a.onerror=c;a=null})};var Lb={Index:R,Charset:pb,Encoder:Fa,Document:V,Worker:Ja,Resolver:Y,IndexedDB:Gb,Language:{}},Mb=self,Nb;(Nb=Mb.define)&&Nb.amd?Nb([],function(){return Lb}):"object"===typeof Mb.exports?Mb.exports=Lb:Mb.FlexSearch=Lb;}(this||self));

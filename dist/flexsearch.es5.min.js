...
0;f&&k<this.replacer.length;k+=2)f=f.replace(this.replacer[k],this.replacer[k+1]);this.cache&&h.length<=this.H&&(this.C.set(h,f),this.C.size>this.T&&(this.C.clear(),this.H=this.H/1.1|0));f&&d.push(f)}this.finalize&&(d=this.finalize(d)||d);this.cache&&a.length<=this.G&&(this.B.set(a,d),this.B.size>this.T&&(this.B.clear(),this.G=this.G/1.1|0));return d};function N(a){a.D=null;a.B.clear();a.C.clear()};var O,Ha;
...
var c="undefined"!==typeof self?self._factory:"undefined"!==typeof window?window._factory:null;c&&(c=c.toString());var d="undefined"===typeof window,e=this,g=Ta(c,d,a.worker);return g.then?g.then(function(f){return b.call(e,f)}):b.call(this,g)}S("add");S("append");S("search");S("update");S("remove");S("clear");S("export");S("import");La(Sa.prototype);
function S(a){Sa.prototype[a]=function(){var b=this,c=[].slice.call(arguments),d=c[c.length-1];if("function"===typeof d){var e=d;c.pop()}d=new Promise(function(g){"export"===a&&"function"===typeof c[0]&&(c[0]=null);b.h[++Ra]=g;b.worker.postMessage({task:a,id:Ra,args:c})});return e?(d.then(e),this):d}}
...
T.prototype.clear=function(){this.index.length=0};T.prototype.destroy=function(){this.proxy=this.index=null};T.prototype.push=function(){};function U(a){a=void 0===a?8:a;if(!this||this.constructor!==U)return new U(a);this.index=J();this.h=[];this.size=0;32<a?(this.A=cb,this.B=BigInt(a)):(this.A=db,this.B=a)}U.prototype.get=function(a){var b=this.A(a);return(b=this.index[b])&&b.get(a)};
U.prototype.set=function(a,b){var c=this.A(a),d=this.index[c];d?(c=d.size,d.set(a,b),(c-=d.size)&&this.size++):(this.index[c]=d=new Map([[a,b]]),this.h.push(d),this.size++)};function V(a){a=void 0===a?8:a;if(!this||this.constructor!==V)return new V(a);this.index=J();this.h=[];this.size=0;32<a?(this.A=cb,this.B=BigInt(a)):(this.A=db,this.B=a)}V.prototype.add=function(a){var b=this.A(a),c=this.index[b];c?(b=c.size,c.add(a),(b-=c.size)&&this.size++):(this.index[b]=c=new Set([a]),this.h.push(c),this.size++)};
u=U.prototype;u.has=V.prototype.has=function(a){var b=this.A(a);return(b=this.index[b])&&b.has(a)};u.delete=V.prototype.delete=function(a){var b=this.A(a);(b=this.index[b])&&b.delete(a)&&this.size--};u.clear=V.prototype.clear=function(){this.index=J();this.h=[];this.size=0};
u.values=V.prototype.values=function eb(){var b,c=this,d,e,g;return ra(eb,function(f){switch(f.h){case 1:b=0;case 2:if(!(b<c.h.length)){f.h=0;break}d=x(c.h[b].values());e=d.next();case 5:if(e.done){b++;f.h=2;break}g=e.value;return E(f,g,6);case 6:e=d.next(),f.h=5}})};
u.keys=V.prototype.keys=function fb(){var b,c=this,d,e,g;return ra(fb,function(f){switch(f.h){case 1:b=0;case 2:if(!(b<c.h.length)){f.h=0;break}d=x(c.h[b].keys());e=d.next();case 5:if(e.done){b++;f.h=2;break}g=e.value;return E(f,g,6);case 6:e=d.next(),f.h=5}})};
...
function cb(){throw Error("The keystore is limited to 32 for EcmaScript5");};W.prototype.add=function(a,b,c){L(a)&&(b=a,a=ya(b,this.key));if(b&&(a||0===a)){if(!c&&this.reg.has(a))return this.update(a,b);for(var d=0,e;d<this.field.length;d++){e=this.J[d];var g=this.index.get(this.field[d]);if("function"===typeof e)(e=e(b))&&g.add(a,e,!1,!0);else{var f=e.R;if(!f||f(b))e.constructor===String?e=[""+e]:K(e)&&(e=[e]),hb(b,e,this.S,0,g,a,e[0],c)}}if(this.tag)for(d=0;d<this.L.length;d++){f=this.L[d];g=this.tag.get(this.aa[d]);e=J();if("function"===typeof f){if(f=f(b),!f)continue}else{var h=
f.R;if(h&&!h(b))continue;f.constructor===String&&(f=""+f);f=ya(b,f)}if(g&&f){K(f)&&(f=[f]);h=0;for(var k,l=void 0;h<f.length;h++)if(k=f[h],!e[k]){e[k]=1;var m;(m=g.get(k))?l=m:g.set(k,l=[]);if(!c||!l.includes(a)){if(l.length===Math.pow(2,31)-1){m=new T(l);if(this.fastupdate)for(var n=x(this.reg.values()),p=n.next();!p.done;p=n.next())p=p.value,p.includes(l)&&(p[p.indexOf(l)]=m);g.set(k,l=m)}l.push(a);this.fastupdate&&((k=this.reg.get(a))?k.push(l):this.reg.set(a,[l]))}}}}if(this.store&&(!c||!this.store.has(a))){if(this.I){var q=
...
p;var Ja=v.db.support_tag_search;y.field=n}Ja||(y.enrich=!1)}if(t){t[A]=v.search(a,b,y);y&&f&&(y.enrich=f);continue}else v=v.search(a,b,y),y&&f&&(y.enrich=f)}y=v&&(k?v.length:v.result.length);if(p&&y){D=[];G=0;if(this.db&&d){if(!Ja)for(I=n.length;I<d.length;I++){var M=d[I];if(M&&M.length)G++,D.push(M);else if(!q)return k?e:new Y(e)}}else{I=0;for(var Wb=M=void 0;I<p.length;I+=2){M=this.tag.get(p[I]);if(!M)if(q)continue;else return k?e:new Y(e);if(Wb=(M=M&&M.get(p[I+1]))&&M.length)G++,D.push(M);else if(!q)return k?
e:new Y(e)}}if(G){v=lb(v,D,k);y=v.length;if(!y&&!q)return k?v:new Y(v);G--}}if(y)g[h]=z,e.push(v),h++;else if(1===n.length)return k?e:new Y(e)}if(t){if(this.db&&p&&p.length&&!Ja)for(f=0;f<p.length;f+=2){g=this.index.get(p[f]);if(!g)if(q)continue;else return k?e:new Y(e);t.push(g.db.tag(p[f+1],b,w,!1))}var Xb=this;return Promise.all(t).then(function(P){return P.length?Xb.search(a,b,c,P):P})}if(!h)return k?e:new Y(e);if(l&&(!f||!this.store))return e[0];t=[];w=0;for(q=void 0;w<g.length;w++){q=e[w];f&&
q.length&&!q[0].doc&&(this.db?t.push(q=this.index.get(this.field[0]).db.enrich(q)):q=X.call(this,q));if(l)return k?q:new Y(q);e[w]={field:g[w],result:q}}if(f&&this.db&&t.length){var Ka=this;return Promise.all(t).then(function(P){for(var Q=0;Q<P.length;Q++)e[Q].result=P[Q];return m?vb(e,b):r?wb(e,a,Ka.index,Ka.field,Ka.J,r):e})}return m?vb(e,b):r?wb(e,a,this.index,this.field,this.J,r):e};
function wb(a,b,c,d,e,g){console.log("template",g);for(var f,h,k,l=0,m,n,p;l<a.length;l++)for(m=a[l].result,n=a[l].field,k=c.get(n),p=k.encoder,k=k.tokenize,n=e[d.indexOf(n)],p!==f&&(f=p,h=f.encode(b)),p=0;p<m.length;p++){var q="",r=ya(m[p].doc,n),w=f.encode(r);r=r.split(f.split);for(var t=0,A,z;t<w.length;t++){A=w[t];z=r[t];for(var v=void 0,y=0,D;y<h.length;y++)if(D=h[y],"strict"===k){if(A===D){q+=(q?" ":"")+g.replace("$1",z);v=!0;break}}else{var G=A.indexOf(D);if(-1<G){q+=(q?" ":"")+z.substring(0,
G)+g.replace("$1",z.substring(G,D.length))+z.substring(G+D.length);v=!0;break}}v||(q+=(q?" ":"")+r[t])}m[p].highlight=q}return a}function vb(a,b){for(var c=[],d=J(),e=0,g,f;e<a.length;e++){g=a[e];f=g.result;for(var h=0,k,l,m;h<f.length;h++)if(l=f[h],"object"!==typeof l&&(l={id:l}),k=l.id,m=d[k])m.push(g.field);else{if(c.length===b)return c;l.field=d[k]=[g.field];c.push(l)}}return c}
...
for(b=c.next();!b.done;b=c.next())b=b.value,b.then&&a.push(b);if(a.length){var g=this;return Promise.all(a).then(function(f){for(var h=0,k=x(g.index.entries()),l=k.next();!l.done;l=k.next()){l=l.value;var m=l[0];l[1].then&&g.index.set(m,f[h++])}return g})}}else a.db&&(this.fastupdate=!1,this.mount(a.db))}u=W.prototype;
...
u.commit=function(a,b){var c=this,d,e,g,f;return ta(function(h){if(1==h.h){d=[];e=x(c.index.values());for(g=e.next();!g.done;g=e.next())f=g.value,d.push(f.commit(f,a,b));return E(h,Promise.all(d),2)}c.reg.clear();h.h=0})};u.destroy=function(){for(var a=[],b=x(this.index.values()),c=b.next();!c.done;c=b.next())a.push(c.value.destroy());return Promise.all(a)};
...
f||!(f=Eb[f])||f===e||(d+=f,e=f,4!==d.length));g++);a[b]=d}}},ArabicDefault:{normalize:!1,dedupe:!0,prepare:function(a){return(""+a).replace(Fb," ")}},CjkDefault:{normalize:!1,dedupe:!0,split:"",prepare:function(a){return(""+a).replace(Gb,"")}},CyrillicDefault:{normalize:!1,dedupe:!0,prepare:function(a){return(""+a).replace(Hb," ")}}};var Jb={memory:{resolution:1},performance:{resolution:3,fastupdate:!0,context:{depth:1,resolution:1}},match:{tokenize:"forward"},score:{resolution:9,context:{depth:2,resolution:3}}};R.prototype.add=function(a,b,c,d){if(b&&(a||0===a)){if(!d&&!c&&this.reg.has(a))return this.update(a,b);b=this.encoder.encode(b);if(d=b.length){for(var e=J(),g=J(),f=this.depth,h=this.resolution,k=0;k<d;k++){var l=b[this.rtl?d-1-k:k],m=l.length;if(m&&(f||!g[l])){var n=this.score?this.score(b,l,k,null,0):Kb(h,d,k),p="";switch(this.tokenize){case "full":if(2<m){n=0;for(var q;n<m;n++)for(var r=m;r>n;r--)p=l.substring(n,r),q=this.rtl?m-1-n:n,q=this.score?this.score(b,l,k,p,q):Kb(h,d,k,m,q),Lb(this,g,p,
q,a,c);break}case "reverse":if(1<m){for(r=m-1;0<r;r--)p=l[this.rtl?m-1-r:r]+p,q=this.score?this.score(b,l,k,p,r):Kb(h,d,k,m,r),Lb(this,g,p,q,a,c);p=""}case "forward":if(1<m){for(r=0;r<m;r++)p+=l[this.rtl?m-1-r:r],Lb(this,g,p,n,a,c);break}default:if(Lb(this,g,l,n,a,c),f&&1<d&&k<d-1)for(m=J(),p=this.da,n=l,r=Math.min(f+1,this.rtl?k+1:d-k),q=m[n]=1;q<r;q++)if((l=b[this.rtl?d-1-k-q:k+q])&&!m[l]){m[l]=1;var w=this.score?this.score(b,n,k,l,q-1):Kb(p+(d/2>p?0:1),d,k,r-1,q-1),t=this.bidirectional&&l>n;Lb(this,
...
function Kb(a,b,c,d,e){return c&&1<a?b+(d||0)<=a?c+(e||0):(a-1)/(b+(d||0))*(c+(e||0))+1|0:0};R.prototype.search=function(a,b,c){c||(!b&&L(a)?(c=a,a=""):L(b)&&(c=b,b=0));var d=[],e=0,g;if(c){a=c.query||a;b=c.limit||b;e=c.offset||0;var f=c.context;var h=c.suggest;var k=(g=!1!==c.resolve)&&c.enrich;var l=c.boost;var m=c.resolution;var n=this.db&&c.tag}else g=this.resolve;var p=this.encoder.encode(a);var q=p.length;b=b||(g?100:0);if(1===q)return Nb.call(this,p[0],"",b,e,g,k,n);f=this.depth&&!1!==f;if(2===q&&f&&!h)return Nb.call(this,p[0],p[1],b,e,g,k,n);var r=J(),w=0;if(1<q&&f){var t=p[0];w=
1}m||0===m||(m=t?this.da:this.resolution);if(this.db){if(this.db.search&&(a=this.db.search(this,p,b,e,h,g,k,n),!1!==a))return a;var A=this;return function(){var z,v;return ta(function(y){switch(y.h){case 1:v=z=void 0;case 2:if(!(w<q)){y.h=4;break}v=p[w];if(!v||r[v]){y.h=5;break}r[v]=1;return E(y,Ob(A,v,t,0,0,!1,!1),6);case 6:z=y.D;if(z=Pb(z,d,h,m)){d=z;y.h=4;break}t&&(h&&z&&d.length||(t=v));case 5:h&&t&&w===q-1&&!d.length&&(m=A.resolution,t="",w=-1,r=J());w++;y.h=2;break;case 4:return y.return(Qb(d,
...
function Sb(a){var b=0;if(a.constructor===Array)for(var c=0,d=void 0;c<a.length;c++)(d=a[c])&&(b+=d.length);else for(c=x(a.entries()),d=c.next();!d.done;d=c.next()){var e=d.value;d=e[0];(e=Sb(e[1]))?b+=e:a.delete(d)}return b}u.cleanup=function(){if(!this.fastupdate)return this;Sb(this.map);this.depth&&Sb(this.ctx);return this};u.searchCache=zb;
...
b+c+d+"}":b+c+d};La(R.prototype);var Tb="undefined"!==typeof window&&(window.indexedDB||window.mozIndexedDB||window.webkitIndexedDB||window.msIndexedDB),Ub=["map","ctx","tag","reg","cfg"];
...
u.close=function(){this.db&&this.db.close();this.db=null};u.destroy=function(){var a=Tb.deleteDatabase(this.id+(this.field?":"+this.field:""));return Yb(a)};u.clear=function(){for(var a=this.db.transaction(Ub,"readwrite"),b=0;b<Ub.length;b++)a.objectStore(Ub[b]).clear();return Yb(a)};
...
function Yb(a){return new Promise(function(b,c){a.onsuccess=function(){b(this.result)};a.oncomplete=function(){b(this.result)};a.onerror=c;a=null})};var $b={Index:R,Charset:Ib,Encoder:Ga,Document:W,Worker:Sa,Resolver:Y,IndexedDB:Vb,Language:{}},ac=self,bc;(bc=ac.define)&&bc.amd?bc([],function(){return $b}):"object"===typeof ac.exports?ac.exports=$b:ac.FlexSearch=$b;}(this||self));

...
var g=new c;b.prototype.ma=function(f){var h=this.D();f.Y(h.resolve,h.reject)};b.prototype.na=function(f,h){var k=this.D();try{f.call(h,k.resolve,k.reject)}catch(l){k.reject(l)}};b.prototype.then=function(f,h){function k(p,q){return"function"==typeof p?function(r){try{l(p(r))}catch(x){m(x)}}:q}var l,m,n=new b(function(p,q){l=p;m=q});this.Y(k(f,l),k(h,m));return n};b.prototype.catch=function(f){return this.then(void 0,f)};b.prototype.Y=function(f,h){function k(){switch(l.A){case 1:f(l.C);break;case 2:h(l.C);
break;default:throw Error("Unexpected state: "+l.A);}}var l=this;null==this.h?g.A(k):this.h.push(k);this.L=!0};b.resolve=d;b.reject=function(f){return new b(function(h,k){k(f)})};b.race=function(f){return new b(function(h,k){for(var l=y(f),m=l.next();!m.done;m=l.next())d(m.value).Y(h,k)})};b.all=function(f){var h=y(f),k=h.next();return k.done?d([]):new b(function(l,m){function n(r){return function(x){p[r]=x;q--;0==q&&l(p)}}var p=[],q=0;do p.push(void 0),q++,d(k.value).Y(n(p.length-1),m),k=h.next();
...
B("WeakMap",function(a){function b(k){this.h=(h+=Math.random()+1).toString();if(k){k=y(k);for(var l;!(l=k.next()).done;)l=l.value,this.set(l[0],l[1])}}function c(){}function d(k){var l=typeof k;return"object"===l&&null!==k||"function"===l}function e(k){if(!H(k,f)){var l=new c;ba(k,f,{value:l})}}function g(k){var l=Object[k];l&&(Object[k]=function(m){if(m instanceof c)return m;Object.isExtensible(m)&&e(m);return l(m)})}if(function(){if(!a||!Object.seal)return!1;try{var k=Object.seal({}),l=Object.seal({}),
...
["\u0477","\u0475"],["\u04c2","\u0436"],["\u04d1","\u0430"],["\u04d3","\u0430"],["\u04d7","\u0435"],["\u04db","\u04d9"],["\u04dd","\u0436"],["\u04df","\u0437"],["\u04e3","\u0438"],["\u04e5","\u0438"],["\u04e7","\u043e"],["\u04eb","\u04e9"],["\u04ed","\u044d"],["\u04ef","\u0443"],["\u04f1","\u0443"],["\u04f3","\u0443"],["\u04f5","\u0447"]];var Ba=/[^\p{L}\p{N}]+/u,Ca=/(\d{3})/g,Da=/(\D)(\d{3})/g,Ea=/(\d{3})(\D)/g,Fa="".normalize&&/[\u0300-\u036f]/g;function N(a){if(!this){var b=Function.prototype.bind,c=b.apply,d=[null],e=d.concat;if(arguments instanceof Array)var g=arguments;else{g=y(arguments);for(var f,h=[];!(f=g.next()).done;)h.push(f.value);g=h}return new (c.call(b,N,e.call(d,g)))}for(b=0;b<arguments.length;b++)this.assign(arguments[b])}
...
I(a.maxlength,0,this.maxlength);if(this.cache=c=I(a.cache,!0,this.cache))this.X=null,this.L="number"===typeof c?c:2E5,this.P=new Map,this.V=new Map,this.A=this.h=128;this.C="";this.G=null;this.D="";this.H=null;if(this.matcher)for(a=y(this.matcher.keys()),b=a.next();!b.done;b=a.next())this.C+=(this.C?"|":"")+b.value;if(this.stemmer)for(a=y(this.stemmer.keys()),b=a.next();!b.done;b=a.next())this.D+=(this.D?"|":"")+b.value;return this};
...
w.keys=T.prototype.keys=function Va(){var b,c=this,d,e,g;return qa(Va,function(f){switch(f.h){case 1:b=0;case 2:if(!(b<c.h.length)){f.h=0;break}d=y(c.h[b].keys());e=d.next();case 5:if(e.done){b++;f.h=2;break}g=e.value;return F(f,g,6);case 6:e=d.next(),f.h=5}})};
...
X.prototype.offset=function(a){if(this.result.length){for(var b=[],c=0,d=0,e;d<this.result.length;d++)e=this.result[d],e.length+c<a?c+=e.length:(b[d]=e.slice(a-c),c=a);this.result=b}return this};X.prototype.boost=function(a){this.M+=a;return this};X.prototype.resolve=function(a,b,c){hb=1;var d=this.result;this.result=this.index=null;return d.length?("object"===typeof a&&(c=a.enrich,b=a.offset,a=a.limit),W(d,a||100,b,c)):d};function ib(a,b,c,d){var e=a.length,g=[],f=0,h;d&&(d=[]);for(var k=e-1,l;0<=k;k--){var m=a[k];e=K();l=!x;for(var n=0,p;n<m.length;n++)if((p=m[n])&&p.length)for(var q=0,r;q<p.length;q++)if(r=p[q],x){if(x[r]){if(!k)if(c)c--;else if(g[f++]=r,f===b)return g;if(k||d)e[r]=1;l=!0}d&&!h[r]&&(h[r]=1,(d[n]||(d[n]=[])).push(r))}else e[r]=1;if(d)x||(h=e);else if(!l)return[];var x=e}if(d)for(a=d.length-1;0<=a;a--)for(h=d[a],e=h.length,m=0;m<e;m++)if(k=h[m],!x[k]){if(c)c--;else if(g[f++]=k,f===b)return g;x[k]=
1}return g}function jb(a,b){for(var c=K(),d=K(),e=[],g=0;g<a.length;g++)c[a[g]]=1;for(a=0;a<b.length;a++){g=b[a];for(var f=0,h;f<g.length;f++)h=g[f],c[h]&&!d[h]&&(d[h]=1,e.push(h))}return e};var hb=1;
V.prototype.search=function(a,b,c){c||(!b&&M(a)?(c=a,a=""):M(b)&&(c=b,b=0));var d=[],e=0,g;if(c){a=c.query||a;b=c.limit||b;e=c.offset||0;var f=c.context;var h=c.suggest;(g=hb&&!1!==c.resolve)||(hb=0);var k=g&&c.enrich;var l=this.db&&c.tag}else g=this.resolve||hb;a=this.encoder.encode(a);var m=a.length;b||!g||(b=100);if(1===m)return kb.call(this,a[0],"",b,e,g,k,l);f=this.depth&&!1!==f;if(2===m&&f&&!h)return kb.call(this,a[0],a[1],b,e,g,k,l);var n=c=0;if(1<m){for(var p=K(),q=[],r=0,x=void 0;r<m;r++)if((x=
a[r])&&!p[x]){if(h||this.db||Y(this,x))q.push(x),p[x]=1;else return g?d:new X(d);x=x.length;c=Math.max(c,x);n=n?Math.min(n,x):x}a=q;m=a.length}if(!m)return g?d:new X(d);var u=0;if(1===m)return kb.call(this,a[0],"",b,e,g,k,l);if(2===m&&f&&!h)return kb.call(this,a[0],a[1],b,e,g,k,l);if(1<m)if(f){var t=a[0];u=1}else 9<c&&3<c/n&&a.sort(wa);if(this.db){if(this.db.search&&(f=this.db.search(this,a,b,e,h,g,k,l),!1!==f))return f;var v=this;return function(){var A,C,D;return sa(function(E){switch(E.h){case 1:C=
A=void 0;case 2:if(!(u<m)){E.h=4;break}C=a[u];return t?F(E,Y(v,C,t),8):F(E,Y(v,C),7);case 7:A=E.G;A=lb(A,d,h,v.resolution,b,e,1===m);E.h=6;break;case 8:A=E.G,A=lb(A,d,h,v.da,b,e,2===m),h&&!1===A&&d.length||(t=C);case 6:if(A)return E.return(A);if(h&&u===m-1){D=d.length;if(!D){if(t){t="";u=-1;E.h=3;break}return E.return(d)}if(1===D)return E.return(g?W(d[0],b,e):new X(d[0]))}case 3:u++;E.h=2;break;case 4:return E.return(g?ib(d,b,e,h):new X(d[0]))}})}()}for(k=f=void 0;u<m;u++){k=a[u];t?(f=Y(this,k,t),
f=lb(f,d,h,this.da,b,e,2===m),h&&!1===f&&d.length||(t=k)):(f=Y(this,k),f=lb(f,d,h,this.resolution,b,e,1===m));if(f)return f;if(h&&u===m-1){f=d.length;if(!f){if(t){t="";u=-1;continue}return d}if(1===f)return g?W(d[0],b,e):new X(d[0])}}return g?ib(d,b,e,h):new X(d[0])};function kb(a,b,c,d,e,g,f){a=Y(this,a,b,c,d,e,g,f);return this.db?a.then(function(h){return e?h:h&&h.length?e?W(h,c,d):new X(h):e?[]:new X([])}):a&&a.length?e?W(a,c,d):new X(a):e?[]:new X([])}
...
f.U;if(h&&!h(b))continue;f.constructor===String&&(f=""+f);f=ya(b,f)}if(g&&f){L(f)&&(f=[f]);h=0;for(var k,l=void 0;h<f.length;h++)if(k=f[h],!e[k]){e[k]=1;var m;(m=g.get(k))?l=m:g.set(k,l=[]);if(!c||!l.includes(a)){if(l.length===Math.pow(2,31)-1){m=new R(l);if(this.fastupdate)for(var n=y(this.B.values()),p=n.next();!p.done;p=n.next())p=p.value,p.includes(l)&&(p[p.indexOf(l)]=m);g.set(k,l=m)}l.push(a);this.fastupdate&&((k=this.B.get(a))?k.push(l):this.B.set(a,[l]))}}}}if(this.store&&(!c||!this.store.has(a))){if(this.I){var q=
...
t[v]);else r.push(u.field,t)}else{t=Object.keys(u);v=0;for(var A=void 0,C=void 0;v<t.length;v++)if(A=t[v],C=u[A],C.constructor===Array)for(var D=0;D<C.length;D++)r.push(A,C[D]);else r.push(A,C)}m=r;if(!a){g=[];if(r.length)for(k=0;k<r.length;k+=2){p=void 0;if(this.db){p=this.index.get(r[k]);if(!p)continue;g.push(p=p.db.tag(r[k+1],b,q,n))}else p=vb.call(this,r[k],r[k+1],b,q,n);e.push({field:r[k],tag:r[k+1],result:p})}return g.length?Promise.all(g).then(function(O){for(var P=0;P<O.length;P++)e[P].result=
O[P];return e}):e}}L(h)&&(h=[h])}h||(h=this.field);r=!d&&(this.worker||this.async)&&[];x=0;for(v=u=t=void 0;x<h.length;x++)if(u=h[x],!this.db||!this.tag||this.O[x]){t=void 0;L(u)||(t=u,u=t.field,a=t.query||a,b=t.limit||b,p=t.suggest||p);if(d)t=d[x];else{v=t||c;t=this.index.get(u);if(m){if(this.db){v.tag=m;var E=t.db.sa;v.field=h}E||(v.enrich=!1)}if(r){r[x]=t.searchAsync(a,b,v);v&&n&&(v.enrich=n);continue}else t=t.search(a,b,v),v&&n&&(v.enrich=n)}v=t&&t.length;if(m&&v){A=[];C=0;if(this.db&&d){if(!E)for(D=
h.length;D<d.length;D++){var J=d[D];if(J&&J.length)C++,A.push(J);else if(!p)return e}}else{D=0;for(var Gb=J=void 0;D<m.length;D+=2){J=this.tag.get(m[D]);if(!J)if(p)continue;else return e;if(Gb=(J=J&&J.get(m[D+1]))&&J.length)C++,A.push(J);else if(!p)return e}}if(C){t=jb(t,A);v=t.length;if(!v&&!p)return e;C--}}if(v)g[f]=u,e.push(t),f++;else if(1===h.length)return e}if(r){if(this.db&&m&&m.length&&!E)for(n=0;n<m.length;n+=2){g=this.index.get(m[n]);if(!g)if(p)continue;else return e;r.push(g.db.tag(m[n+
1],b,q,!1))}var Hb=this;return Promise.all(r).then(function(O){return O.length?Hb.search(a,b,c,O):O})}if(!f)return e;if(k&&(!n||!this.store))return e[0];r=[];q=0;for(p=void 0;q<g.length;q++){p=e[q];n&&p.length&&!p[0].doc&&(this.db?r.push(p=this.index.get(this.field[0]).db.enrich(p)):p.length&&(p=wb.call(this,p)));if(k)return p;e[q]={field:g[q],result:p}}return n&&this.db&&r.length?Promise.all(r).then(function(O){for(var P=0;P<O.length;P++)e[P].result=O[P];return l?xb(e,b):e}):l?xb(e,b):e};
...
y(a.map),m=l.next(),n={};!m.done;n={S:void 0,aa:void 0},m=l.next())m=m.value,n.aa=m[0],n.S=m[1],n.S.length&&(b?k.put(n.S,n.aa):k.get(n.aa).onsuccess=function(p){return function(){var q=this.result,r;if(q&&q.length)for(var x=Math.max(q.length,p.S.length),u=0,t;u<x;u++){if((t=p.S[u])&&t.length){if((r=q[u])&&r.length)for(var v=0;v<t.length;v++)r.push(t[v]);else q[u]=t;r=1}}else q=p.S,r=1;r&&k.put(q,p.aa)}}(n))}),13):h.return();case 13:return F(h,d.transaction("ctx","readwrite",function(k){for(var l=
y(a.J),m=l.next(),n={};!m.done;n={Z:void 0},m=l.next()){m=m.value;n.Z=m[0];m=y(m[1]);for(var p=m.next(),q={};!p.done;q={T:void 0,ba:void 0},p=m.next())p=p.value,q.ba=p[0],q.T=p[1],q.T.length&&(b?k.put(q.T,n.Z+":"+q.ba):k.get(n.Z+":"+q.ba).onsuccess=function(r,x){return function(){var u=this.result,t;if(u&&u.length)for(var v=Math.max(u.length,r.T.length),A=0,C;A<v;A++){if((C=r.T[A])&&C.length){if((t=u[A])&&t.length)for(var D=0;D<C.length;D++)t.push(C[D]);else u[A]=C;t=1}}else u=r.T,t=1;t&&k.put(u,
x.Z+":"+r.ba)}}(q,n))}}),14);case 14:if(a.store)return F(h,d.transaction("reg","readwrite",function(k){for(var l=y(a.store),m=l.next();!m.done;m=l.next()){var n=m.value;m=n[0];n=n[1];k.put("object"===typeof n?JSON.stringify(n):1,m)}}),16);if(a.pa){h.h=16;break}return F(h,d.transaction("reg","readwrite",function(k){for(var l=y(a.B.keys()),m=l.next();!m.done;m=l.next())k.put(1,m.value)}),16);case 16:if(!a.tag){h.h=20;break}return F(h,d.transaction("tag","readwrite",function(k){for(var l=y(a.tag),m=

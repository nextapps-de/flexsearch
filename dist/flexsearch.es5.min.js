...
break;default:throw Error("Unexpected state: "+l.A);}}var l=this;null==this.h?g.A(k):this.h.push(k);this.H=!0};b.resolve=d;b.reject=function(f){return new b(function(h,k){k(f)})};b.race=function(f){return new b(function(h,k){for(var l=x(f),m=l.next();!m.done;m=l.next())d(m.value).U(h,k)})};b.all=function(f){var h=x(f),k=h.next();return k.done?d([]):new b(function(l,m){function n(r){return function(w){p[r]=w;q--;0==q&&l(p)}}var p=[],q=0;do p.push(void 0),q++,d(k.value).U(n(p.length-1),m),k=h.next();
...
C("WeakMap",function(a){function b(k){this.h=(h+=Math.random()+1).toString();if(k){k=x(k);for(var l;!(l=k.next()).done;)l=l.value,this.set(l[0],l[1])}}function c(){}function d(k){var l=typeof k;return"object"===l&&null!==k||"function"===l}function e(k){if(!F(k,f)){var l=new c;ba(k,f,{value:l})}}function g(k){var l=Object[k];l&&(Object[k]=function(m){if(m instanceof c)return m;Object.isExtensible(m)&&e(m);return l(m)})}if(function(){if(!a||!Object.seal)return!1;try{var k=Object.seal({}),l=Object.seal({}),
...
C("Map",function(a){function b(){var h={};return h.K=h.next=h.head=h}function c(h,k){var l=h[1];return ua(function(){if(l){for(;l.head!=h[1];)l=l.K;for(;l.next!=l.head;)return l=l.next,{done:!1,value:k(l)};l=null}return{done:!0,value:void 0}})}function d(h,k){var l=k&&typeof k;"object"==l||"function"==l?g.has(k)?l=g.get(k):(l=""+ ++f,g.set(k,l)):l="p_"+k;var m=h[0][l];if(m&&F(h[0],l))for(h=0;h<m.length;h++){var n=m[h];if(k!==k&&n.key!==n.key||k===n.key)return{id:l,list:m,index:h,F:n}}return{id:l,
...
C("Set",function(a){function b(c){this.h=new Map;if(c){c=x(c);for(var d;!(d=c.next()).done;)this.add(d.value)}this.size=this.h.size}if(function(){if(!a||"function"!=typeof a||!a.prototype.entries||"function"!=typeof Object.seal)return!1;try{var c=Object.seal({x:4}),d=new a(x([c]));if(!d.has(c)||1!=d.size||d.add(c)!=d||1!=d.size||d.add({x:4})!=d||2!=d.size)return!1;var e=d.entries(),g=e.next();if(g.done||g.value[0]!=c||g.value[1]!=c)return!1;g=e.next();return g.done||g.value[0]==c||4!=g.value[0].x||
...
function J(){return Object.create(null)}function K(a){return"string"===typeof a}function xa(a){return"object"===typeof a}function ya(a){var b=[];a=x(a.keys());for(var c=a.next();!c.done;c=a.next())b.push(c.value);return b}function za(a,b){if(K(b))a=a[b];else for(var c=0;a&&c<b.length;c++)a=a[b[c]];return a}function Aa(a){for(var b=0,c=0,d=void 0;c<a.length;c++)(d=a[c])&&b<d.length&&(b=d.length);return b};var Ba=/[^\p{L}\p{N}]+/u,Ca=/(\d{3})/g,Da=/(\D)(\d{3})/g,Ea=/(\d{3})(\D)/g,Fa=/[\u0300-\u036f]/g;function Ga(a){a=void 0===a?{}:a;if(!this||this.constructor!==Ga){var b=Function.prototype.bind,c=b.apply,d=[null],e=d.concat;if(arguments instanceof Array)var g=arguments;else{g=x(arguments);for(var f,h=[];!(f=g.next()).done;)h.push(f.value);g=h}return new (c.call(b,Ga,e.call(d,g)))}if(arguments.length)for(b=0;b<arguments.length;b++)this.assign(arguments[b]);else this.assign(a)}u=Ga.prototype;
...
b=a.next();!b.done;b=a.next())this.A+=(this.A?"|":"")+b.value;return this};u.addStemmer=function(a,b){this.stemmer||(this.stemmer=new Map);this.stemmer.set(a,b);this.A+=(this.A?"|":"")+a;this.N=null;this.cache&&L(this);return this};u.addFilter=function(a){"function"===typeof a?this.filter=a:(this.filter||(this.filter=new Set),this.filter.add(a));this.cache&&L(this);return this};
u.addMapper=function(a,b){if("object"===typeof a)return this.addReplacer(a,b);if(1<a.length)return this.addMatcher(a,b);this.mapper||(this.mapper=new Map);this.mapper.set(a,b);this.cache&&L(this);return this};u.addMatcher=function(a,b){if("object"===typeof a)return this.addReplacer(a,b);if(2>a.length&&(this.dedupe||this.mapper))return this.addMapper(a,b);this.matcher||(this.matcher=new Map);this.matcher.set(a,b);this.h+=(this.h?"|":"")+a;this.M=null;this.cache&&L(this);return this};
u.addReplacer=function(a,b){if("string"===typeof a)return this.addMatcher(a,b);this.replacer||(this.replacer=[]);this.replacer.push(a,b);this.cache&&L(this);return this};
...
d=[],e=this.split||""===this.split?a.split(this.split):a,g=0,f=void 0,h=void 0;g<e.length;g++)if((f=h=e[g])&&!(f.length<this.minlength||f.length>this.maxlength))if(c)d.push(f);else if(!this.filter||("function"===typeof this.filter?this.filter(f):!this.filter.has(f))){if(this.cache&&f.length<=this.H)if(this.D){var k=this.C.get(f);if(k||""===k){k&&d.push(k);continue}}else this.D=setTimeout(L,50,this);this.stemmer&&2<f.length&&(this.N||(this.N=new RegExp("(?!^)("+this.A+")$")),f=f.replace(this.N,function(q){return b.stemmer.get(q)}));
...
f),this.C.size>this.T&&(this.C.clear(),this.H=this.H/1.1|0));f&&d.push(f)}this.finalize&&(d=this.finalize(d)||d);this.cache&&a.length<=this.G&&(this.B.set(a,d),this.B.size>this.T&&(this.B.clear(),this.G=this.G/1.1|0));return d};function L(a){a.D=null;a.B.clear();a.C.clear()};var Ha,Ia;
...
5;break}return E(h,g,7);case 7:g=h.D;h.h=5;break;case 9:f=h.D,Ha.import(d[0],f);case 5:postMessage("search"===b?{id:c,msg:g}:{id:c}),h.h=0}})};function Ka(a){Na.call(a,"add");Na.call(a,"append");Na.call(a,"search");Na.call(a,"update");Na.call(a,"remove")}var Oa,Pa,Qa;function Ra(){Oa=Qa=0}
...
function O(a){Ta.prototype[a]=function(){var b=this,c=[].slice.call(arguments),d=c[c.length-1];if("function"===typeof d){var e=d;c.pop()}d=new Promise(function(g){"export"===a&&"function"===typeof c[0]&&(c[0]=null);b.h[++Sa]=g;b.worker.postMessage({task:a,id:Sa,args:c})});return e?(d.then(e),this):d}}
...
R.prototype.clear=function(){this.index.length=0};R.prototype.destroy=function(){this.proxy=this.index=null};R.prototype.push=function(){};function S(a){a=void 0===a?8:a;if(!this||this.constructor!==S)return new S(a);this.index=J();this.h=[];this.size=0;32<a?(this.A=db,this.B=BigInt(a)):(this.A=eb,this.B=a)}S.prototype.get=function(a){var b=this.A(a);return(b=this.index[b])&&b.get(a)};
S.prototype.set=function(a,b){var c=this.A(a),d=this.index[c];d?(c=d.size,d.set(a,b),(c-=d.size)&&this.size++):(this.index[c]=d=new Map([[a,b]]),this.h.push(d),this.size++)};function T(a){a=void 0===a?8:a;if(!this||this.constructor!==T)return new T(a);this.index=J();this.h=[];this.size=0;32<a?(this.A=db,this.B=BigInt(a)):(this.A=eb,this.B=a)}T.prototype.add=function(a){var b=this.A(a),c=this.index[b];c?(b=c.size,c.add(a),(b-=c.size)&&this.size++):(this.index[b]=c=new Set([a]),this.h.push(c),this.size++)};
u=S.prototype;u.has=T.prototype.has=function(a){var b=this.A(a);return(b=this.index[b])&&b.has(a)};u.delete=T.prototype.delete=function(a){var b=this.A(a);(b=this.index[b])&&b.delete(a)&&this.size--};u.clear=T.prototype.clear=function(){this.index=J();this.h=[];this.size=0};
u.values=T.prototype.values=function fb(){var b,c=this,d,e,g;return ra(fb,function(f){switch(f.h){case 1:b=0;case 2:if(!(b<c.h.length)){f.h=0;break}d=x(c.h[b].values());e=d.next();case 5:if(e.done){b++;f.h=2;break}g=e.value;return E(f,g,6);case 6:e=d.next(),f.h=5}})};
u.keys=T.prototype.keys=function gb(){var b,c=this,d,e,g;return ra(gb,function(f){switch(f.h){case 1:b=0;case 2:if(!(b<c.h.length)){f.h=0;break}d=x(c.h[b].keys());e=d.next();case 5:if(e.done){b++;f.h=2;break}g=e.value;return E(f,g,6);case 6:e=d.next(),f.h=5}})};
u.entries=T.prototype.entries=function hb(){var b,c=this,d,e,g;return ra(hb,function(f){switch(f.h){case 1:b=0;case 2:if(!(b<c.h.length)){f.h=0;break}d=x(c.h[b].entries());e=d.next();case 5:if(e.done){b++;f.h=2;break}g=e.value;return E(f,g,6);case 6:e=d.next(),f.h=5}})};function eb(a){var b=Math.pow(2,this.B)-1;if("number"==typeof a)return a&b;for(var c=0,d=this.B+1,e=0;e<a.length;e++)c=(c*d^a.charCodeAt(e))&b;return 32===this.B?c+Math.pow(2,31):c}
function db(){throw Error("The keystore is limited to 32 for EcmaScript5");};U.prototype.add=function(a,b,c){xa(a)&&(b=a,a=za(b,this.key));if(b&&(a||0===a)){if(!c&&this.reg.has(a))return this.update(a,b);for(var d=0,e;d<this.field.length;d++){e=this.J[d];var g=this.index.get(this.field[d]);if("function"===typeof e)(e=e(b))&&g.add(a,e,!1,!0);else{var f=e.R;if(!f||f(b))e.constructor===String?e=[""+e]:K(e)&&(e=[e]),ib(b,e,this.S,0,g,a,e[0],c)}}if(this.tag)for(d=0;d<this.L.length;d++){f=this.L[d];g=this.tag.get(this.aa[d]);e=J();if("function"===typeof f){if(f=f(b),!f)continue}else{var h=
f.R;if(h&&!h(b))continue;f.constructor===String&&(f=""+f);f=za(b,f)}if(g&&f){K(f)&&(f=[f]);h=0;for(var k,l=void 0;h<f.length;h++)if(k=f[h],!e[k]){e[k]=1;var m;(m=g.get(k))?l=m:g.set(k,l=[]);if(!c||!l.includes(a)){if(l.length===Math.pow(2,31)-1){m=new R(l);if(this.fastupdate)for(var n=x(this.reg.values()),p=n.next();!p.done;p=n.next())p=p.value,p.includes(l)&&(p[p.indexOf(l)]=m);g.set(k,l=m)}l.push(a);this.fastupdate&&((k=this.reg.get(a))?k.push(l):this.reg.set(a,[l]))}}}}if(this.store&&(!c||!this.store.has(a))){if(this.I){var q=
...
W.prototype.offset=function(a){if(this.result.length){for(var b=[],c=0,d;c<this.result.length;c++)if(d=this.result[c])d.length<=a?a-=d.length:(b[c]=d.slice(a),a=0);this.result=b}return this};W.prototype.boost=function(a){this.h+=a;return this};W.prototype.resolve=function(a,b,c){var d=this.result,e=this.index;this.result=this.index=null;return d.length?("object"===typeof a&&(c=a.enrich,b=a.offset,a=a.limit),nb.call(e,d,a||100,b,c)):d};J();U.prototype.search=function(a,b,c,d){c||(!b&&xa(a)?(c=a,a=""):xa(b)&&(c=b,b=0));var e=[],g=[],f,h=0,k=!0;if(c){c.constructor===Array&&(c={index:c});a=c.query||a;var l=c.pluck;var m=c.merge;var n=l||c.field||(n=c.index)&&(n.index?null:n);var p=this.tag&&c.tag;var q=c.suggest;k=!1!==c.resolve;k||l||!(n=n||this.field)||(K(n)?l=n:(n.constructor===Array&&1===n.length&&(n=n[0]),l=n.field||n.index));var r=(f=this.store&&c.enrich&&k)&&c.highlight;b=c.limit||b;var w=c.offset||0;b||(b=100);if(p&&(!this.db||
!d)){p.constructor!==Array&&(p=[p]);for(var t=[],z=0,A=void 0;z<p.length;z++)if(A=p[z],A.field&&A.tag){var v=A.tag;if(v.constructor===Array)for(var y=0;y<v.length;y++)t.push(A.field,v[y]);else t.push(A.field,v)}else{v=Object.keys(A);y=0;for(var D=void 0,H=void 0;y<v.length;y++)if(D=v[y],H=A[D],H.constructor===Array)for(var I=0;I<H.length;I++)t.push(D,H[I]);else t.push(D,H)}p=t;if(!a){k=[];if(t.length)for(g=0;g<t.length;g+=2){l=void 0;if(this.db){l=this.index.get(t[g]);if(!l)continue;k.push(l=l.db.tag(t[g+
1],b,w,f))}else l=vb.call(this,t[g],t[g+1],b,w,f);e.push({field:t[g],tag:t[g+1],result:l})}return k.length?Promise.all(k).then(function(P){for(var Q=0;Q<P.length;Q++)e[Q].result=P[Q];return e}):e}}n&&n.constructor!==Array&&(n=[n])}n||(n=this.field);t=!d&&(this.worker||this.db)&&[];z=0;for(y=A=v=void 0;z<n.length;z++)if(A=n[z],!this.db||!this.tag||this.J[z]){v=void 0;K(A)||(v=A,A=v.field,a=v.query||a,b=v.limit||b,w=v.offset||w,q=v.suggest||q,f=this.store&&(v.enrich||f));if(d)v=d[z];else{y=v||c;v=this.index.get(A);
if(p){if(this.db){y.tag=p;var La=v.db.support_tag_search;y.field=n}La||(y.enrich=!1)}if(t){t[z]=v.search(a,b,y);y&&f&&(y.enrich=f);continue}else v=v.search(a,b,y),y&&f&&(y.enrich=f)}y=v&&(k?v.length:v.result.length);if(p&&y){D=[];H=0;if(this.db&&d){if(!La)for(I=n.length;I<d.length;I++){var M=d[I];if(M&&M.length)H++,D.push(M);else if(!q)return k?e:new W(e)}}else{I=0;for(var Wb=M=void 0;I<p.length;I+=2){M=this.tag.get(p[I]);if(!M)if(q)continue;else return k?e:new W(e);if(Wb=(M=M&&M.get(p[I+1]))&&M.length)H++,
D.push(M);else if(!q)return k?e:new W(e)}}if(H){v=mb(v,D,k);y=v.length;if(!y&&!q)return k?v:new W(v);H--}}if(y)g[h]=A,e.push(v),h++;else if(1===n.length)return k?e:new W(e)}if(t){if(this.db&&p&&p.length&&!La)for(f=0;f<p.length;f+=2){g=this.index.get(p[f]);if(!g)if(q)continue;else return k?e:new W(e);t.push(g.db.tag(p[f+1],b,w,!1))}var Xb=this;return Promise.all(t).then(function(P){return P.length?Xb.search(a,b,c,P):P})}if(!h)return k?e:new W(e);if(l&&(!f||!this.store))return e[0];t=[];for(w=0;w<g.length;w++){q=
e[w];f&&q.length&&"undefined"===typeof q[0].doc&&(this.db?t.push(q=this.index.get(this.field[0]).db.enrich(q)):q=V.call(this,q));if(l)return k?q:new W(q);e[w]={field:g[w],result:q}}if(f&&this.db&&t.length){var Ma=this;return Promise.all(t).then(function(P){for(var Q=0;Q<P.length;Q++)e[Q].result=P[Q];return m?wb(e):r?xb(e,a,Ma.index,Ma.field,Ma.J,r):e})}return m?wb(e):r?xb(e,a,this.index,this.field,this.J,r):e};
function xb(a,b,c,d,e,g){for(var f,h,k,l=0,m,n;l<a.length;l++)if(m=a[l].field){var p=a[l].result;k=c.get(m);n=k.encoder;k=k.tokenize;m=e[d.indexOf(m)];n!==f&&(f=n,h=f.encode(b));for(var q=0;q<p.length;q++){for(var r="",w=za(p[q].doc,m).split(/\s+/),t=0,z,A;t<w.length;t++){z=w[t];A=n.encode(z);A=1<A.length?A.join(" "):A[0];var v=void 0;if(A&&z)for(var y=0,D;y<h.length;y++)if(D=h[y],"strict"===k){if(A===D){r+=(r?" ":"")+g.replace("$1",z);v=!0;break}}else{var H=A.indexOf(D);if(-1<H){r+=(r?" ":"")+z.substring(0,
H)+g.replace("$1",z.substring(H,D.length))+z.substring(H+D.length);v=!0;break}}v||(r+=(r?" ":"")+w[t])}p[q].highlight=r}}return a}function wb(a){for(var b=[],c=J(),d=0,e,g;d<a.length;d++){e=a[d];g=e.result;for(var f=0,h,k,l;f<g.length;f++)k=g[f],"object"!==typeof k&&(k={id:k}),h=k.id,(l=c[h])?l.push(e.field):(k.field=c[h]=[e.field],b.push(k))}return b}
function vb(a,b,c,d,e){a=this.tag.get(a);if(!a)return[];if((b=(a=a&&a.get(b))&&a.length-d)&&0<b){if(b>c||d)a=a.slice(d,d+c);e&&(a=V.call(this,a));return a}}function V(a){if(!this||!this.store)return a;for(var b=Array(a.length),c=0,d;c<a.length;c++)d=a[c],b[c]={id:d,doc:this.store.get(d)};return b};function U(a){if(!this||this.constructor!==U)return new U(a);var b=a.document||a.doc||a,c,d;this.J=[];this.field=[];this.S=[];this.key=(c=b.key||b.id)&&yb(c,this.S)||"id";(d=a.keystore||0)&&(this.keystore=d);this.fastupdate=!!a.fastupdate;this.reg=!this.fastupdate||a.worker||a.db?d?new T(d):new Set:d?new S(d):new Map;this.I=(c=b.store||null)&&c&&!0!==c&&[];this.store=c&&(d?new S(d):new Map);this.cache=(c=a.cache||null)&&new X(c);a.cache=!1;this.worker=a.worker;this.priority=a.priority||4;this.index=
...
for(b=c.next();!b.done;b=c.next())b=b.value,b.then&&a.push(b);if(a.length){var g=this;return Promise.all(a).then(function(f){for(var h=0,k=x(g.index.entries()),l=k.next();!l.done;l=k.next()){l=l.value;var m=l[0];l[1].then&&g.index.set(m,f[h++])}return g})}}else a.db&&(this.fastupdate=!1,this.mount(a.db))}u=U.prototype;
...
u.cleanup=function(){if(!this.fastupdate)return this;Ib(this.map);this.depth&&Ib(this.ctx);return this};u.searchCache=Ab;u.export=function(a,b,c,d){c=void 0===c?0:c;d=void 0===d?0:d;switch(d){case 0:var e="reg";var g=Za(this.reg);break;case 1:e="cfg";g=null;break;case 2:e="map";g=Va(this.map,this.reg.size);break;case 3:e="ctx";g=Xa(this.ctx,this.reg.size);break;default:return}return ab.call(this,a,b,e,g,c,d)};
...
b+c+d+"}":b+c+d};Ka(N.prototype);var Rb="undefined"!==typeof window&&(window.indexedDB||window.mozIndexedDB||window.webkitIndexedDB||window.msIndexedDB),Sb=["map","ctx","tag","reg","cfg"],Y=J();
function Tb(a,b){b=void 0===b?{}:b;if(!this)return new Tb(a,b);"object"===typeof a&&(b=a,a=a.name);a||console.info("Default storage space was used, because a name was not passed.");this.id="flexsearch"+(a?":"+a.toLowerCase().replace(/[^a-z0-9_\-]/g,""):"");this.field=b.field?b.field.toLowerCase().replace(/[^a-z0-9_\-]/g,""):"";this.type=b.type;this.fastupdate=this.support_tag_search=!1;this.db=null;this.h={}}u=Tb.prototype;u.mount=function(a){if(!a.encoder)return a.mount(this);a.db=this;return this.open()};
u.open=function(){if(this.db)return this.db;var a=this;navigator.storage&&navigator.storage.persist();Y[a.id]||(Y[a.id]=[]);Y[a.id].push(a.field);var b=Rb.open(a.id,1);b.onupgradeneeded=function(){for(var c=a.db=this.result,d=0,e;d<Sb.length;d++){e=Sb[d];for(var g=0,f;g<Y[a.id].length;g++)f=Y[a.id][g],c.objectStoreNames.contains(e+("reg"!==e?f?":"+f:"":""))||c.createObjectStore(e+("reg"!==e?f?":"+f:"":""))}};return a.db=Z(b,function(c){a.db=c;a.db.onversionchange=function(){a.close()}})};
u.close=function(){this.db&&this.db.close();this.db=null};u.destroy=function(){var a=Rb.deleteDatabase(this.id);return Z(a)};u.clear=function(){for(var a=[],b=0,c;b<Sb.length;b++){c=Sb[b];for(var d=0,e;d<Y[this.id].length;d++)e=Y[this.id][d],a.push(c+("reg"!==c?e?":"+e:"":""))}b=this.db.transaction(a,"readwrite");for(c=0;c<a.length;c++)b.objectStore(a[c]).clear();return Z(b)};
...
function(k){for(var l=x(a.ctx),m=l.next(),n={};!m.done;n={V:void 0},m=l.next()){m=m.value;n.V=m[0];m=x(m[1]);for(var p=m.next(),q={};!p.done;q={P:void 0,Z:void 0},p=m.next())p=p.value,q.Z=p[0],q.P=p[1],q.P.length&&(b?k.put(q.P,n.V+":"+q.Z):k.get(n.V+":"+q.Z).onsuccess=function(r,w){return function(){var t=this.result,z;if(t&&t.length)for(var A=Math.max(t.length,r.P.length),v=0,y;v<A;v++){if((y=r.P[v])&&y.length){if((z=t[v])&&z.length)for(var D=0;D<y.length;D++)z.push(y[D]);else t[v]=y;z=1}}else t=
...
function Ub(a,b,c){for(var d=a.value,e,g=0,f=0,h;f<d.length;f++){if(h=c?d:d[f]){for(var k=0,l;k<b.length;k++)if(l=b[k],l=h.indexOf(l),0<=l)if(e=1,1<h.length)h.splice(l,1);else{d[f]=[];break}g+=h.length}if(c)break}g?e&&a.update(d):a.delete();a.continue()}
u.remove=function(a){"object"!==typeof a&&(a=[a]);return Promise.all([this.transaction("map","readwrite",function(b){b.openCursor().onsuccess=function(){var c=this.result;c&&Ub(c,a)}}),this.transaction("ctx","readwrite",function(b){b.openCursor().onsuccess=function(){var c=this.result;c&&Ub(c,a)}}),this.transaction("tag","readwrite",function(b){b.openCursor().onsuccess=function(){var c=this.result;c&&Ub(c,a,!0)}}),this.transaction("reg","readwrite",function(b){for(var c=0;c<a.length;c++)b.delete(a[c])})])};
function Z(a,b){return new Promise(function(c,d){a.onsuccess=a.oncomplete=function(){b&&b(this.result);b=null;c(this.result)};a.onerror=a.onblocked=d;a=null})};var Vb={Index:N,Charset:Hb,Encoder:Ga,Document:U,Worker:Ta,Resolver:W,IndexedDB:Tb,Language:{}},Yb="undefined"!==typeof self?self:"undefined"!==typeof global?global:self,Zb;(Zb=Yb.define)&&Zb.amd?Zb([],function(){return Vb}):"object"===typeof Yb.exports?Yb.exports=Vb:Yb.FlexSearch=Vb;}(this||self));

...
function la(a,b){a.C={Ca:b,Da:!0};a.h=a.R}ja.prototype.return=function(a){this.C={return:a};this.h=this.R};function F(a,b,c){a.h=c;return{value:b}}function ma(a){this.h=new ja;this.A=a}function na(a,b){ka(a.h);var c=a.h.A;if(c)return oa(a,"return"in c?c["return"]:function(d){return{value:d,done:!0}},b,a.h.return);a.h.return(b);return pa(a)}
...
this.J(f)}};b.prototype.va=function(f){var h=void 0;try{h=f.then}catch(k){this.G(k);return}"function"==typeof h?this.za(h,f):this.J(f)};b.prototype.G=function(f){this.pa(2,f)};b.prototype.J=function(f){this.pa(1,f)};b.prototype.pa=function(f,h){if(0!=this.A)throw Error("Cannot settle("+f+", "+h+"): Promise already settled in state"+this.A);this.A=f;this.C=h;2===this.A&&this.xa();this.ta()};b.prototype.xa=function(){var f=this;e(function(){if(f.ua()){var h=z.console;"undefined"!==typeof h&&h.error(f.C)}},
...
B("WeakMap",function(a){function b(k){this.h=(h+=Math.random()+1).toString();if(k){k=y(k);for(var l;!(l=k.next()).done;)l=l.value,this.set(l[0],l[1])}}function c(){}function d(k){var l=typeof k;return"object"===l&&null!==k||"function"===l}function e(k){if(!G(k,f)){var l=new c;ba(k,f,{value:l})}}function g(k){var l=Object[k];l&&(Object[k]=function(m){if(m instanceof c)return m;Object.isExtensible(m)&&e(m);return l(m)})}if(function(){if(!a||!Object.seal)return!1;try{var k=Object.seal({}),l=Object.seal({}),
...
m.value,h.call(k,m[1],m[0],this)};e.prototype[Symbol.iterator]=e.prototype.entries;var f=0;return e});B("Array.prototype.keys",function(a){return a?a:function(){return va(this,function(b){return b})}});
...
function I(){return Object.create(null)}function xa(a,b){return b.length-a.length}function J(a){return"string"===typeof a}function K(a){return"object"===typeof a}function ya(a){var b=[];a=y(a.keys());for(var c=a.next();!c.done;c=a.next())b.push(c.value);return b}function za(a,b){if(J(b))a=a[b];else for(var c=0;a&&c<b.length;c++)a=a[b[c]];return a}function Aa(a){for(var b=0,c=0,d=void 0;c<a.length;c++)(d=a[c])&&b<d.length&&(b=d.length);return b};var Ba=/[^\p{L}\p{N}]+/u,Ca=/(\d{3})/g,Da=/(\D)(\d{3})/g,Ea=/(\d{3})(\D)/g,Fa="".normalize&&/[\u0300-\u036f]/g,Ga=!Fa&&[["\u00aa","a"],["\u00b2","2"],["\u00b3","3"],["\u00b9","1"],["\u00ba","o"],["\u00bc","1\u20444"],["\u00bd","1\u20442"],["\u00be","3\u20444"],["\u00e0","a"],["\u00e1","a"],["\u00e2","a"],["\u00e3","a"],["\u00e4","a"],["\u00e5","a"],["\u00e7","c"],["\u00e8","e"],["\u00e9","e"],["\u00ea","e"],["\u00eb","e"],["\u00ec","i"],["\u00ed","i"],["\u00ee","i"],["\u00ef","i"],["\u00f1","n"],
["\u00f2","o"],["\u00f3","o"],["\u00f4","o"],["\u00f5","o"],["\u00f6","o"],["\u00f9","u"],["\u00fa","u"],["\u00fb","u"],["\u00fc","u"],["\u00fd","y"],["\u00ff","y"],["\u0101","a"],["\u0103","a"],["\u0105","a"],["\u0107","c"],["\u0109","c"],["\u010b","c"],["\u010d","c"],["\u010f","d"],["\u0113","e"],["\u0115","e"],["\u0117","e"],["\u0119","e"],["\u011b","e"],["\u011d","g"],["\u011f","g"],["\u0121","g"],["\u0123","g"],["\u0125","h"],["\u0129","i"],["\u012b","i"],["\u012d","i"],["\u012f","i"],["\u0133",
...
null,this.ca);Ga&&(this.K=new Map(Ga));this.rtl=a.rtl||!1;this.H=H(a.H,!0,this.H);this.filter=H((c=a.filter)&&new Set(c),null,this.filter);this.N=H((c=a.N)&&new Map(c),null,this.N);this.K=H((c=a.K)&&new Map(c),null,this.K);this.U=H((c=a.U)&&new Map(c),null,this.U);this.P=H(a.P,null,this.P);this.ka=H(a.ka,1,this.ka);this.sa=H(a.sa,0,this.sa);if(this.cache=c=H(a.cache,!0,this.cache))this.ea=null,this.R="number"===typeof c?c:2E5,this.W=new Map,this.ba=new Map,this.A=this.h=128;this.C="";this.G=null;
this.D="";this.J=null;if(this.N)for(a=y(this.N.keys()),b=a.next();!b.done;b=a.next())this.C+=(this.C?"|":"")+b.value;if(this.U)for(a=y(this.U.keys()),b=a.next();!b.done;b=a.next())this.D+=(this.D?"|":"")+b.value;return this};
...
0));f&&d.push(f)}this.ca&&(d=this.ca(d)||d);this.cache&&a.length<=this.h&&(this.W.set(a,d),this.W.size>this.R&&(this.W.clear(),this.h=this.h/1.1|0));return d};function Ha(a){a.ea=null;a.W.clear();a.ba.clear()};function Ia(a,b,c){a=("object"===typeof a?""+a.query:a).toLowerCase();var d=this.cache.get(a);if(!d){d=this.search(a,b,c);if(d instanceof Promise){var e=this;d.then(function(g){e.cache.set(a,g)})}this.cache.set(a,d)}return d}function N(a){this.limit=a&&!0!==a?a:1E3;this.cache=new Map;this.h=""}N.prototype.set=function(a,b){this.cache.has(a)||(this.cache.set(this.h=a,b),this.limit&&this.cache.size>this.limit&&this.cache.delete(this.cache.keys().next().value))};
...
k.limit||0;g=k.offset||0;f=k.resolve;continue}d[h]=l;l instanceof Promise&&c.push(l)}if(c.length)return Promise.all(c).then(function(){d=[a.result].concat(d);a.result=Za(d,e,g,f,a.V);return f?a.result:a});d=[this.result].concat(d);this.result=Za(d,e,g,f,a.V);return f?this.result:this}return this};
...
0;f=l.enrich;h=l.resolve;continue}d[k]=m;m instanceof Promise&&c.push(m)}if(c.length)return Promise.all(c).then(function(){a.result.length&&(d=[a.result].concat(d));a.result=$a(d,e,g,f,!h,a.V);return h?a.result:a});this.result.length&&(d=[this.result].concat(d));this.result=$a(d,e,g,f,!h,a.V);return h?this.result:this};
...
f=fb(f,d,h,this.na,b,e,2===m),h&&!1===f&&d.length||(t=k)):(f=W(this,k),f=fb(f,d,h,this.resolution,b,e,1===m));if(f)return f;if(h&&u===m-1){f=d.length;if(!f){if(t){t="";u=-1;continue}return d}if(1===f)return g?U(d[0],b,e):new V(d[0])}}return g?cb(d,b,e,h):new V(d[0])};function eb(a,b,c,d,e,g,f){a=W(this,a,b,c,d,e,g,f);return this.db?a.then(function(h){return e?h:h&&h.length?e?U(h,c,d):new V(h):e?[]:new V([])}):a&&a.length?e?U(a,c,d):new V(a):e?[]:new V([])}
...
O[P];return e}):e}}J(h)&&(h=[h])}h||(h=this.field);r=!d&&(this.worker||this.async)&&[];x=0;for(v=u=t=void 0;x<h.length;x++)if(u=h[x],!this.db||!this.tag||this.T[x]){t=void 0;J(u)||(t=u,u=t.field,a=t.query||a,b=t.limit||b,p=t.suggest||p);if(d)t=d[x];else{v=t||c;t=this.index.get(u);if(m){if(this.db){v.tag=m;var E=t.db.Fa;v.field=h}E||(v.enrich=!1)}if(r){r[x]=t.searchAsync(a,b,v);v&&n&&(v.enrich=n);continue}else t=t.search(a,b,v),v&&n&&(v.enrich=n)}v=t&&t.length;if(m&&v){A=[];C=0;if(this.db&&d){if(!E)for(D=
h.length;D<d.length;D++){var L=d[D];if(L&&L.length)C++,A.push(L);else if(!p)return e}}else{D=0;for(var Db=L=void 0;D<m.length;D+=2){L=this.tag.get(m[D]);if(!L)if(p)continue;else return e;if(Db=(L=L&&L.get(m[D+1]))&&L.length)C++,A.push(L);else if(!p)return e}}if(C){t=db(t,A);v=t.length;if(!v&&!p)return e;C--}}if(v)g[f]=u,e.push(t),f++;else if(1===h.length)return e}if(r){if(this.db&&m&&m.length&&!E)for(n=0;n<m.length;n+=2){g=this.index.get(m[n]);if(!g)if(p)continue;else return e;r.push(g.db.tag(m[n+
1],b,q,!1))}var Eb=this;return Promise.all(r).then(function(O){return O.length?Eb.search(a,b,c,O):O})}if(!f)return e;if(k&&(!n||!this.store))return e[0];r=[];q=0;for(p=void 0;q<g.length;q++){p=e[q];n&&p.length&&!p[0].doc&&(this.db?r.push(p=this.index.get(this.field[0]).db.enrich(p)):p.length&&(p=pb.call(this,p)));if(k)return p;e[q]={field:g[q],result:p}}return n&&this.db&&r.length?Promise.all(r).then(function(O){for(var P=0;P<O.length;P++)e[P].result=O[P];return l?qb(e,b):e}):l?qb(e,b):e};
...
w.commit=function(a,b){var c=this,d,e,g,f;return ta(function(h){if(1==h.h){d=[];e=y(c.index.values());for(g=e.next();!g.done;g=e.next())f=g.value,d.push(f.db.commit(f,a,b));return F(h,Promise.all(d),2)}c.B.clear();h.h=0})};function rb(a,b){for(var c=a.split(":"),d=0,e=0;e<c.length;e++)a=c[e],"]"===a[a.length-1]&&(a=a.substring(0,a.length-2))&&(b[d]=!0),a&&(c[d++]=a);d<c.length&&(c.length=d);return 1<d?c:c[0]}w.append=function(a,b){return this.add(a,b,!0)};
...
w.get=function(a){return this.db?this.index.get(this.field[0]).db.enrich(a).then(function(b){return b[0]&&b[0].doc}):this.store.get(a)};w.set=function(a,b){this.store.set(a,b);return this};w.searchCache=Ia;
...
f.enrich(k):k}return h})};w.tag=function(a,b,c,d){b=void 0===b?0:b;c=void 0===c?0:c;d=void 0===d?!1:d;a=this.db.transaction("tag","readonly").objectStore("tag").get(a);var e=this;return wb(a).then(function(g){if(!g||!g.length||c>=g.length)return[];if(!b&&!c)return g;g=g.slice(c,c+b);return d?e.enrich(g):g})};
...
x.ga+":"+r.ja)}}(q,n))}}),14);case 14:if(a.store)return F(h,d.transaction("reg","readwrite",function(k){for(var l=y(a.store),m=l.next();!m.done;m=l.next()){var n=m.value;m=n[0];n=n[1];k.put("object"===typeof n?JSON.stringify(n):1,m)}}),16);if(a.Ba){h.h=16;break}return F(h,d.transaction("reg","readwrite",function(k){for(var l=y(a.B.keys()),m=l.next();!m.done;m=l.next())k.put(1,m.value)}),16);case 16:if(!a.tag){h.h=20;break}return F(h,d.transaction("tag","readwrite",function(k){for(var l=y(a.tag),m=
l.next(),n={};!m.done;n={ha:void 0,oa:void 0},m=l.next())m=m.value,n.oa=m[0],n.ha=m[1],n.ha.length&&(k.get(n.oa).onsuccess=function(p){return function(){var q=this.result;q=q&&q.length?q.concat(p.ha):p.ha;k.put(q,p.oa)}}(n))}),20);case 20:a.map.clear(),a.M.clear(),a.tag&&a.tag.clear(),a.store&&a.store.clear(),a.document||a.B.clear(),h.h=0}})};

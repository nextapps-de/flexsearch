 ...
 */
(function _f(self){'use strict';if(typeof module!=='undefined')self=module;else if(typeof process !== 'undefined')self=process;self._factory=_f;var u;function aa(a){var b=0;return function(){return b<a.length?{done:!1,value:a[b++]}:{done:!0}}}function w(a){var b="undefined"!=typeof Symbol&&Symbol.iterator&&a[Symbol.iterator];if(b)return b.call(a);if("number"==typeof a.length)return{next:aa(a)};throw Error(String(a)+" is not an iterable or ArrayLike");}var ba="function"==typeof Object.defineProperties?Object.defineProperty:function(a,b,c){if(a==Array.prototype||a==Object.prototype)return a;a[b]=c.value;return a};
...
var g=new c;b.prototype.ha=function(f){var h=this.C();f.U(h.resolve,h.reject)};b.prototype.ia=function(f,h){var k=this.C();try{f.call(h,k.resolve,k.reject)}catch(l){k.reject(l)}};b.prototype.then=function(f,h){function k(p,q){return"function"==typeof p?function(r){try{l(p(r))}catch(x){m(x)}}:q}var l,m,n=new b(function(p,q){l=p;m=q});this.U(k(f,l),k(h,m));return n};b.prototype.catch=function(f){return this.then(void 0,f)};b.prototype.U=function(f,h){function k(){switch(l.A){case 1:f(l.B);break;case 2:h(l.B);
break;default:throw Error("Unexpected state: "+l.A);}}var l=this;null==this.h?g.A(k):this.h.push(k);this.H=!0};b.resolve=d;b.reject=function(f){return new b(function(h,k){k(f)})};b.race=function(f){return new b(function(h,k){for(var l=w(f),m=l.next();!m.done;m=l.next())d(m.value).U(h,k)})};b.all=function(f){var h=w(f),k=h.next();return k.done?d([]):new b(function(l,m){function n(r){return function(x){p[r]=x;q--;0==q&&l(p)}}var p=[],q=0;do p.push(void 0),q++,d(k.value).U(n(p.length-1),m),k=h.next();
while(!k.done)})};return b});function va(a,b){a instanceof String&&(a+="");var c=0,d=!1,e={next:function(){if(!d&&c<a.length){var g=c++;return{value:b(g,a[g]),done:!1}}d=!0;return{done:!0,value:void 0}}};e[Symbol.iterator]=function(){return e};return e}C("Array.prototype.values",function(a){return a?a:function(){return va(this,function(b,c){return c})}});function F(a,b){return Object.prototype.hasOwnProperty.call(a,b)}
C("WeakMap",function(a){function b(k){this.h=(h+=Math.random()+1).toString();if(k){k=w(k);for(var l;!(l=k.next()).done;)l=l.value,this.set(l[0],l[1])}}function c(){}function d(k){var l=typeof k;return"object"===l&&null!==k||"function"===l}function e(k){if(!F(k,f)){var l=new c;ba(k,f,{value:l})}}function g(k){var l=Object[k];l&&(Object[k]=function(m){if(m instanceof c)return m;Object.isExtensible(m)&&e(m);return l(m)})}if(function(){if(!a||!Object.seal)return!1;try{var k=Object.seal({}),l=Object.seal({}),
...
m.value,h.call(k,m[1],m[0],this)};e.prototype[Symbol.iterator]=e.prototype.entries;var f=0;return e});C("Array.prototype.keys",function(a){return a?a:function(){return va(this,function(b){return b})}});
C("Set",function(a){function b(c){this.h=new Map;if(c){c=w(c);for(var d;!(d=c.next()).done;)this.add(d.value)}this.size=this.h.size}if(function(){if(!a||"function"!=typeof a||!a.prototype.entries||"function"!=typeof Object.seal)return!1;try{var c=Object.seal({x:4}),d=new a(w([c]));if(!d.has(c)||1!=d.size||d.add(c)!=d||1!=d.size||d.add({x:4})!=d||2!=d.size)return!1;var e=d.entries(),g=e.next();if(g.done||g.value[0]!=c||g.value[1]!=c)return!1;g=e.next();return g.done||g.value[0]==c||4!=g.value[0].x||
...
["\u0477","\u0475"],["\u04c2","\u0436"],["\u04d1","\u0430"],["\u04d3","\u0430"],["\u04d7","\u0435"],["\u04db","\u04d9"],["\u04dd","\u0436"],["\u04df","\u0437"],["\u04e3","\u0438"],["\u04e5","\u0438"],["\u04e7","\u043e"],["\u04eb","\u04e9"],["\u04ed","\u044d"],["\u04ef","\u0443"],["\u04f1","\u0443"],["\u04f3","\u0443"],["\u04f5","\u0447"]];var Ba=/[^\p{L}\p{N}]+/u,Ca=/(\d{3})/g,Da=/(\D)(\d{3})/g,Ea=/(\d{3})(\D)/g,Fa="".normalize&&/[\u0300-\u036f]/g;function Ga(a){a=void 0===a?{}:a;if(!this||this.constructor!==Ga){var b=Function.prototype.bind,c=b.apply,d=[null],e=d.concat;if(arguments instanceof Array)var g=arguments;else{g=w(arguments);for(var f,h=[];!(f=g.next()).done;)h.push(f.value);g=h}return new (c.call(b,Ga,e.call(d,g)))}if(arguments.length)for(b=0;b<arguments.length;b++)this.assign(arguments[b]);else this.assign(a)}u=Ga.prototype;
u.assign=function(a){this.normalize=H(a.normalize,!0,this.normalize);var b=a.include,c=b||a.exclude||a.split;if(c||""===c){if("object"===typeof c&&c.constructor!==RegExp){var d="";var e=!b;b||(d+="\\p{Z}");c.letter&&(d+="\\p{L}");c.number&&(d+="\\p{N}",e=!!b);c.symbol&&(d+="\\p{S}");c.punctuation&&(d+="\\p{P}");c.control&&(d+="\\p{C}");if(c=c.char)d+="object"===typeof c?c.join(""):c;try{this.split=new RegExp("["+(b?"^":"")+d+"]+","u")}catch(g){this.split=/\s+/}}else this.split=c,e=!1===c||2>"a1a".split(c).length;
...
function Ra(a){function b(f){function h(k){k=k.data||k;var l=k.id,m=l&&e.h[l];m&&(m(k.msg),delete e.h[l])}this.worker=f;this.h=J();if(this.worker){d?this.worker.on("message",h):this.worker.onmessage=h;if(a.config)return new Promise(function(k){e.h[++S]=function(){k(e);1E9<S&&(S=0)};e.worker.postMessage({id:S,task:"init",factory:c,options:a})});this.worker.postMessage({task:"init",factory:c,options:a});this.priority=a.priority||4;return this}}a=void 0===a?{}:a;if(!this||this.constructor!==Ra)return new Ra(a);
var c="undefined"!==typeof self?self._factory:"undefined"!==typeof window?window._factory:null;c&&(c=c.toString());var d="undefined"===typeof window,e=this,g=Sa(c,d,a.worker);return g.then?g.then(function(f){return b.call(e,f)}):b.call(this,g)}T("add");T("append");T("search");T("update");T("remove");T("clear");T("export");T("import");La(Ra.prototype);
function T(a){Ra.prototype[a]=function(){var b=this,c=[].slice.call(arguments),d=c[c.length-1];if("function"===typeof d){var e=d;c.pop()}d=new Promise(function(g){"export"===a&&"function"===typeof c[0]&&(c[0]=null);b.h[++S]=g;b.worker.postMessage({task:a,id:S,args:c})});return e?(d.then(e),this):d}}
...
"module/worker/worker.js"),{type:"module"})};function Ta(a,b){b=void 0===b?0:b;var c=[],d=[];b&&(b=25E4/b*5E3|0);a=w(a.entries());for(var e=a.next();!e.done;e=a.next())d.push(e.value),d.length===b&&(c.push(d),d=[]);d.length&&c.push(d);return c}function Ua(a,b){b||(b=new Map);for(var c=0,d;c<a.length;c++)d=a[c],b.set(d[0],d[1]);return b}
function Va(a,b){b=void 0===b?0:b;var c=[],d=[];b&&(b=25E4/b*1E3|0);a=w(a.entries());for(var e=a.next();!e.done;e=a.next())e=e.value,d.push([e[0],Ta(e[1])[0]]),d.length===b&&(c.push(d),d=[]);d.length&&c.push(d);return c}function Wa(a,b){b||(b=new Map);for(var c=0,d,e;c<a.length;c++)d=a[c],e=b.get(d[0]),b.set(d[0],Ua(d[1],e));return b}function Xa(a){var b=[],c=[];a=w(a.keys());for(var d=a.next();!d.done;d=a.next())c.push(d.value),25E4===c.length&&(b.push(c),c=[]);c.length&&b.push(c);return b}
function Ya(a,b){b||(b=new Set);for(var c=0;c<a.length;c++)b.add(a[c]);return b}function Za(a,b,c,d,e,g,f){f=void 0===f?0:f;var h=d&&d.constructor===Array,k=h?d.shift():d;if(!k)return this.export(a,b,e,g+1);if((k=a((b?b+".":"")+(f+1)+"."+c,JSON.stringify(k)))&&k.then){var l=this;return k.then(function(){return Za.call(l,a,b,c,h?d:null,e,g,f+1)})}return Za.call(this,a,b,c,h?d:null,e,g,f+1)};function $a(a,b,c,d){for(var e=[],g=0,f;g<a.index.length;g++)if(f=a.index[g],b>=f.length)b-=f.length;else{b=f[d?"splice":"slice"](b,c);if(f=b.length)if(e=e.length?e.concat(b):b,c-=f,d&&(a.length-=f),!c)break;b=0}return e}
...
u.keys=V.prototype.keys=function eb(){var b,c=this,d,e,g;return ra(eb,function(f){switch(f.h){case 1:b=0;case 2:if(!(b<c.h.length)){f.h=0;break}d=w(c.h[b].keys());e=d.next();case 5:if(e.done){b++;f.h=2;break}g=e.value;return E(f,g,6);case 6:e=d.next(),f.h=5}})};
u.entries=V.prototype.entries=function fb(){var b,c=this,d,e,g;return ra(fb,function(f){switch(f.h){case 1:b=0;case 2:if(!(b<c.h.length)){f.h=0;break}d=w(c.h[b].entries());e=d.next();case 5:if(e.done){b++;f.h=2;break}g=e.value;return E(f,g,6);case 6:e=d.next(),f.h=5}})};function cb(a){var b=Math.pow(2,this.A)-1;if("number"==typeof a)return a&b;for(var c=0,d=this.A+1,e=0;e<a.length;e++)c=(c*d^a.charCodeAt(e))&b;return 32===this.A?c+Math.pow(2,31):c}
function bb(){throw Error("The keystore is limited to 32 for EcmaScript5");};W.prototype.add=function(a,b,c){M(a)&&(b=a,a=ya(b,this.key));if(b&&(a||0===a)){if(!c&&this.reg.has(a))return this.update(a,b);for(var d=0,e;d<this.field.length;d++){e=this.J[d];var g=this.index.get(this.field[d]);if("function"===typeof e)(e=e(b))&&g.add(a,e,!1,!0);else{var f=e.R;if(!f||f(b))e.constructor===String?e=[""+e]:K(e)&&(e=[e]),gb(b,e,this.S,0,g,a,e[0],c)}}if(this.tag)for(d=0;d<this.L.length;d++){f=this.L[d];g=this.tag.get(this.aa[d]);e=J();if("function"===typeof f){if(f=f(b),!f)continue}else{var h=
f.R;if(h&&!h(b))continue;f.constructor===String&&(f=""+f);f=ya(b,f)}if(g&&f){K(f)&&(f=[f]);h=0;for(var k,l=void 0;h<f.length;h++)if(k=f[h],!e[k]){e[k]=1;var m;(m=g.get(k))?l=m:g.set(k,l=[]);if(!c||!l.includes(a)){if(l.length===Math.pow(2,31)-1){m=new ab(l);if(this.fastupdate)for(var n=w(this.reg.values()),p=n.next();!p.done;p=n.next())p=p.value,p.includes(l)&&(p[p.indexOf(l)]=m);g.set(k,l=m)}l.push(a);this.fastupdate&&((k=this.reg.get(a))?k.push(l):this.reg.set(a,[l]))}}}}if(this.store&&(!c||!this.store.has(a))){if(this.I){var q=
J();for(c=0;c<this.I.length;c++)if(d=this.I[c],g=d.R,!g||g(b)){g=void 0;if("function"===typeof d){g=d(b);if(!g)continue;d=[d.ja]}else if(K(d)||d.constructor===String){q[d]=b[d];continue}hb(b,q,d,0,d[0],g)}}this.store.set(a,q||b)}this.worker&&(this.fastupdate||this.reg.add(a))}return this};function hb(a,b,c,d,e,g){a=a[e];if(d===c.length-1)b[e]=g||a;else if(a)if(a.constructor===Array)for(b=b[e]=Array(a.length),e=0;e<a.length;e++)hb(a,b,c,d,e);else b=b[e]||(b[e]=J()),e=c[++d],hb(a,b,c,d,e)}
function gb(a,b,c,d,e,g,f,h){if(a=a[f])if(d===b.length-1){if(a.constructor===Array){if(c[d]){for(b=0;b<a.length;b++)e.add(g,a[b],!0,!0);return}a=a.join(" ")}e.add(g,a,h,!0)}else if(a.constructor===Array)for(f=0;f<a.length;f++)gb(a,b,c,d,e,g,f,h);else f=b[++d],gb(a,b,c,d,e,g,f,h);else e.db&&e.remove(g)};function ib(a,b,c,d,e,g,f){var h=a.length,k=[],l;var m=J();for(var n=0,p=void 0,q;n<b;n++)for(var r=0;r<h;r++)if(q=a[r],n<q.length&&(p=q[n]))for(var x=0;x<p.length;x++){q=p[x];(l=m[q])?m[q]++:(l=0,m[q]=1);l=k[l]||(k[l]=[]);if(!f){var t=n+(r||!e?0:g||0);l=l[t]||(l[t]=[])}l.push(q)}if(a=k.length)if(e)k=1<k.length?jb(k,c,d,f,g):(k=k[0]).length>c||d?k.slice(d,c+d):k;else{if(a<h)return[];k=k[a-1];if(c||d)if(f){if(k.length>c||d)k=k.slice(d,c+d)}else{e=[];for(g=0;g<k.length;g++)if(f=k[g],f.length>d)d-=f.length;
...
Y.prototype.offset=function(a){if(this.result.length){for(var b=[],c=0,d;c<this.result.length;c++)if(d=this.result[c])d.length<=a?a-=d.length:(b[c]=d.slice(a),a=0);this.result=b}return this};Y.prototype.boost=function(a){this.h+=a;return this};Y.prototype.resolve=function(a,b,c){var d=this.result,e=this.index;this.result=this.index=null;return d.length?("object"===typeof a&&(c=a.enrich,b=a.offset,a=a.limit),lb.call(e,d,a||100,b,c)):d};J();W.prototype.search=function(a,b,c,d){c||(!b&&M(a)?(c=a,a=""):M(b)&&(c=b,b=0));var e=[],g=[],f=0,h=!0;if(c){c.constructor===Array&&(c={index:c});a=c.query||a;var k=c.pluck;var l=c.merge;var m=k||c.field||(m=c.index)&&(m.index?null:m);var n=this.tag&&c.tag;var p=c.suggest;h=!1!==c.resolve;h||k||!(m=m||this.field)||(K(m)?k=m:(m.constructor===Array&&1===m.length&&(m=m[0]),k=m.field||m.index));var q=this.store&&c.enrich&&h;var r=c.highlight&&q;b=c.limit||b;var x=c.offset||0;b||(b=100);if(n&&(!this.db||
!d)){n.constructor!==Array&&(n=[n]);for(var t=[],A=0,z=void 0;A<n.length;A++)if(z=n[A],z.field&&z.tag){var v=z.tag;if(v.constructor===Array)for(var y=0;y<v.length;y++)t.push(z.field,v[y]);else t.push(z.field,v)}else{v=Object.keys(z);y=0;for(var D=void 0,G=void 0;y<v.length;y++)if(D=v[y],G=z[D],G.constructor===Array)for(var I=0;I<G.length;I++)t.push(D,G[I]);else t.push(D,G)}n=t;if(!a){h=[];if(t.length)for(g=0;g<t.length;g+=2){k=void 0;if(this.db){k=this.index.get(t[g]);if(!k)continue;h.push(k=k.db.tag(t[g+
1],b,x,q))}else k=tb.call(this,t[g],t[g+1],b,x,q);e.push({field:t[g],tag:t[g+1],result:k})}return h.length?Promise.all(h).then(function(P){for(var Q=0;Q<P.length;Q++)e[Q].result=P[Q];return e}):e}}m&&m.constructor!==Array&&(m=[m])}m||(m=this.field);t=!d&&(this.worker||this.db)&&[];A=0;for(y=z=v=void 0;A<m.length;A++)if(z=m[A],!this.db||!this.tag||this.J[A]){v=void 0;K(z)||(v=z,z=v.field,a=v.query||a,b=v.limit||b,x=v.offset||x,p=v.suggest||p,q=this.store&&(v.enrich||q));if(d)v=d[A];else{y=v||c;v=this.index.get(z);
if(n){if(this.db){y.tag=n;var Ja=v.db.support_tag_search;y.field=m}Ja||(y.enrich=!1)}if(t){t[A]=v.search(a,b,y);y&&q&&(y.enrich=q);continue}else v=v.search(a,b,y),y&&q&&(y.enrich=q)}y=v&&(h?v.length:v.result.length);if(n&&y){D=[];G=0;if(this.db&&d){if(!Ja)for(I=m.length;I<d.length;I++){var L=d[I];if(L&&L.length)G++,D.push(L);else if(!p)return h?e:new Y(e)}}else{I=0;for(var Vb=L=void 0;I<n.length;I+=2){L=this.tag.get(n[I]);if(!L)if(p)continue;else return h?e:new Y(e);if(Vb=(L=L&&L.get(n[I+1]))&&L.length)G++,
D.push(L);else if(!p)return h?e:new Y(e)}}if(G){v=kb(v,D,h);y=v.length;if(!y&&!p)return h?v:new Y(v);G--}}if(y)g[f]=z,e.push(v),f++;else if(1===m.length)return h?e:new Y(e)}if(t){if(this.db&&n&&n.length&&!Ja)for(q=0;q<n.length;q+=2){g=this.index.get(n[q]);if(!g)if(p)continue;else return h?e:new Y(e);t.push(g.db.tag(n[q+1],b,x,!1))}var Wb=this;return Promise.all(t).then(function(P){return P.length?Wb.search(a,b,c,P):P})}if(!f)return h?e:new Y(e);if(k&&(!q||!this.store))return e[0];t=[];x=0;for(p=void 0;x<
g.length;x++){p=e[x];q&&p.length&&!p[0].doc&&(this.db?t.push(p=this.index.get(this.field[0]).db.enrich(p)):p=X.call(this,p));if(k)return h?p:new Y(p);e[x]={field:g[x],result:p}}if(q&&this.db&&t.length){var Ka=this;return Promise.all(t).then(function(P){for(var Q=0;Q<P.length;Q++)e[Q].result=P[Q];return l?ub(e,b):r?vb(e,a,Ka.index,Ka.field,Ka.J,r):e})}return l?ub(e,b):r?vb(e,a,this.index,this.field,this.J,r):e};
...
D.length))+z.substring(G+D.length);v=!0;break}}v||(q+=(q?" ":"")+r[t])}m[p].highlight=q}return a}function ub(a,b){for(var c=[],d=J(),e=0,g,f;e<a.length;e++){g=a[e];f=g.result;for(var h=0,k,l,m;h<f.length;h++)if(l=f[h],"object"!==typeof l&&(l={id:l}),k=l.id,m=d[k])m.push(g.field);else{if(c.length===b)return c;l.field=d[k]=[g.field];c.push(l)}}return c}
function tb(a,b,c,d,e){a=this.tag.get(a);if(!a)return[];if((b=(a=a&&a.get(b))&&a.length-d)&&0<b){if(b>c||d)a=a.slice(d,d+c);e&&(a=X.call(this,a));return a}}function X(a){if(!this||!this.store)return a;for(var b=Array(a.length),c=0,d;c<a.length;c++)d=a[c],b[c]={id:d,doc:this.store.get(d)};return b};function W(a){if(!this||this.constructor!==W)return new W(a);var b=a.document||a.doc||a,c,d;this.J=[];this.field=[];this.S=[];this.key=(c=b.key||b.id)&&wb(c,this.S)||"id";(d=a.keystore||0)&&(this.keystore=d);this.fastupdate=!!a.fastupdate;this.reg=!this.fastupdate||a.worker||a.db?d?new V(d):new Set:d?new U(d):new Map;this.I=(c=b.store||null)&&c&&!0!==c&&[];this.store=c&&(d?new U(d):new Map);this.cache=(c=a.cache||null)&&new Z(c);a.cache=!1;this.worker=a.worker;this.priority=a.priority||4;this.index=
xb.call(this,a,b);this.tag=null;if(c=b.tag)if("string"===typeof c&&(c=[c]),c.length){this.tag=new Map;this.L=[];this.aa=[];b=0;for(var e=d=void 0;b<c.length;b++){d=c[b];e=d.field||d;if(!e)throw Error("The tag field from the document descriptor is undefined.");d.custom?this.L[b]=d.custom:(this.L[b]=wb(e,this.S),d.filter&&("string"===typeof this.L[b]&&(this.L[b]=new String(this.L[b])),this.L[b].R=d.filter));this.aa[b]=e;this.tag.set(e,new Map)}}if(this.worker){this.fastupdate=!1;a=[];c=w(this.index.values());
for(b=c.next();!b.done;b=c.next())b=b.value,b.then&&a.push(b);if(a.length){var g=this;return Promise.all(a).then(function(f){for(var h=0,k=w(g.index.entries()),l=k.next();!l.done;l=k.next()){l=l.value;var m=l[0];l[1].then&&g.index.set(m,f[h++])}return g})}}else a.db&&(this.fastupdate=!1,this.mount(a.db))}u=W.prototype;
...
function xb(a,b){var c=new Map,d=b.index||b.field||b;K(d)&&(d=[d]);for(var e=0,g,f=void 0;e<d.length;e++){g=d[e];K(g)||(f=g,g=g.field);f=M(f)?Object.assign({},a,f):a;if(this.worker){var h=new Ra(f);c.set(g,h)}this.worker||c.set(g,new R(f,this.reg));f.custom?this.J[e]=f.custom:(this.J[e]=wb(g,this.S),f.filter&&("string"===typeof this.J[e]&&(this.J[e]=new String(this.J[e])),this.J[e].R=f.filter));this.field[e]=g}if(this.I)for(a=b.store,K(a)&&(a=[a]),b=0;b<a.length;b++)d=a[b],e=d.field||d,d.custom?(this.I[b]=
...
u.export=function(a,b,c,d){c=void 0===c?0:c;d=void 0===d?0:d;if(c<this.field.length){var e=this.field[c];if((b=this.index.get(e).export(a,e,c,d=1))&&b.then){var g=this;return b.then(function(){return g.export(a,e,c+1)})}return this.export(a,e,c+1)}switch(d){case 0:var f="reg";var h=Xa(this.reg);b=null;break;case 1:f="tag";h=this.tag&&Va(this.tag,this.reg.size);b=null;break;case 2:f="doc";h=this.store&&Ta(this.store);b=null;break;default:return}return Za.call(this,a,b,f,h,c,d)};
...
return Promise.all(b)}break;case "tag":this.tag=Wa(b,this.tag);break;case "doc":this.store=Ua(b,this.store)}}};La(W.prototype);function yb(a,b,c){a=("object"===typeof a?""+a.query:a).toLowerCase();this.cache||(this.cache=new Z);var d=this.cache.get(a);if(!d){d=this.search(a,b,c);if(d.then){var e=this;d.then(function(g){e.cache.set(a,g);return g})}this.cache.set(a,d)}return d}function Z(a){this.limit=a&&!0!==a?a:1E3;this.cache=new Map;this.h=""}Z.prototype.set=function(a,b){this.cache.set(this.h=a,b);this.cache.size>this.limit&&this.cache.delete(this.cache.keys().next().value)};
...
f||!(f=Db[f])||f===e||(d+=f,e=f,4!==d.length));g++);a[b]=d}}},ArabicDefault:{normalize:!1,dedupe:!0,prepare:function(a){return(""+a).replace(Eb," ")}},CjkDefault:{normalize:!1,dedupe:!0,split:"",prepare:function(a){return(""+a).replace(Fb,"")}},CyrillicDefault:{normalize:!1,dedupe:!0,prepare:function(a){return(""+a).replace(Gb," ")}}};var Ib={memory:{resolution:1},performance:{resolution:3,fastupdate:!0,context:{depth:1,resolution:1}},match:{tokenize:"forward"},score:{resolution:9,context:{depth:2,resolution:3}}};R.prototype.add=function(a,b,c,d){if(b&&(a||0===a)){if(!d&&!c&&this.reg.has(a))return this.update(a,b);b=this.encoder.encode(b);if(d=b.length){for(var e=J(),g=J(),f=this.depth,h=this.resolution,k=0;k<d;k++){var l=b[this.rtl?d-1-k:k],m=l.length;if(m&&(f||!g[l])){var n=this.score?this.score(b,l,k,null,0):Jb(h,d,k),p="";switch(this.tokenize){case "full":if(2<m){n=0;for(var q;n<m;n++)for(var r=m;r>n;r--)p=l.substring(n,r),q=this.rtl?m-1-n:n,q=this.score?this.score(b,l,k,p,q):Jb(h,d,k,m,q),Kb(this,g,p,
q,a,c);break}case "reverse":if(1<m){for(r=m-1;0<r;r--)p=l[this.rtl?m-1-r:r]+p,q=this.score?this.score(b,l,k,p,r):Jb(h,d,k,m,r),Kb(this,g,p,q,a,c);p=""}case "forward":if(1<m){for(r=0;r<m;r++)p+=l[this.rtl?m-1-r:r],Kb(this,g,p,n,a,c);break}default:if(Kb(this,g,l,n,a,c),f&&1<d&&k<d-1)for(m=J(),p=this.da,n=l,r=Math.min(f+1,this.rtl?k+1:d-k),q=m[n]=1;q<r;q++)if((l=b[this.rtl?d-1-k-q:k+q])&&!m[l]){m[l]=1;var x=this.score?this.score(b,n,k,l,q-1):Jb(p+(d/2>p?0:1),d,k,r-1,q-1),t=this.bidirectional&&l>n;Kb(this,
...
function Jb(a,b,c,d,e){return c&&1<a?b+(d||0)<=a?c+(e||0):(a-1)/(b+(d||0))*(c+(e||0))+1|0:0};R.prototype.search=function(a,b,c){c||(!b&&M(a)?(c=a,a=""):M(b)&&(c=b,b=0));var d=[],e=0,g;if(c){a=c.query||a;b=c.limit||b;e=c.offset||0;var f=c.context;var h=c.suggest;var k=(g=!1!==c.resolve)&&c.enrich;var l=c.boost;var m=c.resolution;var n=this.db&&c.tag}else g=this.resolve;var p=this.encoder.encode(a);var q=p.length;b=b||(g?100:0);if(1===q)return Mb.call(this,p[0],"",b,e,g,k,n);f=this.depth&&!1!==f;if(2===q&&f&&!h)return Mb.call(this,p[0],p[1],b,e,g,k,n);var r=J(),x=0;if(1<q&&f){var t=p[0];x=
1}m||0===m||(m=t?this.da:this.resolution);if(this.db){if(this.db.search&&(a=this.db.search(this,p,b,e,h,g,k,n),!1!==a))return a;var A=this;return function(){var z,v;return ta(function(y){switch(y.h){case 1:v=z=void 0;case 2:if(!(x<q)){y.h=4;break}v=p[x];if(!v||r[v]){y.h=5;break}r[v]=1;return E(y,Nb(A,v,t,0,0,!1,!1),6);case 6:z=y.D;if(z=Ob(z,d,h,m)){d=z;y.h=4;break}t&&(h&&z&&d.length||(t=v));case 5:h&&t&&x===q-1&&!d.length&&(m=A.resolution,t="",x=-1,r=J());x++;y.h=2;break;case 4:return y.return(Pb(d,
m,b,e,h,l,g))}})}()}for(c=a=void 0;x<q;x++){if((c=p[x])&&!r[c]){r[c]=1;a=Nb(this,c,t,0,0,!1,!1);if(a=Ob(a,d,h,m)){d=a;break}t&&(h&&a&&d.length||(t=c))}h&&t&&x===q-1&&!d.length&&(m=this.resolution,t="",x=-1,r=J())}return Pb(d,m,b,e,h,l,g)};function Pb(a,b,c,d,e,g,f){var h=a.length,k=a;if(1<h)k=ib(a,b,c,d,e,g,f);else if(1===h)return f?lb.call(null,a[0],c,d):new Y(a[0]);return f?k:new Y(k)}
...
u.export=function(a,b,c,d){c=void 0===c?0:c;d=void 0===d?0:d;switch(d){case 0:var e="reg";var g=Xa(this.reg);break;case 1:e="cfg";g=null;break;case 2:e="map";g=Ta(this.map,this.reg.size);break;case 3:e="ctx";g=Va(this.ctx,this.reg.size);break;default:return}return Za.call(this,a,b,e,g,c,d)};
u.import=function(a,b){if(b)switch("string"===typeof b&&(b=JSON.parse(b)),a=a.split("."),"json"===a[a.length-1]&&a.pop(),3===a.length&&a.shift(),a=1<a.length?a[1]:a[0],a){case "reg":this.fastupdate=!1;this.reg=Ya(b,this.reg);break;case "map":this.map=Ua(b,this.map);break;case "ctx":this.ctx=Wa(b,this.ctx)}};
...
b+d+e+"}":b+d+e};La(R.prototype);var Sb="undefined"!==typeof window&&(window.indexedDB||window.mozIndexedDB||window.webkitIndexedDB||window.msIndexedDB),Tb=["map","ctx","tag","reg","cfg"];
function Ub(a,b){b=void 0===b?{}:b;if(!this)return new Ub(a,b);"object"===typeof a&&(b=a,a=a.name);a||console.info("Default storage space was used, because a name was not passed.");this.id="flexsearch"+(a?":"+a.toLowerCase().replace(/[^a-z0-9_\-]/g,""):"");this.field=b.field?b.field.toLowerCase().replace(/[^a-z0-9_\-]/g,""):"";this.type=b.type;this.fastupdate=this.support_tag_search=!1;this.db=null;this.h={}}u=Ub.prototype;u.mount=function(a){if(!a.encoder)return a.mount(this);a.db=this;return this.open()};
...
u.close=function(){this.db.close();this.db=null};u.destroy=function(){var a=Sb.deleteDatabase(this.id+(this.field?":"+this.field:""));return Xb(a)};u.clear=function(){for(var a=this.db.transaction(Tb,"readwrite"),b=0;b<Tb.length;b++)a.objectStore(Tb[b]).clear();return Xb(a)};
u.get=function(a,b,c,d,e,g){c=void 0===c?0:c;d=void 0===d?0:d;e=void 0===e?!0:e;g=void 0===g?!1:g;a=this.db.transaction(b?"ctx":"map","readonly").objectStore(b?"ctx":"map").get(b?b+":"+a:a);var f=this;return Xb(a).then(function(h){var k=[];if(!h||!h.length)return k;if(e){if(!c&&!d&&1===h.length)return h[0];for(var l=0,m=void 0;l<h.length;l++)if((m=h[l])&&m.length)if(d>=m.length)d-=m.length;else{for(var n=c?d+Math.min(m.length-d,c):m.length,p=d;p<n;p++)k.push(m[p]);d=0;if(k.length===c)break}return g?
f.enrich(k):k}return h})};u.tag=function(a,b,c,d){b=void 0===b?0:b;c=void 0===c?0:c;d=void 0===d?!1:d;a=this.db.transaction("tag","readonly").objectStore("tag").get(a);var e=this;return Xb(a).then(function(g){if(!g||!g.length||c>=g.length)return[];if(!b&&!c)return g;g=g.slice(c,c+b);return d?e.enrich(g):g})};
u.enrich=function(a){"object"!==typeof a&&(a=[a]);for(var b=this.db.transaction("reg","readonly").objectStore("reg"),c=[],d=0;d<a.length;d++)c[d]=Xb(b.get(a[d]));return Promise.all(c).then(function(e){for(var g=0;g<e.length;g++)e[g]={id:a[g],doc:e[g]?JSON.parse(e[g]):null};return e})};u.has=function(a){a=this.db.transaction("reg","readonly").objectStore("reg").getKey(a);return Xb(a)};u.search=null;u.info=function(){};
u.transaction=function(a,b,c){var d=this,e=this.h[a+":"+b];if(e)return c.call(this,e);var g=this.db.transaction(a,b);this.h[a+":"+b]=e=g.objectStore(a);return new Promise(function(f,h){g.onerror=function(l){g.abort();g=e=null;h(l)};g.oncomplete=function(l){g=e=null;f(l||!0)};var k=c.call(d,e);d.h[a+":"+b]=null;return k})};
...
"readwrite",function(k){for(var l=w(a.map),m=l.next(),n={};!m.done;n={O:void 0,Y:void 0},m=l.next())m=m.value,n.Y=m[0],n.O=m[1],n.O.length&&(b?k.put(n.O,n.Y):k.get(n.Y).onsuccess=function(p){return function(){var q=this.result,r;if(q&&q.length)for(var x=Math.max(q.length,p.O.length),t=0,A;t<x;t++){if((A=p.O[t])&&A.length){if((r=q[t])&&r.length)for(var z=0;z<A.length;z++)r.push(A[z]);else q[t]=A;r=1}}else q=p.O,r=1;r&&k.put(q,p.Y)}}(n))}),13):h.return();case 13:return E(h,d.transaction("ctx","readwrite",
function(k){for(var l=w(a.ctx),m=l.next(),n={};!m.done;n={V:void 0},m=l.next()){m=m.value;n.V=m[0];m=w(m[1]);for(var p=m.next(),q={};!p.done;q={P:void 0,Z:void 0},p=m.next())p=p.value,q.Z=p[0],q.P=p[1],q.P.length&&(b?k.put(q.P,n.V+":"+q.Z):k.get(n.V+":"+q.Z).onsuccess=function(r,x){return function(){var t=this.result,A;if(t&&t.length)for(var z=Math.max(t.length,r.P.length),v=0,y;v<z;v++){if((y=r.P[v])&&y.length){if((A=t[v])&&A.length)for(var D=0;D<y.length;D++)A.push(y[D]);else t[v]=y;A=1}}else t=
r.P,A=1;A&&k.put(t,x.V+":"+r.Z)}}(q,n))}}),14);case 14:if(a.store)return E(h,d.transaction("reg","readwrite",function(k){for(var l=w(a.store),m=l.next();!m.done;m=l.next()){var n=m.value;m=n[0];n=n[1];k.put("object"===typeof n?JSON.stringify(n):1,m)}}),16);if(a.bypass){h.h=16;break}return E(h,d.transaction("reg","readwrite",function(k){for(var l=w(a.reg.keys()),m=l.next();!m.done;m=l.next())k.put(1,m.value)}),16);case 16:if(!a.tag){h.h=20;break}return E(h,d.transaction("tag","readwrite",function(k){for(var l=
...
function Yb(a,b,c){for(var d=a.value,e,g,f=0,h=0,k;h<d.length;h++){if(k=c?d:d[h]){for(var l=0,m,n;l<b.length;l++)if(n=b[l],m=k.indexOf(g?parseInt(n,10):n),0>m&&!g&&"string"===typeof n&&!isNaN(n)&&(m=k.indexOf(parseInt(n,10)))&&(g=1),0<=m)if(e=1,1<k.length)k.splice(m,1);else{d[h]=[];break}f+=k.length}if(c)break}f?e&&a.update(d):a.delete();a.continue()}
u.remove=function(a){"object"!==typeof a&&(a=[a]);return Promise.all([this.transaction("map","readwrite",function(b){b.openCursor().onsuccess=function(){var c=this.result;c&&Yb(c,a)}}),this.transaction("ctx","readwrite",function(b){b.openCursor().onsuccess=function(){var c=this.result;c&&Yb(c,a)}}),this.transaction("tag","readwrite",function(b){b.openCursor().onsuccess=function(){var c=this.result;c&&Yb(c,a,!0)}}),this.transaction("reg","readwrite",function(b){for(var c=0;c<a.length;c++)b.delete(a[c])})])};
function Xb(a){return new Promise(function(b,c){a.onsuccess=function(){b(this.result)};a.oncomplete=function(){b(this.result)};a.onerror=c;a=null})};var Zb={Index:R,Charset:Hb,Encoder:Ga,Document:W,Worker:Ra,Resolver:Y,IndexedDB:Ub,Language:{}},$b=self,ac;(ac=$b.define)&&ac.amd?ac([],function(){return Zb}):"object"===typeof $b.exports?$b.exports=Zb:$b.FlexSearch=Zb;}(this||self));

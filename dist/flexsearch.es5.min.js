...
function I(){return Object.create(null)}function J(a){return"string"===typeof a}function K(a){return"object"===typeof a}function xa(a){var b=[];a=y(a.keys());for(var c=a.next();!c.done;c=a.next())b.push(c.value);return b}function ya(a,b){if(J(b))a=a[b];else for(var c=0;a&&c<b.length;c++)a=a[b[c]];return a}function za(a){for(var b=0,c=0,d=void 0;c<a.length;c++)(d=a[c])&&b<d.length&&(b=d.length);return b};var Aa=/[^\p{L}\p{N}]+/u,Ba=/(\d{3})/g,Ca=/(\D)(\d{3})/g,Da=/(\d{3})(\D)/g,Ea=/[\u0300-\u036f]/g;function Fa(a){a=void 0===a?{}:a;if(!this||this.constructor!==Fa){var b=Function.prototype.bind,c=b.apply,d=[null],e=d.concat;if(arguments instanceof Array)var g=arguments;else{g=y(arguments);for(var f,h=[];!(f=g.next()).done;)h.push(f.value);g=h}return new (c.call(b,Fa,e.call(d,g)))}if(arguments.length)for(b=0;b<arguments.length;b++)this.assign(arguments[b]);else this.assign(a)}u=Fa.prototype;
...
b=a.next();!b.done;b=a.next())this.A+=(this.A?"|":"")+b.value;return this};u.addStemmer=function(a,b){this.stemmer||(this.stemmer=new Map);this.stemmer.set(a,b);this.A+=(this.A?"|":"")+a;this.N=null;this.cache&&M(this);return this};u.addFilter=function(a){"function"===typeof a?this.filter=a:(this.filter||(this.filter=new Set),this.filter.add(a));this.cache&&M(this);return this};
u.addMapper=function(a,b){if("object"===typeof a)return this.addReplacer(a,b);if(1<a.length)return this.addMatcher(a,b);this.mapper||(this.mapper=new Map);this.mapper.set(a,b);this.cache&&M(this);return this};u.addMatcher=function(a,b){if("object"===typeof a)return this.addReplacer(a,b);if(2>a.length&&(this.dedupe||this.mapper))return this.addMapper(a,b);this.matcher||(this.matcher=new Map);this.matcher.set(a,b);this.h+=(this.h?"|":"")+a;this.M=null;this.cache&&M(this);return this};
u.addReplacer=function(a,b){if("string"===typeof a)return this.addMatcher(a,b);this.replacer||(this.replacer=[]);this.replacer.push(a,b);this.cache&&M(this);return this};
...
d=[],e=this.split||""===this.split?a.split(this.split):a,g=0,f=void 0,h=void 0;g<e.length;g++)if((f=h=e[g])&&!(f.length<this.minlength))if(c)d.push(f);else if(!this.filter||("function"===typeof this.filter?this.filter(f):!this.filter.has(f))){if(this.cache&&f.length<=this.H)if(this.D){var k=this.C.get(f);if(k||""===k){k&&d.push(k);continue}}else this.D=setTimeout(M,50,this);this.stemmer&&2<f.length&&(this.N||(this.N=new RegExp("(?!^)("+this.A+")$")),k=f,f=f.replace(this.N,function(q){return b.stemmer.get(q)}),
...
0;f&&k<this.replacer.length;k+=2)f=f.replace(this.replacer[k],this.replacer[k+1]);this.cache&&h.length<=this.H&&(this.C.set(h,f),this.C.size>this.T&&(this.C.clear(),this.H=this.H/1.1|0));f&&d.push(f)}this.finalize&&(d=this.finalize(d)||d);this.cache&&a.length<=this.G&&(this.B.set(a,d),this.B.size>this.T&&(this.B.clear(),this.G=this.G/1.1|0));return d};function M(a){a.D=null;a.B.clear();a.C.clear()};var Ga,Ha;
function Ia(a){var b,c,d,e,g,f;return ta(function(h){switch(h.h){case 1:a=a.data;b=a.task;c=a.id;d=a.args;switch(b){case "init":Ha=a.options||{};(e=a.factory)?(Function("return "+e)()(self),Ga=new self.FlexSearch.Index(Ha),delete self.FlexSearch):Ga=new O(Ha);postMessage({id:c});break;default:h.h=2;return}h.h=0;break;case 2:"export"===b&&(d[1]?(d[0]=Ha.export,d[2]=0,d[3]=1):d=null);if("import"===b){if(!d[0]){h.h=5;break}return D(h,Ha.import.call(Ga,d[0]),9)}g=d&&Ga[b].apply(Ga,d);if(!g||!g.then){h.h=
5;break}return D(h,g,7);case 7:g=h.D;h.h=5;break;case 9:f=h.D,Ga.import(d[0],f);case 5:postMessage("search"===b?{id:c,msg:g}:{id:c}),h.h=0}})};function Ja(a){Ka.call(a,"add");Ka.call(a,"append");Ka.call(a,"search");Ka.call(a,"update");Ka.call(a,"remove")}var Na,Oa,Pa;function Qa(){Na=Pa=0}
...
var c="undefined"!==typeof self?self._factory:"undefined"!==typeof window?window._factory:null;c&&(c=c.toString());var d="undefined"===typeof window,e=this,g=Ta(c,d,a.worker);return g.then?g.then(function(f){return b.call(e,f)}):b.call(this,g)}R("add");R("append");R("search");R("update");R("remove");R("clear");R("export");R("import");Ja(Sa.prototype);
...
S.prototype.clear=function(){this.index.length=0};S.prototype.destroy=function(){this.proxy=this.index=null};S.prototype.push=function(){};function T(a){a=void 0===a?8:a;if(!this||this.constructor!==T)return new T(a);this.index=I();this.h=[];this.size=0;32<a?(this.A=cb,this.B=BigInt(a)):(this.A=db,this.B=a)}T.prototype.get=function(a){var b=this.A(a);return(b=this.index[b])&&b.get(a)};
T.prototype.set=function(a,b){var c=this.A(a),d=this.index[c];d?(c=d.size,d.set(a,b),(c-=d.size)&&this.size++):(this.index[c]=d=new Map([[a,b]]),this.h.push(d),this.size++)};function U(a){a=void 0===a?8:a;if(!this||this.constructor!==U)return new U(a);this.index=I();this.h=[];this.size=0;32<a?(this.A=cb,this.B=BigInt(a)):(this.A=db,this.B=a)}U.prototype.add=function(a){var b=this.A(a),c=this.index[b];c?(b=c.size,c.add(a),(b-=c.size)&&this.size++):(this.index[b]=c=new Set([a]),this.h.push(c),this.size++)};
u=T.prototype;u.has=U.prototype.has=function(a){var b=this.A(a);return(b=this.index[b])&&b.has(a)};u.delete=U.prototype.delete=function(a){var b=this.A(a);(b=this.index[b])&&b.delete(a)&&this.size--};u.clear=U.prototype.clear=function(){this.index=I();this.h=[];this.size=0};
u.values=U.prototype.values=function eb(){var b,c=this,d,e,g;return ra(eb,function(f){switch(f.h){case 1:b=0;case 2:if(!(b<c.h.length)){f.h=0;break}d=y(c.h[b].values());e=d.next();case 5:if(e.done){b++;f.h=2;break}g=e.value;return D(f,g,6);case 6:e=d.next(),f.h=5}})};
u.keys=U.prototype.keys=function fb(){var b,c=this,d,e,g;return ra(fb,function(f){switch(f.h){case 1:b=0;case 2:if(!(b<c.h.length)){f.h=0;break}d=y(c.h[b].keys());e=d.next();case 5:if(e.done){b++;f.h=2;break}g=e.value;return D(f,g,6);case 6:e=d.next(),f.h=5}})};
...
function cb(){throw Error("The keystore is limited to 32 for EcmaScript5");};V.prototype.add=function(a,b,c){K(a)&&(b=a,a=ya(b,this.key));if(b&&(a||0===a)){if(!c&&this.reg.has(a))return this.update(a,b);for(var d=0,e;d<this.field.length;d++){e=this.J[d];var g=this.index.get(this.field[d]);if("function"===typeof e)(e=e(b))&&g.add(a,e,!1,!0);else{var f=e.R;if(!f||f(b))e.constructor===String?e=[""+e]:J(e)&&(e=[e]),hb(b,e,this.S,0,g,a,e[0],c)}}if(this.tag)for(d=0;d<this.L.length;d++){f=this.L[d];g=this.tag.get(this.aa[d]);e=I();if("function"===typeof f){if(f=f(b),!f)continue}else{var h=
f.R;if(h&&!h(b))continue;f.constructor===String&&(f=""+f);f=ya(b,f)}if(g&&f){J(f)&&(f=[f]);h=0;for(var k,l=void 0;h<f.length;h++)if(k=f[h],!e[k]){e[k]=1;var m;(m=g.get(k))?l=m:g.set(k,l=[]);if(!c||!l.includes(a)){if(l.length===Math.pow(2,31)-1){m=new S(l);if(this.fastupdate)for(var n=y(this.reg.values()),p=n.next();!p.done;p=n.next())p=p.value,p.includes(l)&&(p[p.indexOf(l)]=m);g.set(k,l=m)}l.push(a);this.fastupdate&&((k=this.reg.get(a))?k.push(l):this.reg.set(a,[l]))}}}}if(this.store&&(!c||!this.store.has(a))){if(this.I){var q=
...
function kb(a,b,c,d,e){var g=[],f=I(),h=a.length,k;if(d)for(e=h-1;0<=e;e--){if(k=(d=a[e])&&d.length)for(h=0;h<k;h++){var l=d[h];if(!f[l])if(f[l]=1,c)c--;else if(g.push(l),g.length===b)return g}}else for(var m=h-1,n,p=0;0<=m;m--){n=a[m];for(var q=0;q<n.length;q++)if(k=(d=n[q])&&d.length)for(var t=0;t<k;t++)if(l=d[t],!f[l])if(f[l]=1,c)c--;else{var w=(q+(m<h-1?e||0:0))/(m+1)|0;(g[w]||(g[w]=[])).push(l);if(++p===b)return g}}return g}
...
X.prototype.offset=function(a){if(this.result.length){for(var b=[],c=0,d;c<this.result.length;c++)if(d=this.result[c])d.length<=a?a-=d.length:(b[c]=d.slice(a),a=0);this.result=b}return this};X.prototype.boost=function(a){this.h+=a;return this};X.prototype.resolve=function(a,b,c){var d=this.result,e=this.index;this.result=this.index=null;return d.length?("object"===typeof a&&(c=a.enrich,b=a.offset,a=a.limit),mb.call(e,d,a||100,b,c)):d};I();V.prototype.search=function(a,b,c,d){c||(!b&&K(a)?(c=a,a=""):K(b)&&(c=b,b=0));var e=[],g=[],f,h=0,k=!0;if(c){c.constructor===Array&&(c={index:c});a=c.query||a;var l=c.pluck;var m=c.merge;var n=l||c.field||(n=c.index)&&(n.index?null:n);var p=this.tag&&c.tag;var q=c.suggest;k=!1!==c.resolve;k||l||!(n=n||this.field)||(J(n)?l=n:(n.constructor===Array&&1===n.length&&(n=n[0]),l=n.field||n.index));var t=(f=this.store&&c.enrich&&k)&&c.highlight;b=c.limit||b;var w=c.offset||0;b||(b=100);if(p&&(!this.db||!d)){p.constructor!==
Array&&(p=[p]);for(var r=[],z=0,A=void 0;z<p.length;z++)if(A=p[z],A.field&&A.tag){var v=A.tag;if(v.constructor===Array)for(var x=0;x<v.length;x++)r.push(A.field,v[x]);else r.push(A.field,v)}else{v=Object.keys(A);x=0;for(var E=void 0,N=void 0;x<v.length;x++)if(E=v[x],N=A[E],N.constructor===Array)for(var H=0;H<N.length;H++)r.push(E,N[H]);else r.push(E,N)}p=r;if(!a){k=[];if(r.length)for(g=0;g<r.length;g+=2){l=void 0;if(this.db){l=this.index.get(r[g]);if(!l)continue;k.push(l=l.db.tag(r[g+1],b,w,f))}else l=
ub.call(this,r[g],r[g+1],b,w,f);e.push({field:r[g],tag:r[g+1],result:l})}return k.length?Promise.all(k).then(function(P){for(var Q=0;Q<P.length;Q++)e[Q].result=P[Q];return e}):e}}n&&n.constructor!==Array&&(n=[n])}n||(n=this.field);r=!d&&(this.worker||this.db)&&[];z=0;for(x=A=v=void 0;z<n.length;z++)if(A=n[z],!this.db||!this.tag||this.J[z]){v=void 0;J(A)||(v=A,A=v.field,a=v.query||a,b=v.limit||b,w=v.offset||w,q=v.suggest||q,f=this.store&&(v.enrich||f));if(d)v=d[z];else{x=v||c;v=this.index.get(A);if(p){if(this.db){x.tag=
p;var La=v.db.support_tag_search;x.field=n}La||(x.enrich=!1)}if(r){r[z]=v.search(a,b,x);x&&f&&(x.enrich=f);continue}else v=v.search(a,b,x),x&&f&&(x.enrich=f)}x=v&&(k?v.length:v.result.length);if(p&&x){E=[];N=0;if(this.db&&d){if(!La)for(H=n.length;H<d.length;H++){var L=d[H];if(L&&L.length)N++,E.push(L);else if(!q)return k?e:new X(e)}}else{H=0;for(var Wb=L=void 0;H<p.length;H+=2){L=this.tag.get(p[H]);if(!L)if(q)continue;else return k?e:new X(e);if(Wb=(L=L&&L.get(p[H+1]))&&L.length)N++,E.push(L);else if(!q)return k?
e:new X(e)}}if(N){v=lb(v,E,k);x=v.length;if(!x&&!q)return k?v:new X(v);N--}}if(x)g[h]=A,e.push(v),h++;else if(1===n.length)return k?e:new X(e)}if(r){if(this.db&&p&&p.length&&!La)for(f=0;f<p.length;f+=2){g=this.index.get(p[f]);if(!g)if(q)continue;else return k?e:new X(e);r.push(g.db.tag(p[f+1],b,w,!1))}var Xb=this;return Promise.all(r).then(function(P){return P.length?Xb.search(a,b,c,P):P})}if(!h)return k?e:new X(e);if(l&&(!f||!this.store))return e[0];r=[];for(w=0;w<g.length;w++){q=e[w];f&&q.length&&
"undefined"===typeof q[0].doc&&(this.db?r.push(q=this.index.get(this.field[0]).db.enrich(q)):q=W.call(this,q));if(l)return k?q:new X(q);e[w]={field:g[w],result:q}}if(f&&this.db&&r.length){var Ma=this;return Promise.all(r).then(function(P){for(var Q=0;Q<P.length;Q++)e[Q].result=P[Q];return m?vb(e,b):t?wb(e,a,Ma.index,Ma.field,Ma.J,t):e})}return m?vb(e,b):t?wb(e,a,this.index,this.field,this.J,t):e};
...
for(b=c.next();!b.done;b=c.next())b=b.value,b.then&&a.push(b);if(a.length){var g=this;return Promise.all(a).then(function(f){for(var h=0,k=y(g.index.entries()),l=k.next();!l.done;l=k.next()){l=l.value;var m=l[0];l[1].then&&g.index.set(m,f[h++])}return g})}}else a.db&&(this.fastupdate=!1,this.mount(a.db))}u=V.prototype;
...
function yb(a,b){var c=new Map,d=b.index||b.field||b;J(d)&&(d=[d]);for(var e=0,g,f=void 0;e<d.length;e++){g=d[e];J(g)||(f=g,g=g.field);f=K(f)?Object.assign({},a,f):a;if(this.worker){var h=new Sa(f);c.set(g,h)}this.worker||c.set(g,new O(f,this.reg));f.custom?this.J[e]=f.custom:(this.J[e]=xb(g,this.S),f.filter&&("string"===typeof this.J[e]&&(this.J[e]=new String(this.J[e])),this.J[e].R=f.filter));this.field[e]=g}if(this.I)for(a=b.store,J(a)&&(a=[a]),b=0;b<a.length;b++)d=a[b],e=d.field||d,d.custom?(this.I[b]=
...
function Kb(a,b,c,d,e){return c&&1<a?b+(d||0)<=a?c+(e||0):(a-1)/(b+(d||0))*(c+(e||0))+1|0:0};O.prototype.search=function(a,b,c){c||(!b&&K(a)?(c=a,a=""):K(b)&&(c=b,b=0));var d=[],e=0,g;if(c){a=c.query||a;b=c.limit||b;e=c.offset||0;var f=c.context;var h=c.suggest;var k=(g=!1!==c.resolve)&&c.enrich;var l=c.boost;var m=c.resolution;var n=this.db&&c.tag}else g=this.resolve;var p=this.encoder.encode(a);var q=p.length;b=b||(g?100:0);if(1===q)return Mb.call(this,p[0],"",b,e,g,k,n);f=this.depth&&!1!==f;if(2===q&&f&&!h)return Mb.call(this,p[1],p[0],b,e,g,k,n);var t=I(),w=0;if(1<q&&f){var r=p[0];w=
1}m||0===m||(m=r?this.da:this.resolution);if(this.db){if(this.db.search&&(a=this.db.search(this,p,b,e,h,g,k,n),!1!==a))return a;var z=this;return function(){var A,v;return ta(function(x){switch(x.h){case 1:v=A=void 0;case 2:if(!(w<q)){x.h=4;break}v=p[w];if(!v||t[v]){x.h=5;break}t[v]=1;return D(x,Nb(z,v,r,0,0,!1,!1),6);case 6:A=x.D;if(A=Ob(A,d,h,m)){d=A;x.h=4;break}r&&(h&&A&&d.length||(r=v));case 5:h&&r&&w===q-1&&!d.length&&(m=z.resolution,r="",w=-1,t=I());w++;x.h=2;break;case 4:return x.return(Pb(d,
m,b,e,h,l,g))}})}()}for(c=a=void 0;w<q;w++){if((c=p[w])&&!t[c]){t[c]=1;a=Nb(this,c,r,0,0,!1,!1);if(a=Ob(a,d,h,m)){d=a;break}r&&(h&&a&&d.length||(r=c))}h&&r&&w===q-1&&!d.length&&(m=this.resolution,r="",w=-1,t=I())}return Pb(d,m,b,e,h,l,g)};function Pb(a,b,c,d,e,g,f){var h=a.length,k=a;if(1<h)k=jb(a,b,c,d,e,g,f);else if(1===h)return f?mb.call(null,a[0],c,d):new X(a[0]);return f?k:new X(k)}
...
b+c+d+"}":b+c+d};Ja(O.prototype);var Qb="undefined"!==typeof window&&(window.indexedDB||window.mozIndexedDB||window.webkitIndexedDB||window.msIndexedDB),Rb=["map","ctx","tag","reg","cfg"],Sb=I();
...
u.open=function(){if(this.db)return this.db;var a=this;navigator.storage&&navigator.storage.persist();Sb[a.id]||(Sb[a.id]=[]);Sb[a.id].push(a.field);var b=Qb.open(a.id,1);b.onupgradeneeded=function(){for(var c=a.db=this.result,d=0,e;d<Rb.length;d++){e=Rb[d];for(var g=0,f;g<Sb[a.id].length;g++)f=Sb[a.id][g],c.objectStoreNames.contains(e+("reg"!==e?f?":"+f:"":""))||c.createObjectStore(e+("reg"!==e?f?":"+f:"":""))}};return a.db=Z(b,function(c){a.db=c;a.db.onversionchange=function(){a.close()}})};
u.close=function(){this.db&&this.db.close();this.db=null};u.destroy=function(){var a=Qb.deleteDatabase(this.id);return Z(a)};u.clear=function(){for(var a=[],b=0,c;b<Rb.length;b++){c=Rb[b];for(var d=0,e;d<Sb[this.id].length;d++)e=Sb[this.id][d],a.push(c+("reg"!==c?e?":"+e:"":""))}b=this.db.transaction(a,"readwrite");for(c=0;c<a.length;c++)b.objectStore(a[c]).clear();return Z(b)};

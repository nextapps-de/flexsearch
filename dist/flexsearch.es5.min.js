/**!
 * FlexSearch.js v0.8.102 (ES5)
 * Author and Copyright: Thomas Wilkerling
 * Licence: Apache-2.0
 * Hosted by Nextapps GmbH
 * https://github.com/nextapps-de/flexsearch
 */
(function _f(self){'use strict';if(typeof module!=='undefined')self=module;else if(typeof process !== 'undefined')self=process;self._factory=_f;var t;function aa(a){var b=0;return function(){return b<a.length?{done:!1,value:a[b++]}:{done:!0}}}function x(a){var b="undefined"!=typeof Symbol&&Symbol.iterator&&a[Symbol.iterator];if(b)return b.call(a);if("number"==typeof a.length)return{next:aa(a)};throw Error(String(a)+" is not an iterable or ArrayLike");}var ba="function"==typeof Object.defineProperties?Object.defineProperty:function(a,b,c){if(a==Array.prototype||a==Object.prototype)return a;a[b]=c.value;return a};
...
function la(a,b){a.B={ma:b,na:!0};a.h=a.L}ja.prototype.return=function(a){this.B={return:a};this.h=this.L};function H(a,b,c){a.h=c;return{value:b}}function ma(a){this.h=new ja;this.A=a}function na(a,b){ka(a.h);var c=a.h.A;if(c)return oa(a,"return"in c?c["return"]:function(d){return{value:d,done:!0}},b,a.h.return);a.h.return(b);return pa(a)}
...
E("WeakMap",function(a){function b(k){this.h=(g+=Math.random()+1).toString();if(k){k=x(k);for(var l;!(l=k.next()).done;)l=l.value,this.set(l[0],l[1])}}function c(){}function d(k){var l=typeof k;return"object"===l&&null!==k||"function"===l}function e(k){if(!I(k,f)){var l=new c;ba(k,f,{value:l})}}function h(k){var l=Object[k];l&&(Object[k]=function(m){if(m instanceof c)return m;Object.isExtensible(m)&&e(m);return l(m)})}if(function(){if(!a||!Object.seal)return!1;try{var k=Object.seal({}),l=Object.seal({}),
...
["\u0477","\u0475"],["\u04c2","\u0436"],["\u04d1","\u0430"],["\u04d3","\u0430"],["\u04d7","\u0435"],["\u04db","\u04d9"],["\u04dd","\u0436"],["\u04df","\u0437"],["\u04e3","\u0438"],["\u04e5","\u0438"],["\u04e7","\u043e"],["\u04eb","\u04e9"],["\u04ed","\u044d"],["\u04ef","\u0443"],["\u04f1","\u0443"],["\u04f3","\u0443"],["\u04f5","\u0447"]];var Ca=/[^\p{L}\p{N}]+/u,Da=/(\d{3})/g,Ea=/(\D)(\d{3})/g,Fa=/(\d{3})(\D)/g,Ga="".normalize&&/[\u0300-\u036f]/g;function Ha(a){if(!this||this.constructor!==Ha){var b=Function.prototype.bind,c=b.apply,d=[null],e=d.concat;if(arguments instanceof Array)var h=arguments;else{h=x(arguments);for(var f,g=[];!(f=h.next()).done;)g.push(f.value);h=g}return new (c.call(b,Ha,e.call(d,h)))}for(b=0;b<arguments.length;b++)this.assign(arguments[b])}t=Ha.prototype;
...
function Ja(a){a.N.clear();a.O.clear()}
...
function O(a){function b(f){function g(k){k=k.data||k;var l=k.id,m=l&&e.h[l];m&&(m(k.msg),delete e.h[l])}this.worker=f;this.h=K();if(this.worker){d?this.worker.on("message",g):this.worker.onmessage=g;if(a.config)return new Promise(function(k){e.h[++Ma]=function(){k(e)};e.worker.postMessage({id:Ma,task:"init",factory:c,options:a})});this.worker.postMessage({task:"init",factory:c,options:a});return this}}a=void 0===a?{}:a;if(!this||this.constructor!==O)return new O(a);var c="undefined"!==typeof self?self._factory:
"undefined"!==typeof window?window._factory:null;c&&(c=c.toString());var d="undefined"===typeof window,e=this,h=Na(c,d,a.worker);return h.then?h.then(function(f){return b.call(e,f)}):b.call(this,h)}Oa("add");Oa("append");Oa("search");Oa("update");Oa("remove");
function Oa(a){O.prototype[a]=O.prototype[a+"Async"]=function(){var b=this,c=arguments,d,e,h,f,g;return ta(function(k){d=b;e=[].slice.call(c);h=e[e.length-1];"function"===typeof h&&(f=h,e.splice(e.length-1,1));g=new Promise(function(l){d.h[++Ma]=l;d.worker.postMessage({task:a,id:Ma,args:e})});return f?(g.then(f),k.return(b)):k.return(g)})}}
...
K();for(c=0;c<this.H.length;c++)if(d=this.H[c],h=d.S,!h||h(b)){h=void 0;if("function"===typeof d){h=d(b);if(!h)continue;d=[d.la]}else if(L(d)||d.constructor===String){q[d]=b[d];continue}eb(b,q,d,0,d[0],h)}}this.store.set(a,q||b)}}return this};function eb(a,b,c,d,e,h){a=a[e];if(d===c.length-1)b[e]=h||a;else if(a)if(a.constructor===Array)for(b=b[e]=Array(a.length),e=0;e<a.length;e++)eb(a,b,c,d,e);else b=b[e]||(b[e]=K()),e=c[++d],eb(a,b,c,d,e)}
...
0;Q<P.length;Q++)e[Q].result=P[Q];return k?kb(e,b):q?lb(e,a,Ia.index,Ia.field,Ia.I,q):e})}return k?kb(e,b):q?lb(e,a,this.index,this.field,this.I,q):e};
...
t.get=function(a){return this.db?this.index.get(this.field[0]).db.enrich(a).then(function(b){return b[0]&&b[0].doc}):this.store.get(a)};t.set=function(a,b){this.store.set(a,b);return this};t.searchCache=ob;
...
function zb(a,b,c,d,e){return c&&1<a?b+(d||0)<=a?c+(e||0):(a-1)/(b+(d||0))*(c+(e||0))+1|0:0};function X(a,b,c,d){if(1===a.length)return a=a[0],a=c||a.length>b?b?a.slice(c,c+b):a.slice(c):a,d?Cb(a):a;for(var e=[],h=0,f=void 0,g=void 0;h<a.length;h++)if((f=a[h])&&(g=f.length)){if(c){if(c>=g){c-=g;continue}c<g&&(f=b?f.slice(c,c+b):f.slice(c),g=f.length,c=0)}if(e.length)g>b&&(f=f.slice(0,b),g=f.length);else if(g>=b)return g>b&&(f=f.slice(0,b)),d?Cb(f):f;e.push(f);b-=g;if(!b)break}if(!e.length)return e;e=1<e.length?[].concat.apply([],e):e[0];return d?Cb(e):e}
...
else continue;d[g]=l;l.then&&c.push(l)}if(c.length)return Promise.all(c).then(function(){a.result=Gb.call(a,d,e,h,f);return f?a.result:a});d.length&&(this.result=Gb.call(this,d,e,h,f));return f?this.result:this};
...
K(),y=[],z=0,u=void 0;z<q;z++)if((u=n[z])&&!v[u]){if(g||this.db||Z(this,u))y.push(u),v[u]=1;else return h?d:new Y(d);u=u.length;c=Math.max(c,u);r=r?Math.min(r,u):u}n=y;q=a.length}if(!q)return h?d:new Y(d);var w=0;if(1===q)return Ib.call(this,n[0],"",b,e,h,k,p);if(2===q&&f&&!g)return Ib.call(this,n[0],n[1],b,e,h,k,p);if(1<q)if(f){var A=n[0];w=1}else 9<c&&3<c/r&&n.sort(xa);m||0===m||(m=this.resolution);if(this.db){if(this.db.search&&(a=this.db.search(this,n,b,e,g,h,k,p),!1!==a))return a;var D=this;
return function(){var B,R,F;return ta(function(G){switch(G.h){case 1:R=B=void 0;case 2:if(!(w<q)){G.h=4;break}R=n[w];return A?H(G,Z(D,R,A,0,0,!1,!1),8):H(G,Z(D,R,"",0,0,!1,!1),7);case 7:B=G.D;B=Jb(B,d,g,m);G.h=6;break;case 8:B=G.D,B=Jb(B,d,g,D.aa),g&&!1===B&&d.length||(A=R);case 6:if(B)return G.return(B);if(g&&w===q-1){F=d.length;if(!F){if(A){A="";w=-1;G.h=3;break}return G.return(d)}if(1===F)return G.return(h?X(d[0],b,e):new Y(d[0]))}case 3:w++;G.h=2;break;case 4:return G.return(h?fb(d,m,b,e,g,l,
h):new Y(d[0]))}})}()}for(f=a=void 0;w<q;w++){f=n[w];A?(a=Z(this,f,A,0,0,!1,!1),a=Jb(a,d,g,this.aa),g&&!1===a&&d.length||(A=f)):(a=Z(this,f,"",0,0,!1,!1),a=Jb(a,d,g,m));if(a)return a;if(g&&w===q-1){a=d.length;if(!a){if(A){A="";w=-1;continue}return d}if(1===a)return h?X(d[0],b,e):new Y(d[0])}}d=fb(d,m,b,e,g,l,h);return h?d:new Y(d)};
function Ib(a,b,c,d,e,h,f){a=Z(this,a,b,c,d,e,h,f);return this.db?a.then(function(g){return e?g:g&&g.length?e?X(g,c,d):new Y(g):e?[]:new Y([])}):a&&a.length?e?X(a,c,d):new Y(a):e?[]:new Y([])}function Jb(a,b,c,d){var e=[];if(a){d=Math.min(a.length,d);for(var h=0,f=void 0;h<d;h++)(f=a[h])&&f&&(e[h]=f);if(e.length){b.push(e);return}}return!c&&e}
...
function Lb(a){var b=0;if(a.constructor===Array)for(var c=0,d=void 0;c<a.length;c++)(d=a[c])&&(b+=d.length);else for(c=x(a),d=c.next();!d.done;d=c.next()){var e=d.value;d=e[0];(e=Lb(e[1]))?b+=e:a.delete(d)}return b}t.cleanup=function(){if(!this.fastupdate)return this;Lb(this.map);this.depth&&Lb(this.ctx);return this};t.searchCache=ob;
t.export=function(a,b,c,d){d=void 0===d?0:d;switch(d){case 0:var e="reg";var h=Va(this.reg);break;case 1:e="cfg";h={};break;case 2:e="map";h=Ra(this.map,this.reg.size);break;case 3:e="ctx";h=Ta(this.ctx,this.reg.size);break;default:return}return Xa.call(this,a,b,e,h,c,d)};
t.import=function(a,b){if(b)switch(L(b)&&(b=JSON.parse(b)),a=a.split("."),"json"===a[a.length-1]&&a.pop(),a=1<a.length?a[1]:a[0],a){case "reg":this.fastupdate=!1;this.reg=Wa(b,this.reg);break;case "map":this.map=Sa(b,this.map);break;case "ctx":this.ctx=Ua(b,this.ctx)}};
...
t.close=function(){this.db.close();this.db=null};t.destroy=function(){return Mb.deleteDatabase(this.id+(this.field?":"+this.field:""))};t.clear=function(){for(var a=this.db.transaction(Nb,"readwrite"),b=0;b<Nb.length;b++)a.objectStore(Nb[b]).clear();return Qb(a)};

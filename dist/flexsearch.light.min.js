...
d,c);break a}d=m}return d};function M(a,d,b){let f;b&&(f=a.bidirectional&&d>b)&&(f=b,b=d,d=f);a=b?(a=a.ctx.get(b))&&a.get(d):a.map.get(d);return a};J.prototype.remove=function(a,d){const b=this.reg.size&&(this.fastupdate?this.reg.get(a):this.reg.has(a));if(b){if(this.fastupdate)for(let f=0,c;f<b.length;f++){if(c=b[f])if(2>c.length)c.pop();else{const g=c.indexOf(a);g===b.length-1?c.pop():c.splice(g,1)}}else N(this.map,a),this.depth&&N(this.ctx,a);d||this.reg.delete(a)}return this};
function N(a,d){let b=0;if(a.constructor===Array)for(let f=0,c,g;f<a.length;f++){if((c=a[f])&&c.length)if(g=c.indexOf(d),0<=g){1<c.length?(c.splice(g,1),b++):delete a[f];break}else b++}else for(let f of a.entries()){const c=f[0],g=N(f[1],d);g?b+=g:a.delete(c)}return b};function J(a,d){if(!this||this.constructor!==J)return new J(a);if(a){var b="string"===typeof a?a:a.preset;b&&(a=Object.assign({},I[b],a))}else a={};b=a.context;const f=!0===b?{depth:1}:b||{},c=a.encode||a.encoder||{};this.encoder=c.encode?c:"object"===typeof c?new F(c):{encode:c};this.resolution=a.resolution||9;this.tokenize=b=(b=a.tokenize)&&"default"!==b&&"exact"!==b&&b||"strict";this.depth="strict"===b&&f.depth||0;this.bidirectional=!1!==f.bidirectional;this.fastupdate=!!a.fastupdate;this.score=
a.score||null;this.map=new Map;this.ctx=new Map;this.reg=d||(this.fastupdate?new Map:new Set);this.v=f.resolution||3;this.rtl=c.rtl||a.rtl||!1}r=J.prototype;r.clear=function(){this.map.clear();this.ctx.clear();this.reg.clear();return this};r.append=function(a,d){return this.add(a,d,!0)};r.contain=function(a){return this.reg.has(a)};r.update=function(a,d){const b=this,f=this.remove(a);return f&&f.then?f.then(()=>b.add(a,d)):this.add(a,d)};
function O(a){let d=0;if(a.constructor===Array)for(let b=0,f;b<a.length;b++)(f=a[b])&&(d+=f.length);else for(const b of a.entries()){const f=b[0],c=O(b[1]);c?d+=c:a.delete(f)}return d}r.cleanup=function(){if(!this.fastupdate)return this;O(this.map);this.depth&&O(this.ctx);return this};w();const P={Index:J,Charset:null,Encoder:F,Document:null,Worker:null,Resolver:null,IndexedDB:null,Language:{}},Q="undefined"!==typeof self?self:"undefined"!==typeof global?global:self;let R;(R=Q.define)&&R.amd?R([],function(){return P}):"object"===typeof Q.exports?Q.exports=P:Q.FlexSearch=P;}(this||self));

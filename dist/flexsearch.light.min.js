...
E.prototype.clear=function(){this.cache.clear();this.g=""};const F={normalize:function(a){return a.toLowerCase()},dedupe:!1};const G={memory:{resolution:1},performance:{resolution:6,fastupdate:!0,context:{depth:1,resolution:3}},match:{tokenize:"forward"},score:{resolution:9,context:{depth:2,resolution:9}}};u();H.prototype.add=function(a,c,b,d){if(c&&(a||0===a)){if(!d&&!b&&this.reg.has(a))return this.update(a,c);c=this.encoder.encode(c);if(d=c.length){const q=u(),p=u(),m=this.depth,r=this.resolution;for(let l=0;l<d;l++){let n=c[this.rtl?d-1-l:l];var e=n.length;if(e&&(m||!p[n])){var g=this.score?this.score(c,n,l,null,0):I(r,d,l),f="";switch(this.tokenize){case "full":if(2<e){for(g=0;g<e;g++)for(var h=e;h>g;h--){f=n.substring(g,h);var k=this.score?this.score(c,n,l,f,g):I(r,d,l,e,g);J(this,p,f,k,a,b)}break}case "reverse":if(1<
e){for(h=e-1;0<h;h--)f=n[h]+f,k=this.score?this.score(c,n,l,f,h):I(r,d,l,e,h),J(this,p,f,k,a,b);f=""}case "forward":if(1<e){for(h=0;h<e;h++)f+=n[h],J(this,p,f,g,a,b);break}default:if(J(this,p,n,g,a,b),m&&1<d&&l<d-1)for(e=u(),f=this.A,g=n,h=Math.min(m+1,d-l),e[g]=1,k=1;k<h;k++)if((n=c[this.rtl?d-1-l-k:l+k])&&!e[n]){e[n]=1;const A=this.score?this.score(c,g,l,n,k):I(f+(d/2>f?0:1),d,l,h-1,k-1),K=this.bidirectional&&n>g;J(this,q,K?g:n,A,a,b,K?n:g)}}}}this.fastupdate||this.reg.add(a)}}return this};

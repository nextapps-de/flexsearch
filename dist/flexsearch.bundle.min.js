...
function ib(a,b){const c=new Map;let e=b.index||b.field||b;L(e)&&(e=[e]);for(let d=0,f,g;d<e.length;d++){f=e[d];L(f)||(g=f,f=f.field);g=ca(g)?Object.assign({},a,g):a;if(this.worker){const k=new Ba(g);k.encoder=g.encoder;c.set(f,k)}this.worker||c.set(f,new O(g,this.reg));g.custom?this.F[d]=g.custom:(this.F[d]=fb(f,this.J),g.filter&&("string"===typeof this.F[d]&&(this.F[d]=new String(this.F[d])),this.F[d].I=g.filter));this.field[d]=f}if(this.C){a=b.store;L(a)&&(a=[a]);for(let d=0,f,g;d<a.length;d++)f=
a[d],g=f.field||f,f.custom?(this.C[d]=f.custom,f.custom.V=g):(this.C[d]=fb(g,this.J),f.filter&&("string"===typeof this.C[d]&&(this.C[d]=new String(this.C[d])),this.C[d].I=f.filter))}return c}function fb(a,b){const c=a.split(":");let e=0;for(let d=0;d<c.length;d++)a=c[d],"]"===a[a.length-1]&&(a=a.substring(0,a.length-2))&&(b[e]=!0),a&&(c[e++]=a);e<c.length&&(c.length=e);return 1<e?c:c[0]}v.append=function(a,b){return this.add(a,b,!0)};v.update=function(a,b){return this.remove(a).add(a,b)};

...
V.prototype.search = function(a, c, b, e) {
  ...
  for (let x = 0, r, E, F; x < l.length; x++) {
    ...
    if (m && F) {
      v = [];
      z = 0;
      for (let G = 0, I, Xa; G < m.length; G += 2) {
        I = this.tag.get(m[G]);
        if (!I) {
        ...
        if (Xa = (I = I && I.get(m[G + 1])) && I.length) {
          z++, v.push(I);
        } else if (!k) {
          return p ? d : new X(d);
        }
        ...
        if (d && (n || !m[q])) {
          ...
          switch(this.tokenize) {
            case "full":
              if (2 < d) {
                for (f = 0; f < d; f++) {
                  for (var h = d; h > f; h--) {
                    g = q.substring(f, h);
                    var k = this.score ? this.score(c, q, p, g, f) : Ya(t, e, p, d, f);
                    Z(this, m, g, k, a, b);
                  }
                }
                break;
            ...
            case "reverse":
              if (1 < d) {
                for (h = d - 1; 0 < h; h--) {
                  g = q[h] + g, k = this.score ? this.score(c, q, p, g, h) : Ya(t, e, p, d, h), Z(this, m, g, k, a, b);
                }
                g = "";
              }
            case "forward":
              ...
              if (Z(this, m, q, f, a, b), n && 1 < e && p < e - 1) {
                for (d = C(), g = this.S, f = q, h = Math.min(n + 1, e - p), d[f] = 1, k = 1; k < h; k++) {
                  if ((q = c[this.rtl ? e - 1 - p - k : p + k]) && !d[q]) {
                    d[q] = 1;
                    const y = this.score ? this.score(c, f, p, q, k) : Ya(g + (e / 2 > g ? 0 : 1), e, p, h - 1, k - 1), u = this.bidirectional && q > f;
...
;O.prototype.search = function(a, c, b) {
  ...
  c = c || (h ? 100 : 0);
  if (1 === a) {
    return Za.call(this, b[0], "", c, d, h);
  }
  f = this.depth && !1 !== f;
  if (2 === a && f && !g) {
    return Za.call(this, b[0], b[1], c, d, h);
  }
  h = C();
  let l = 0;
  if (1 < a && f) {

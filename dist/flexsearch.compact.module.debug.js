...
;const ba = /[^\p{L}\p{N}]+/u, ca = /(\d{3})/g, da = /(\D)(\d{3})/g, ea = /(\d{3})(\D)/g, G = "".normalize && /[\u0300-\u036f]/g, H = !G && [["\u00aa", "a"], ["\u00b2", "2"], ["\u00b3", "3"], ["\u00b9", "1"], ["\u00ba", "o"], ["\u00bc", "1\u20444"], ["\u00bd", "1\u20442"], ["\u00be", "3\u20444"], ["\u00e0", "a"], ["\u00e1", "a"], ["\u00e2", "a"], ["\u00e3", "a"], ["\u00e4", "a"], ["\u00e5", "a"], ["\u00e7", "c"], ["\u00e8", "e"], ["\u00e9", "e"], ["\u00ea", "e"], ["\u00eb", "e"], ["\u00ec", "i"], 
...
K.prototype.encode = function(a) {
  ...
  const c = !(this.A || this.B || this.filter || this.D || this.H || this.F);
  let b = [];
  ...
  for (let f = 0, d; f < a.length; f++) {
    ...
    let g;
    this.H && 2 < d.length && (this.S || (this.S = new RegExp("(?!^)(" + this.J + ")$")), d = d.replace(this.S, h => this.H.get(h)), g = 1);
    this.D && 1 < d.length && (this.R || (this.R = new RegExp("(" + this.K + ")", "g")), d = d.replace(this.R, h => this.D.get(h)), g = 1);
    d && g && (d.length < this.O || this.filter && this.filter.has(d)) && (d = "");
    if (d && (this.B || this.A && 1 < d.length)) {
      var e = "";
      for (let h = 0, k = "", n, l; h < d.length; h++) {
        n = d.charAt(h), n === k && this.A || ((l = this.B && this.B.get(n)) || "" === l ? l === k && this.A || !(k = l) || (e += l) : e += k = n);
      }
      d = e;
    }
    if (d && this.F) {
      for (e = 0; d && e < this.F.length; e += 2) {
        d = d.replace(this.F[e], this.F[e + 1]);
      }
    }
    d && b.push(d);
  }
...
const ia = {memory:{resolution:1}, performance:{resolution:6, fastupdate:!0, context:{depth:1, resolution:3}}, match:{tokenize:"forward"}, score:{resolution:9, context:{depth:2, resolution:9}}};
function ja(a) {
  L.call(a, "add");
  L.call(a, "append");
  L.call(a, "search");
  ...
  if (c && (a || 0 === a)) {
    ...
    if (e = c.length) {
      ...
      for (let p = 0; p < e; p++) {
        ...
        var f = m.length;
        if (f && (r || !l[m])) {
          var d = this.score ? this.score(c, m, p, null, 0) : N(t, e, p), g = "";
          switch(this.tokenize) {
            case "full":
              if (2 < f) {
                for (d = 0; d < f; d++) {
                  for (var h = f; h > d; h--) {
                    g = m.substring(d, h);
                    var k = this.score ? this.score(c, m, p, g, d) : N(t, e, p, f, d);
                    O(this, l, g, k, a, b);
                  }
                }
                break;
            ...
            case "reverse":
              if (1 < f) {
                for (h = f - 1; 0 < h; h--) {
                  g = m[h] + g, k = this.score ? this.score(c, m, p, g, h) : N(t, e, p, f, h), O(this, l, g, k, a, b);
                }
                g = "";
              }
            case "forward":
              if (1 < f) {
                for (h = 0; h < f; h++) {
                  g += m[h], O(this, l, g, d, a, b);
                }
                break;
              }
            default:
              if (O(this, l, m, d, a, b), r && 1 < e && p < e - 1) {
                for (f = y(), g = this.W, d = m, h = Math.min(r + 1, e - p), f[d] = 1, k = 1; k < h; k++) {
                  if ((m = c[this.rtl ? e - 1 - p - k : p + k]) && !f[m]) {
                    f[m] = 1;
                    const u = this.score ? this.score(c, d, p, m, k) : N(g + (e / 2 > g ? 0 : 1), e, p, h - 1, k - 1), B = this.bidirectional && m > d;
                    O(this, n, B ? d : m, u, a, b, B ? m : d);
                  }
                }
              }
          }
...
;M.prototype.search = function(a, c, b) {
  ...
  for (let r, t; n < b; n++) {
    t = a[n];
    l ? (r = R(this, t, l), r = ma(r, e, f, this.W, c, d, 2 === b), f && !1 === r && e.length || (l = t)) : (r = R(this, t), r = ma(r, e, f, this.resolution, c, d, 1 === b));
    if (r) {
      return r;
    }
    if (f && n === b - 1) {
...
function R(a, c, b) {
  ...
  a = b ? (a = a.G.get(e ? c : b)) && a.get(e ? b : c) : a.map.get(c);
  return a;
}
;M.prototype.remove = function(a, c) {
  ...
  if (b) {
    if (this.fastupdate) {
      ...
      S(this.map, a), this.depth && S(this.G, a);
    }
    c || this.h.delete(a);
  }
  return this;
...
;function M(a, c) {
  ...
  if (a) {
    ...
    b && (ia[b] || console.warn("Preset not found: " + b), a = Object.assign({}, ia[b], a));
  } else {
    a = {};
  }
  b = a.context || {};
  const e = a.encode || a.encoder || ha;
  ...
  if (c && (a || 0 === a)) {
    ...
    for (let f = 0, d; f < this.field.length; f++) {
      ...
      if ("function" === typeof d) {
        ...
        if (e = d.T, !e || e(c)) {
          d instanceof String ? d = ["" + d] : z(d) && (d = [d]), V(c, d, this.N, 0, g, a, d[0], b);
        }
      }
    }
    if (this.store && (!b || !this.store.has(a))) {
      ...
      if (this.C) {
        f = y();
        for (let d = 0, g; d < this.C.length; d++) {
          g = this.C[d];
          if ((b = g.T) && !b(c)) {
            continue;
          }
...
function W(a, c, b, e, f, d) {
  ...
  if (e === b.length - 1) {
    ...
    if (a.constructor === Array) {
      ...
      c = c[f] || (c[f] = y()), f = b[++e], W(a, c, b, e, f);
    }
  }
}
function V(a, c, b, e, f, d, g, h) {
  if (a = a[g]) {
    if (e === c.length - 1) {
      if (a.constructor === Array) {
        if (b[e]) {
...
;U.prototype.search = function(a, c, b, e) {
        ...
        if (!a) {
          ...
          if (m.length) {
            for (d = 0; d < m.length; d += 2) {
              t = na.call(this, m[d], m[d + 1], c, p, g), f.push({field:m[d], tag:m[d + 1], result:t});
            }
          }
  ...
  for (let v = 0, q, C, D; v < n.length; v++) {
    ...
    if (l && D) {
      m = [];
      u = 0;
      for (let I = 0, J, sa; I < l.length; I += 2) {
        J = this.tag.get(l[I]);
        if (!J) {
        ...
        if (sa = (J = J && J.get(l[I + 1])) && J.length) {
          u++, m.push(J);
        } else if (!k) {
          return f;
        }
...
;function U(a) {
  ...
  this.field = [];
  this.N = [];
  this.key = (b = c.key || c.id) && X(b, this.N) || "id";
  this.h = (this.fastupdate = !!a.fastupdate) ? new Map() : new Set();
  this.C = (b = c.store || null) && !0 !== b && [];
  ...
  for (let f = 0, d, g; f < e.length; f++) {
    d = e[f], z(d) || (g = d, d = d.field), g = E(g) ? Object.assign({}, a, g) : a, b.set(d, new M(g, this.h)), g.M ? this.I[f] = g.M : (this.I[f] = X(d, this.N), g.filter && ("string" === typeof this.I[f] && (this.I[f] = new String(this.I[f])), this.I[f].T = g.filter)), this.field[f] = d;
  }
  if (this.C) {
    a = c.store;
    z(a) && (a = [a]);
    for (let f = 0, d, g; f < a.length; f++) {
      d = a[f], g = d.field || d, d.M ? (this.C[f] = d.M, d.M.X = g) : (this.C[f] = X(g, this.N), d.filter && ("string" === typeof this.C[f] && (this.C[f] = new String(this.C[f])), this.C[f].T = d.filter));
    }
  }
  this.index = b;
}
...
var qa = {normalize:!0, A:!0, B:Z};
const ra = new Map([["ai", "ei"], ["ae", "a"], ["oe", "o"], ["ue", "u"], ["sh", "s"], ["ch", "c"], ["th", "t"], ["ph", "f"], ["pf", "f"]]), ta = [/([^aeo])h([aeo$])/g, "$1$2", /([aeo])h([^aeo]|$)/g, "$1$2"];
var ua = {normalize:!0, A:!0, B:Z, F:ta, D:ra};
var va = {normalize:!0, A:!0, B:Z, F:ta.concat([/(?!^)[aeoy]/g, ""]), D:ra};
...
Y["latin:advanced"] = ua;
Y["latin:extra"] = va;
Y["latin:soundex"] = {normalize:!0, A:!1, U:{Y:!0}, L:function(a) {
  for (let b = 0; b < a.length; b++) {
    var c = a[b];
    let e = c.charAt(0), f = wa[e];
    for (let d = 1, g; d < c.length && (g = c.charAt(d), "h" === g || "w" === g || !(g = wa[g]) || g === f || (e += g, f = g, 4 !== e.length)); d++) {
    }
    a[b] = e;
  }
}};
export default {Index:M, Charset:Y, Encoder:K, Document:U, Worker:null, Resolver:null, IndexedDB:null};

export const Index=M;export const  Charset=Y;export const  Encoder=K;export const  Document=U;export const  Worker=null;export const  Resolver=null;export const  IndexedDB=null;
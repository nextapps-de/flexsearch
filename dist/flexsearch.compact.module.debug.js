    ...
    if ((g = k = e[f]) && !(g.length < this.minlength || g.length > this.maxlength)) {
      if (c) {
        ...
        if (!this.filter || ("function" === typeof this.filter ? this.filter(g) : !this.filter.has(g))) {
          ...
          this.stemmer && 2 < g.length && (this.N || (this.N = new RegExp("(?!^)(" + this.D + ")$")), g = g.replace(this.N, h => this.stemmer.get(h)));
...
U.prototype.search = function(a, c, b, e) {
  ...
  for (let y = 0, r, E, F; y < h.length; y++) {
    ...
    if (l && F) {
      x = [];
      z = 0;
      for (let G = 0, O, Va; G < l.length; G += 2) {
        O = this.tag.get(l[G]);
        if (!O) {
        ...
        if (Va = (O = O && O.get(l[G + 1])) && O.length) {
          z++, x.push(O);
        } else if (!k) {
          return n ? d : new W(d);
        }
  ...
  if (c && (a || 0 === a)) {
    ...
    if (e = c.length) {
      ...
      for (let p = 0; p < e; p++) {
        ...
        var d = q.length;
        if (d && (n || !m[q])) {
          var f = this.score ? this.score(c, q, p, null, 0) : Wa(v, e, p), g = "";
              ...
              if (2 < d) {
                for (let u = 0, t; u < d; u++) {
                  for (f = d; f > u; f--) {
                    g = q.substring(u, f);
                    t = this.rtl ? d - 1 - u : u;
                    var k = this.score ? this.score(c, q, p, g, t) : Wa(v, e, p, d, t);
                    Z(this, m, g, k, a, b);
                  }
                }
                break;
            ...
            case "reverse":
              if (1 < d) {
                for (k = d - 1; 0 < k; k--) {
                  ...
                  var h = this.score ? this.score(c, q, p, g, k) : Wa(v, e, p, d, k);
                  Z(this, m, g, h, a, b);
                }
                g = "";
              }
              ...
              if (Z(this, m, q, f, a, b), n && 1 < e && p < e - 1) {
                for (d = C(), g = this.S, f = q, k = Math.min(n + 1, this.rtl ? p + 1 : e - p), d[f] = 1, h = 1; h < k; h++) {
                  if ((q = c[this.rtl ? e - 1 - p - h : p + h]) && !d[q]) {
                    d[q] = 1;
                    const u = this.score ? this.score(c, f, p, q, h - 1) : Wa(g + (e / 2 > g ? 0 : 1), e, p, k - 1, h - 1), t = this.bidirectional && q > f;

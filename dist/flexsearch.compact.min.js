...
(this.D?"|":"")+d;return this};x.addStemmer=function(a,c){this.stemmer||(this.stemmer=new Map);this.stemmer.set(a,c);this.D+=(this.D?"|":"")+a;this.N=null;this.cache&&L(this);return this};x.addFilter=function(a){this.filter||(this.filter=new Set);this.filter.add(a);this.cache&&L(this);return this};x.addMapper=function(a,c){if("object"===typeof a)return this.addReplacer(a,c);if(1<a.length)return this.addMatcher(a,c);this.mapper||(this.mapper=new Map);this.mapper.set(a,c);this.cache&&L(this);return this};
x.addMatcher=function(a,c){if("object"===typeof a)return this.addReplacer(a,c);if(2>a.length&&(this.dedupe||this.mapper))return this.addMapper(a,c);this.matcher||(this.matcher=new Map);this.matcher.set(a,c);this.h+=(this.h?"|":"")+a;this.M=null;this.cache&&L(this);return this};x.addReplacer=function(a,c){if("string"===typeof a)return this.addMatcher(a,c);this.replacer||(this.replacer=[]);this.replacer.push(a,c);this.cache&&L(this);return this};
...
function Ea(a,c,b,e,d){const f=[],g=C();let k=0;for(let h=0,l;h<a.length;h++)if(l=a[h]){k<l.length&&(k=l.length);for(let m=0,n;m<l.length;m++)if(n=l[m])for(let t=0,p;t<n.length;t++)p=n[t],g[p]=g[p]?2:1}for(let h=0,l,m=0;h<k;h++)for(let n=0,t;n<a.length;n++)if(t=a[n])if(l=t[h])for(let p=0,q;p<l.length;p++)if(q=l[p],1===g[q])if(b)b--;else if(e){if(f.push(q),f.length===c)return f}else{const v=h+(n?d:0);f[v]||(f[v]=[]);f[v].push(q);if(++m===c)return f}return f};X.prototype.not=function(){const {O:a,P:c,limit:b,offset:e,enrich:d,resolve:f,suggest:g}=Aa(this,"not",arguments);return Fa.call(this,a,c,b,e,d,f,g)};function Fa(a,c,b,e,d,f,g){if(c.length){const k=this;return Promise.all(c).then(function(h){a=[];for(let l=0,m;l<h.length;l++)(m=h[l]).length&&(a[l]=m);return Fa.call(k,a,[],b,e,d,f,g)})}if(a.length&&this.result.length)this.result=Ga.call(this,a,b,e,f);else if(f)return this.resolve(b,e,d);return f?d?W.call(this.index,this.result):this.result:this}
...
X.prototype.offset=function(a){if(this.result.length){const c=[];for(let b=0,e;b<this.result.length;b++)if(e=this.result[b])e.length<=a?a-=e.length:(c[b]=e.slice(a),a=0);this.result=c}return this};X.prototype.boost=function(a){this.h+=a;return this};X.prototype.resolve=function(a,c,b){const e=this.result,d=this.index;this.result=this.index=null;return e.length?("object"===typeof a&&(b=a.enrich,c=a.offset,a=a.limit),za.call(d,e,a||100,c,b)):e};C();V.prototype.search=function(a,c,b,e){b||(!c&&H(a)?(b=a,a=""):H(c)&&(b=c,c=0));let d=[];var f=[];let g,k,h,l,m,n,t=0,p=!0,q;if(b){b.constructor===Array&&(b={index:b});a=b.query||a;var v=b.pluck;k=b.merge;l=v||b.field||(l=b.index)&&(l.index?null:l);m=this.tag&&b.tag;h=b.suggest;p=!0;g=this.store&&b.enrich&&p;q=b.highlight&&g;c=b.limit||c;n=b.offset||0;c||(c=100);if(m){m.constructor!==Array&&(m=[m]);var u=[];for(let y=0,r;y<m.length;y++)if(r=m[y],r.field&&r.tag){var w=r.tag;if(w.constructor===Array)for(var z=
0;z<w.length;z++)u.push(r.field,w[z]);else u.push(r.field,w)}else{w=Object.keys(r);for(let E=0,F,A;E<w.length;E++)if(F=w[E],A=r[F],A.constructor===Array)for(z=0;z<A.length;z++)u.push(F,A[z]);else u.push(F,A)}m=u;if(!a){e=[];if(u.length)for(f=0;f<u.length;f+=2)v=Ha.call(this,u[f],u[f+1],c,n,g),d.push({field:u[f],tag:u[f+1],result:v});return e.length?Promise.all(e).then(function(y){for(let r=0;r<y.length;r++)d[r].result=y[r];return d}):d}}l&&l.constructor!==Array&&(l=[l])}l||(l=this.field);u=!e&&(this.worker||
this.db)&&[];for(let y=0,r,E,F;y<l.length;y++){E=l[y];let A;D(E)||(A=E,E=A.field,a=A.query||a,c=A.limit||c,n=A.offset||n,h=A.suggest||h,g=this.store&&(A.enrich||g));if(e)r=e[y];else if(w=A||b,z=this.index.get(E),m&&(w.enrich=!1),u){u[y]=z.search(a,c,w);w&&g&&(w.enrich=g);continue}else r=z.search(a,c,w),w&&g&&(w.enrich=g);F=r&&(p?r.length:r.result.length);if(m&&F){w=[];z=0;for(let J=0,G,Xa;J<m.length;J+=2){G=this.tag.get(m[J]);if(!G)if(h)continue;else return p?d:new X(d);if(Xa=(G=G&&G.get(m[J+1]))&&
G.length)z++,w.push(G);else if(!h)return p?d:new X(d)}if(z){r=ya(r,w);F=r.length;if(!F&&!h)return p?r:new X(r);z--}}if(F)f[t]=E,d.push(r),t++;else if(1===l.length)return p?d:new X(d)}if(u){const y=this;return Promise.all(u).then(function(r){return r.length?y.search(a,c,b,r):r})}if(!t)return p?d:new X(d);if(v&&(!g||!this.store))return d[0];u=[];for(let y=0,r;y<f.length;y++){r=d[y];g&&r.length&&!r[0].doc&&(r=W.call(this,r));if(v)return p?r:new X(r);d[y]={field:f[y],result:r}}return k?Ia(d,c):q?Ja(d,
a,this.index,this.field,this.C,q):d};
function Ja(a,c,b,e,d,f){let g,k,h;for(let m=0,n,t,p,q,v;m<a.length;m++){n=a[m].result;t=a[m].field;q=b.get(t);p=q.encoder;h=q.tokenize;v=d[e.indexOf(t)];p!==g&&(g=p,k=g.encode(c));for(let u=0;u<n.length;u++){let w="";var l=I(n[u].doc,v);let z=g.encode(l);l=l.split(g.split);for(let y=0,r,E;y<z.length;y++){r=z[y];E=l[y];let F;for(let A=0,J;A<k.length;A++)if(J=k[A],"strict"===h){if(r===J){w+=(w?" ":"")+f.replace("$1",E);F=!0;break}}else{const G=r.indexOf(J);if(-1<G){w+=(w?" ":"")+E.substring(0,G)+f.replace("$1",
E.substring(G,J.length))+E.substring(G+J.length);F=!0;break}}F||(w+=(w?" ":"")+l[y])}n[u].highlight=w}}return a}function Ia(a,c){const b=[],e=C();for(let d=0,f,g;d<a.length;d++){f=a[d];g=f.result;for(let k=0,h,l,m;k<g.length;k++)if(l=g[k],"object"!==typeof l&&(l={id:l}),h=l.id,m=e[h])m.push(f.field);else{if(b.length===c)return b;l.field=e[h]=[f.field];b.push(l)}}return b}
...
x.import=function(a,c){var b=a.split(".");"json"===b[b.length-1]&&b.pop();a=2<b.length?b[0]:"";b=2<b.length?b[2]:b[1];if(c){"string"===typeof c&&(c=JSON.parse(c));if(a)return this.index.get(a).import(b,c);switch(b){case "reg":this.fastupdate=!1;this.reg=ta(c,this.reg);for(let e=0,d;e<this.field.length;e++)d=this.index.get(this.field[e]),d.fastupdate=!1,d.reg=this.reg;break;case "tag":this.tag=ra(c,this.tag);break;case "doc":this.store=pa(c,this.store)}}};ja(V.prototype);function La(a,c,b){a=("object"===typeof a?""+a.query:a).toLowerCase();this.cache||(this.cache=new Y);let e=this.cache.get(a);if(!e){e=this.search(a,c,b);if(e.then){const d=this;e.then(function(f){d.cache.set(a,f);return f})}this.cache.set(a,e)}return e}function Y(a){this.limit=a&&!0!==a?a:1E3;this.cache=new Map;this.h=""}Y.prototype.set=function(a,c){this.cache.set(this.h=a,c);this.cache.size>this.limit&&this.cache.delete(this.cache.keys().next().value)};
...
g||"w"===g||!(g=Qa[g])||g===d||(e+=g,d=g,4!==e.length));f++);a[b]=e}}},ArabicDefault:{normalize:!1,dedupe:!0,prepare:function(a){return(""+a).replace(Ra," ")}},CjkDefault:{normalize:!1,dedupe:!0,split:"",prepare:function(a){return(""+a).replace(Sa,"")}},CyrillicDefault:{normalize:!1,dedupe:!0,prepare:function(a){return(""+a).replace(Ta," ")}}};const Va={memory:{resolution:1},performance:{resolution:3,fastupdate:!0,context:{depth:1,resolution:1}},match:{tokenize:"forward"},score:{resolution:9,context:{depth:2,resolution:3}}};O.prototype.add=function(a,c,b,e){if(c&&(a||0===a)){if(!e&&!b&&this.reg.has(a))return this.update(a,c);c=this.encoder.encode(c);if(e=c.length){const l=C(),m=C(),n=this.depth,t=this.resolution;for(let p=0;p<e;p++){let q=c[this.rtl?e-1-p:p];var d=q.length;if(d&&(n||!m[q])){var f=this.score?this.score(c,q,p,null,0):Wa(t,e,p),g="";switch(this.tokenize){case "full":if(2<d){for(let v=0,u;v<d;v++)for(f=d;f>v;f--){g=q.substring(v,f);u=this.rtl?d-1-v:v;var k=this.score?this.score(c,q,p,g,u):Wa(t,e,p,d,u);
Z(this,m,g,k,a,b)}break}case "reverse":if(1<d){for(k=d-1;0<k;k--){g=q[this.rtl?d-1-k:k]+g;var h=this.score?this.score(c,q,p,g,k):Wa(t,e,p,d,k);Z(this,m,g,h,a,b)}g=""}case "forward":if(1<d){for(k=0;k<d;k++)g+=q[this.rtl?d-1-k:k],Z(this,m,g,f,a,b);break}default:if(Z(this,m,q,f,a,b),n&&1<e&&p<e-1)for(d=C(),g=this.S,f=q,k=Math.min(n+1,this.rtl?p+1:e-p),d[f]=1,h=1;h<k;h++)if((q=c[this.rtl?e-1-p-h:p+h])&&!d[q]){d[q]=1;const v=this.score?this.score(c,f,p,q,h-1):Wa(g+(e/2>g?0:1),e,p,k-1,h-1),u=this.bidirectional&&
q>f;Z(this,l,u?f:q,v,a,b,u?q:f)}}}}this.fastupdate||this.reg.add(a)}}return this};function Z(a,c,b,e,d,f,g){let k=g?a.ctx:a.map,h;if(!c[b]||g&&!(h=c[b])[g])g?(c=h||(c[b]=C()),c[g]=1,(h=k.get(g))?k=h:k.set(g,k=new Map)):c[b]=1,(h=k.get(b))?k=h:k.set(b,k=[]),k=k[e]||(k[e]=[]),f&&k.includes(d)||(k.push(d),a.fastupdate&&((c=a.reg.get(d))?c.push(k):a.reg.set(d,[k])))}function Wa(a,c,b,e,d){return b&&1<a?c+(e||0)<=a?b+(d||0):(a-1)/(c+(e||0))*(b+(d||0))+1|0:0};O.prototype.search=function(a,c,b){b||(!c&&H(a)?(b=a,a=""):H(c)&&(b=c,c=0));var e=[],d=0;if(b){a=b.query||a;c=b.limit||c;d=b.offset||0;var f=b.context;var g=b.suggest;var k=!0;var h=b.resolution}else k=!0;a=this.encoder.encode(a);b=a.length;c=c||(k?100:0);if(1===b)return g=c,(c=Ya(this,a[0],""))&&c.length?za.call(this,c,g,d):[];f=this.depth&&!1!==f;if(2===b&&f&&!g)return g=c,(c=Ya(this,a[0],a[1]))&&c.length?za.call(this,c,g,d):[];k=C();let l=0;if(1<b&&f){var m=a[0];l=1}h||0===h||(h=m?this.S:this.resolution);
for(let q,v;l<b;l++){if((v=a[l])&&!k[v]){k[v]=1;q=Ya(this,v,m);a:{f=q;var n=e,t=g,p=h;let u=[];if(f&&f.length){if(f.length<=p){n.push(f);q=void 0;break a}for(let w=0,z;w<p;w++)if(z=f[w])u[w]=z;if(u.length){n.push(u);q=void 0;break a}}q=t?void 0:u}if(q){e=q;break}m&&(g&&q&&e.length||(m=v))}g&&m&&l===b-1&&!e.length&&(h=this.resolution,m="",l=-1,k=C())}a:{a=e;e=a.length;m=a;if(1<e)m=wa(a,h,c,d,g);else if(1===e){g=za.call(null,a[0],c,d);break a}g=m}return g};
function Ya(a,c,b){let e;b&&(e=a.bidirectional&&c>b)&&(e=b,b=c,c=e);a=b?(a=a.ctx.get(b))&&a.get(c):a.map.get(c);return a};O.prototype.remove=function(a,c){const b=this.reg.size&&(this.fastupdate?this.reg.get(a):this.reg.has(a));if(b){if(this.fastupdate)for(let e=0,d;e<b.length;e++){if(d=b[e])if(2>d.length)d.pop();else{const f=d.indexOf(a);f===b.length-1?d.pop():d.splice(f,1)}}else Za(this.map,a),this.depth&&Za(this.ctx,a);c||this.reg.delete(a)}this.cache&&this.cache.remove(a);return this};
function Za(a,c){let b=0;if(a.constructor===Array)for(let e=0,d,f;e<a.length;e++){if((d=a[e])&&d.length)if(f=d.indexOf(c),0<=f){1<d.length?(d.splice(f,1),b++):delete a[e];break}else b++}else for(let e of a.entries()){const d=e[0],f=Za(e[1],c);f?b+=f:a.delete(d)}return b};function O(a,c){if(!this||this.constructor!==O)return new O(a);if(a){var b=D(a)?a:a.preset;b&&(a=Object.assign({},Va[b],a))}else a={};b=a.context;const e=!0===b?{depth:1}:b||{},d=D(a.encoder)?Ua[a.encoder]:a.encode||a.encoder||Ma;this.encoder=d.encode?d:"object"===typeof d?new K(d):{encode:d};this.resolution=a.resolution||9;this.tokenize=(b=a.tokenize)&&"default"!==b&&b||"strict";this.depth="strict"===b&&e.depth||0;this.bidirectional=!1!==e.bidirectional;this.fastupdate=!!a.fastupdate;this.score=
...
x.update=function(a,c){const b=this,e=this.remove(a);return e&&e.then?e.then(()=>b.add(a,c)):this.add(a,c)};function $a(a){let c=0;if(a.constructor===Array)for(let b=0,e;b<a.length;b++)(e=a[b])&&(c+=e.length);else for(const b of a){const e=b[0],d=$a(b[1]);d?c+=d:a.delete(e)}return c}x.cleanup=function(){if(!this.fastupdate)return this;$a(this.map);this.depth&&$a(this.ctx);return this};x.searchCache=La;
...
m[0];g=m[1];for(const n of g.entries()){g=n[0];k=n[1];h="";for(let t=0,p;t<k.length;t++){p=k[t]||[""];l="";for(let q=0;q<p.length;q++)l+=(l?",":"")+("string"===b?'"'+p[q]+'"':p[q]);l="["+l+"]";h+=(h?",":"")+l}h='new Map([["'+g+'",['+h+"]]])";h='["'+f+'",'+h+"]";d+=(d?",":"")+h}}d="index.ctx=new Map(["+d+"]);";return a?"function inject(index){"+c+e+d+"}":c+e+d};ja(O.prototype);const ab={Index:O,Charset:Ua,Encoder:K,Document:V,Worker:null,Resolver:null,IndexedDB:null,Language:{}},bb=self;let cb;(cb=bb.define)&&cb.amd?cb([],function(){return ab}):"object"===typeof bb.exports?bb.exports=ab:bb.FlexSearch=ab;}(this||self));

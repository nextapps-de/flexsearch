 ...
 */
(function _f(self){'use strict';if(typeof module!=='undefined')self=module;else if(typeof process !== 'undefined')self=process;self._factory=_f;var u;function B(a,b,c){const e=typeof c,d=typeof a;if("undefined"!==e){if("undefined"!==d){if(c){if("function"===d&&e===d)return function(h){return a(c(h))};b=a.constructor;if(b===c.constructor){if(b===Array)return c.concat(a);if(b===Map){var g=new Map(c);for(var f of a)g.set(f[0],f[1]);return g}if(b===Set){f=new Set(c);for(g of a.values())f.add(g);return f}}}return a}return c}return"undefined"===d?b:a}function D(){return Object.create(null)}function aa(a,b){return b.length-a.length}
function E(a){return"string"===typeof a}function G(a){return"object"===typeof a}function I(a,b){if(E(b))a=a[b];else for(let c=0;a&&c<b.length;c++)a=a[b[c]];return a};var ba=[["\u00aa","a"],["\u00b2","2"],["\u00b3","3"],["\u00b9","1"],["\u00ba","o"],["\u00bc","1\u20444"],["\u00bd","1\u20442"],["\u00be","3\u20444"],["\u00e0","a"],["\u00e1","a"],["\u00e2","a"],["\u00e3","a"],["\u00e4","a"],["\u00e5","a"],["\u00e7","c"],["\u00e8","e"],["\u00e9","e"],["\u00ea","e"],["\u00eb","e"],["\u00ec","i"],["\u00ed","i"],["\u00ee","i"],["\u00ef","i"],["\u00f1","n"],["\u00f2","o"],["\u00f3","o"],["\u00f4","o"],["\u00f5","o"],["\u00f6","o"],["\u00f9","u"],["\u00fa","u"],["\u00fb",
...
["\u0477","\u0475"],["\u04c2","\u0436"],["\u04d1","\u0430"],["\u04d3","\u0430"],["\u04d7","\u0435"],["\u04db","\u04d9"],["\u04dd","\u0436"],["\u04df","\u0437"],["\u04e3","\u0438"],["\u04e5","\u0438"],["\u04e7","\u043e"],["\u04eb","\u04e9"],["\u04ed","\u044d"],["\u04ef","\u0443"],["\u04f1","\u0443"],["\u04f3","\u0443"],["\u04f5","\u0447"]];const ca=/[^\p{L}\p{N}]+/u,da=/(\d{3})/g,ea=/(\D)(\d{3})/g,fa=/(\d{3})(\D)/g,J="".normalize&&/[\u0300-\u036f]/g;function K(a){if(!this||this.constructor!==K)return new K(...arguments);for(let b=0;b<arguments.length;b++)this.assign(arguments[b])}u=K.prototype;
u.assign=function(a){this.normalize=B(a.normalize,!0,this.normalize);let b=a.include,c=b||a.exclude||a.split;if("object"===typeof c){let e=!b,d="";a.include||(d+="\\p{Z}");c.letter&&(d+="\\p{L}");c.number&&(d+="\\p{N}",e=!!b);c.symbol&&(d+="\\p{S}");c.punctuation&&(d+="\\p{P}");c.control&&(d+="\\p{C}");if(c=c.char)d+="object"===typeof c?c.join(""):c;try{this.split=new RegExp("["+(b?"^":"")+d+"]+","u")}catch(g){this.split=/\s+/}this.numeric=e}else{try{this.split=B(c,ca,this.split)}catch(e){this.split=
/\s+/}this.numeric=B(this.numeric,!0)}this.prepare=B(a.prepare,null,this.prepare);this.finalize=B(a.finalize,null,this.finalize);J||(this.mapper=new Map(ba));this.rtl=a.rtl||!1;this.dedupe=B(a.dedupe,!1,this.dedupe);this.filter=B((c=a.filter)&&new Set(c),null,this.filter);this.matcher=B((c=a.matcher)&&new Map(c),null,this.matcher);this.mapper=B((c=a.mapper)&&new Map(c),null,this.mapper);this.stemmer=B((c=a.stemmer)&&new Map(c),null,this.stemmer);this.replacer=B(a.replacer,null,this.replacer);this.minlength=
...
function S(a,b){const c=a.split(":");let e=0;for(let d=0;d<c.length;d++)a=c[d],"]"===a[a.length-1]&&(a=a.substring(0,a.length-2))&&(b[e]=!0),a&&(c[e++]=a);e<c.length&&(c.length=e);return 1<e?c:c[0]}u=R.prototype;u.append=function(a,b){return this.add(a,b,!0)};u.update=function(a,b){return this.remove(a).add(a,b)};
...
f||"w"===f||!(f=za[f])||f===d||(e+=f,d=f,4!==e.length));g++);a[c]=e}}},ArabicDefault:{rtl:!0,normalize:!1,dedupe:!0,prepare:function(a){return(""+a).replace(Aa," ")}},CjkDefault:{normalize:!1,dedupe:!0,split:"",prepare:function(a){return(""+a).replace(Ba,"")}},CyrillicDefault:{normalize:!1,dedupe:!0,prepare:function(a){return(""+a).replace(Ca," ")}}};const Ea={memory:{resolution:1},performance:{resolution:6,fastupdate:!0,context:{depth:1,resolution:3}},match:{tokenize:"forward"},score:{resolution:9,context:{depth:2,resolution:9}}};D();U.prototype.add=function(a,b,c,e){if(b&&(a||0===a)){if(!e&&!c&&this.reg.has(a))return this.update(a,b);b=this.encoder.encode(b);if(e=b.length){const l=D(),m=D(),r=this.depth,t=this.resolution;for(let p=0;p<e;p++){let n=b[this.rtl?e-1-p:p];var d=n.length;if(d&&(r||!m[n])){var g=this.score?this.score(b,n,p,null,0):V(t,e,p),f="";switch(this.tokenize){case "full":if(2<d){for(g=0;g<d;g++)for(var h=d;h>g;h--){f=n.substring(g,h);var k=this.score?this.score(b,n,p,f,g):V(t,e,p,d,g);W(this,m,f,k,a,c)}break}case "reverse":if(1<
d){for(h=d-1;0<h;h--)f=n[h]+f,k=this.score?this.score(b,n,p,f,h):V(t,e,p,d,h),W(this,m,f,k,a,c);f=""}case "forward":if(1<d){for(h=0;h<d;h++)f+=n[h],W(this,m,f,g,a,c);break}default:if(W(this,m,n,g,a,c),r&&1<e&&p<e-1)for(d=D(),f=this.P,g=n,h=Math.min(r+1,e-p),d[g]=1,k=1;k<h;k++)if((n=b[this.rtl?e-1-p-k:p+k])&&!d[n]){d[n]=1;const v=this.score?this.score(b,g,p,n,k):V(f+(e/2>f?0:1),e,p,h-1,k-1),w=this.bidirectional&&n>g;W(this,l,w?g:n,v,a,c,w?n:g)}}}}this.fastupdate||this.reg.add(a)}}return this};
function W(a,b,c,e,d,g,f){let h=f?a.ctx:a.map,k;if(!b[c]||f&&!(k=b[c])[f])f?(b=k||(b[c]=D()),b[f]=1,(k=h.get(f))?h=k:h.set(f,h=new Map)):b[c]=1,(k=h.get(c))?h=k:h.set(c,h=[]),h=h[e]||(h[e]=[]),g&&h.includes(d)||(h.push(d),a.fastupdate&&((b=a.reg.get(d))?b.push(h):a.reg.set(d,[h])))}function V(a,b,c,e,d){return c&&1<a?b+(e||0)<=a?c+(d||0):(a-1)/(b+(e||0))*(c+(d||0))+1|0:0};function Fa(a,b,c){if(1===a.length)return a=a[0],a=c||a.length>b?b?a.slice(c,c+b):a.slice(c):a;let e=[];for(let d=0,g,f;d<a.length;d++)if((g=a[d])&&(f=g.length)){if(c){if(c>=f){c-=f;continue}c<f&&(g=b?g.slice(c,c+b):g.slice(c),f=g.length,c=0)}if(e.length)f>b&&(g=g.slice(0,b),f=g.length);else if(f>=b)return f>b&&(g=g.slice(0,b)),g;e.push(g);b-=f;if(!b)break}return e.length?e=1<e.length?[].concat.apply([],e):e[0]:e};U.prototype.search=function(a,b,c){c||(!b&&G(a)?(c=a,a=""):G(b)&&(c=b,b=0));var e=[],d=0;if(c){a=c.query||a;b=c.limit||b;d=c.offset||0;var g=c.context;var f=c.suggest;var h=!0;var k=c.resolution}else h=!0;c=this.encoder.encode(a);a=c.length;b||!h||(b=100);if(1===a)return X.call(this,c[0],"",b,d);g=this.depth&&!1!==g;if(2===a&&g&&!f)return X.call(this,c[0],c[1],b,d);var l=h=0;if(1<a){var m=D();const t=[];for(let p=0,n;p<a;p++)if((n=c[p])&&!m[n]){if(f||Y(this,n))t.push(n),m[n]=1;else return e;const v=
n.length;h=Math.max(h,v);l=l?Math.min(l,v):v}c=t;a=c.length}if(!a)return e;m=0;if(1===a)return X.call(this,c[0],"",b,d);if(2===a&&g&&!f)return X.call(this,c[0],c[1],b,d);if(1<a)if(g){var r=c[0];m=1}else 9<h&&3<h/l&&c.sort(aa);k||0===k||(k=this.resolution);for(let t,p;m<a;m++){p=c[m];r?(t=Y(this,p,r),t=Ga(t,e,f,this.P),f&&!1===t&&e.length||(r=p)):(t=Y(this,p,""),t=Ga(t,e,f,k));if(t)return t;if(f&&m===a-1){g=e.length;if(!g){if(r){r="";m=-1;continue}return e}if(1===g)return Fa(e[0],b,d)}}a:{r=f;g=e.length;
f=[];a=D();for(let t=0,p,n,v,w;t<k;t++)for(h=0;h<g;h++)if(v=e[h],t<v.length&&(p=v[t]))for(l=0;l<p.length;l++)n=p[l],(c=a[n])?a[n]++:(c=0,a[n]=1),w=f[c]||(f[c]=[]),w.push(n);if(k=f.length)if(r){if(1<f.length)b:for(k=[],e=D(),r=f.length,c=r-1;0<=c;c--)for(r=f[c],a=r.length,h=0;h<a;h++){if(g=r[h],!e[g])if(e[g]=1,d)d--;else if(k.push(g),k.length===b)break b}else k=(f=f[0]).length>b||d?f.slice(d,b+d):f;f=k}else{if(k<g){e=[];break a}f=f[k-1];if(b||d)if(f.length>b||d)f=f.slice(d,b+d)}e=f}return e};
...
function Ha(a,b){let c=0;if(a.constructor===Array)for(let e=0,d,g;e<a.length;e++){if((d=a[e])&&d.length)if(g=d.indexOf(b),0<=g){1<d.length?(d.splice(g,1),c++):delete a[e];break}else c++}else for(let e of a){const d=e[0],g=Ha(e[1],b);g?c+=g:a.delete(d)}return c};function U(a,b){if(!this||this.constructor!==U)return new U(a);if(a){var c=E(a)?a:a.preset;c&&(a=Object.assign({},Ea[c],a))}else a={};c=a.context;const e=!0===c?{depth:1}:c||{},d=E(a.encoder)?Da[a.encoder]:a.encode||a.encoder||va;this.encoder=d.encode?d:"object"===typeof d?new K(d):{encode:d};this.resolution=a.resolution||9;this.tokenize=c=a.tokenize||"strict";this.depth="strict"===c&&e.depth||0;this.bidirectional=!1!==e.bidirectional;this.fastupdate=!!a.fastupdate;this.score=a.score||null;c=!1;this.map=
new Map;this.ctx=new Map;this.reg=b||(this.fastupdate?new Map:new Set);this.P=e.resolution||3;this.rtl=d.rtl||a.rtl||!1;this.cache=(c=a.cache||null)&&new T(c)}u=U.prototype;u.clear=function(){this.map.clear();this.ctx.clear();this.reg.clear();this.cache&&this.cache.clear();return this};u.append=function(a,b){return this.add(a,b,!0)};u.contain=function(a){return this.reg.has(a)};u.update=function(a,b){const c=this,e=this.remove(a);return e&&e.then?e.then(()=>c.add(a,b)):this.add(a,b)};
function Ia(a){let b=0;if(a.constructor===Array)for(let c=0,e;c<a.length;c++)(e=a[c])&&(b+=e.length);else for(const c of a){const e=c[0],d=Ia(c[1]);d?b+=d:a.delete(e)}return b}u.cleanup=function(){if(!this.fastupdate)return this;Ia(this.map);this.depth&&Ia(this.ctx);return this};u.searchCache=ua;
u.export=function(a,b,c,e=0){let d,g;switch(e){case 0:d="reg";g=la(this.reg);break;case 1:d="cfg";g={};break;case 2:d="map";g=O(this.map,this.reg.size);break;case 3:d="ctx";g=ja(this.ctx,this.reg.size);break;default:return}return Q.call(this,a,b,d,g,c,e)};
u.import=function(a,b){if(b)switch(E(b)&&(b=JSON.parse(b)),a=a.split("."),"json"===a[a.length-1]&&a.pop(),a=1<a.length?a[1]:a[0],a){case "reg":this.fastupdate=!1;this.reg=ma(b,this.reg);break;case "map":this.map=P(b,this.map);break;case "ctx":this.ctx=ka(b,this.ctx)}};

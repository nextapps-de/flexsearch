...
E.substring(G,J.length))+E.substring(G+J.length);F=!0;break}}F||(u+=(u?" ":"")+l[x])}n[w].highlight=u}}return a}function Ia(a,c){const b=[],e=C();for(let d=0,f,g;d<a.length;d++){f=a[d];g=f.result;for(let k=0,h,l,m;k<g.length;k++)if(l=g[k],h=l.id,m=e[h])m.push(f.field);else{if(b.length===c)return b;l.field=e[h]=[f.field];b.push(l)}}return b}function Ha(a,c,b,e,d){a=this.tag.get(a);if(!a)return[];if((c=(a=a&&a.get(c))&&a.length-e)&&0<c){if(c>b||e)a=a.slice(e,e+b);d&&(a=W.call(this,a));return a}}
...
function Ka(a,c){const b=a.split(":");let e=0;for(let d=0;d<b.length;d++)a=b[d],"]"===a[a.length-1]&&(a=a.substring(0,a.length-2))&&(c[e]=!0),a&&(b[e++]=a);e<b.length&&(b.length=e);return 1<e?b:b[0]}v=V.prototype;v.append=function(a,c){return this.add(a,c,!0)};v.update=function(a,c){return this.remove(a).add(a,c)};
...
for(let q,y;l<b;l++){if((y=a[l])&&!k[y]){k[y]=1;q=Ya(this,y,m);a:{f=q;var n=e,t=g,p=h;let w=[];if(f&&f.length){if(f.length<=p){n.push(f);q=void 0;break a}for(let u=0,z;u<p;u++)if(z=f[u])w[u]=z;if(w.length){n.push(w);q=void 0;break a}}q=t?void 0:w}if(q){e=q;break}m&&(g&&q&&e.length||(m=y))}g&&m&&l===b-1&&!e.length&&(m="",l=-1,k=C())}a:{a=e;e=a.length;m=a;if(1<e)m=wa(a,h,c,d,g);else if(1===e){g=za.call(null,a[0],c,d);break a}g=m}return g};
...
v.update=function(a,c){const b=this,e=this.remove(a);return e&&e.then?e.then(()=>b.add(a,c)):this.add(a,c)};function $a(a){let c=0;if(a.constructor===Array)for(let b=0,e;b<a.length;b++)(e=a[b])&&(c+=e.length);else for(const b of a){const e=b[0],d=$a(b[1]);d?c+=d:a.delete(e)}return c}v.cleanup=function(){if(!this.fastupdate)return this;$a(this.map);this.depth&&$a(this.ctx);return this};v.searchCache=La;
v.export=function(a,c,b=0,e=0){let d,f;switch(e){case 0:d="reg";f=sa(this.reg);break;case 1:d="cfg";f=null;break;case 2:d="map";f=oa(this.map,this.reg.size);break;case 3:d="ctx";f=qa(this.ctx,this.reg.size);break;default:return}return U.call(this,a,c,d,f,b,e)};

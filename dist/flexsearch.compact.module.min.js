 ...
 */
var B;function I(a,c,b){const e=typeof b,d=typeof a;if(e!=="undefined"){if(d!=="undefined"){if(b){if(d==="function"&&e===d)return function(h){return a(b(h))};c=a.constructor;if(c===b.constructor){if(c===Array)return b.concat(a);if(c===Map){var f=new Map(b);for(var g of a)f.set(g[0],g[1]);return f}if(c===Set){g=new Set(b);for(f of a.values())g.add(f);return g}}}return a}return b}return d==="undefined"?c:a}function J(a,c){return typeof a==="undefined"?c:a}function N(){return Object.create(null)}
function P(a){return typeof a==="string"}function R(a){return typeof a==="object"}function aa(a,c){if(P(c))a=a[c];else for(let b=0;a&&b<c.length;b++)a=a[c[b]];return a};const ba=/[^\p{L}\p{N}]+/u,ea=/(\d{3})/g,fa=/(\D)(\d{3})/g,ha=/(\d{3})(\D)/g,ka=/[\u0300-\u036f]/g;function la(a={}){if(!this||this.constructor!==la)return new la(...arguments);if(arguments.length)for(a=0;a<arguments.length;a++)this.assign(arguments[a]);else this.assign(a)}B=la.prototype;
B.assign=function(a){this.normalize=I(a.normalize,!0,this.normalize);let c=a.include,b=c||a.exclude||a.split,e;if(b||b===""){if(typeof b==="object"&&b.constructor!==RegExp){let d="";e=!c;c||(d+="\\p{Z}");b.letter&&(d+="\\p{L}");b.number&&(d+="\\p{N}",e=!!c);b.symbol&&(d+="\\p{S}");b.punctuation&&(d+="\\p{P}");b.control&&(d+="\\p{C}");if(b=b.char)d+=typeof b==="object"?b.join(""):b;try{this.split=new RegExp("["+(c?"^":"")+d+"]+","u")}catch(f){this.split=/\s+/}}else this.split=b,e=b===!1||"a1a".split(b).length<
2;this.numeric=I(a.numeric,e)}else{try{this.split=I(this.split,ba)}catch(d){this.split=/\s+/}this.numeric=I(a.numeric,I(this.numeric,!0))}this.prepare=I(a.prepare,null,this.prepare);this.finalize=I(a.finalize,null,this.finalize);b=a.filter;this.filter=typeof b==="function"?b:I(b&&new Set(b),null,this.filter);this.dedupe=I(a.dedupe,!0,this.dedupe);this.matcher=I((b=a.matcher)&&new Map(b),null,this.matcher);this.mapper=I((b=a.mapper)&&new Map(b),null,this.mapper);this.stemmer=I((b=a.stemmer)&&new Map(b),
null,this.stemmer);this.replacer=I(a.replacer,null,this.replacer);this.minlength=I(a.minlength,1,this.minlength);this.maxlength=I(a.maxlength,1024,this.maxlength);this.rtl=I(a.rtl,!1,this.rtl);if(this.cache=b=I(a.cache,!0,this.cache))this.D=null,this.K=typeof b==="number"?b:2E5,this.B=new Map,this.C=new Map,this.H=this.G=128;this.h="";this.I=null;this.A="";this.J=null;if(this.matcher)for(const d of this.matcher.keys())this.h+=(this.h?"|":"")+d;if(this.stemmer)for(const d of this.stemmer.keys())this.A+=
...
[],d=N(),f,g,h=this.split||this.split===""?a.split(this.split):[a];for(let n=0,l,z;n<h.length;n++)if((l=z=h[n])&&!(l.length<this.minlength||l.length>this.maxlength)){if(c){if(d[l])continue;d[l]=1}else{if(f===l)continue;f=l}if(b)e.push(l);else if(!this.filter||(typeof this.filter==="function"?this.filter(l):!this.filter.has(l))){if(this.cache&&l.length<=this.H)if(this.D){var k=this.C.get(l);if(k||k===""){k&&e.push(k);continue}}else this.D=setTimeout(S,50,this);if(this.stemmer){this.J||(this.J=new RegExp("(?!^)("+
...
this.replacer[k+1]);this.cache&&z.length<=this.H&&(this.C.set(z,l),this.C.size>this.K&&(this.C.clear(),this.H=this.H/1.1|0));if(l){if(l!==z)if(c){if(d[l])continue;d[l]=1}else{if(g===l)continue;g=l}e.push(l)}}}this.finalize&&(e=this.finalize(e)||e);this.cache&&a.length<=this.G&&(this.B.set(a,e),this.B.size>this.K&&(this.B.clear(),this.G=this.G/1.1|0));return e};function S(a){a.D=null;a.B.clear();a.C.clear()};function ma(a,c,b){b||(c||typeof a!=="object"?typeof c==="object"&&(b=c,c=0):b=a);b&&(a=b.query||a,c=b.limit||c);let e=""+(c||0);b&&(e+=(b.offset||0)+!!b.context+!!b.suggest+(b.resolve!==!1)+(b.resolution||this.resolution)+(b.boost||0));a=(""+a).toLowerCase();this.cache||(this.cache=new T);let d=this.cache.get(a+e);if(!d){const f=b&&b.cache;f&&(b.cache=!1);d=this.search(a,c,b);f&&(b.cache=f);this.cache.set(a+e,d)}return d}function T(a){this.limit=a&&a!==!0?a:1E3;this.cache=new Map;this.h=""}
...
function U(a){this[a+"Async"]=function(){const c=arguments;var b=c[c.length-1];let e;typeof b==="function"&&(e=b,delete c[c.length-1]);xa?za||(za=Date.now()-ya>=this.priority*this.priority*3):(xa=setTimeout(Aa,0),ya=Date.now());if(za){const f=this;return new Promise(g=>{setTimeout(function(){g(f[a+"Async"].apply(f,c))},0)})}const d=this[a].apply(this,c);b=d.then?d:new Promise(f=>f(d));e&&b.then(e);return b}};X.prototype.add=function(a,c,b){R(a)&&(c=a,a=aa(c,this.key));if(c&&(a||a===0)){if(!b&&this.reg.has(a))return this.update(a,c);for(let h=0,k;h<this.field.length;h++){k=this.B[h];var e=this.index.get(this.field[h]);if(typeof k==="function"){var d=k(c);d&&e.add(a,d,!1,!0)}else if(d=k.F,!d||d(c))k.constructor===String?k=[""+k]:P(k)&&(k=[k]),Ba(c,k,this.C,0,e,a,k[0],b)}if(this.tag)for(e=0;e<this.A.length;e++){var f=this.A[e];d=this.tag.get(this.D[e]);let h=N();if(typeof f==="function"){if(f=f(c),!f)continue}else{var g=
f.F;if(g&&!g(c))continue;f.constructor===String&&(f=""+f);f=aa(c,f)}if(d&&f){P(f)&&(f=[f]);for(let k=0,n,l;k<f.length;k++)n=f[k],h[n]||(h[n]=1,(g=d.get(n))?l=g:d.set(n,l=[]),b&&l.includes(a)||(l.push(a),this.fastupdate&&((g=this.reg.get(a))?g.push(l):this.reg.set(a,[l]))))}}if(this.store&&(!b||!this.store.has(a))){let h;if(this.h){h=N();for(let k=0,n;k<this.h.length;k++){n=this.h[k];if((b=n.F)&&!b(c))continue;let l;if(typeof n==="function"){l=n(c);if(!l)continue;n=[n.M]}else if(P(n)||n.constructor===
String){h[n]=c[n];continue}Ca(c,h,n,0,n[0],l)}}this.store.set(a,h||c)}}return this};function Ca(a,c,b,e,d,f){a=a[d];if(e===b.length-1)c[d]=f||a;else if(a)if(a.constructor===Array)for(c=c[d]=Array(a.length),d=0;d<a.length;d++)Ca(a,c,b,e,d);else c=c[d]||(c[d]=N()),d=b[++e],Ca(a,c,b,e,d)}
function Ba(a,c,b,e,d,f,g,h){if(a=a[g])if(e===c.length-1){if(a.constructor===Array){if(b[e]){for(c=0;c<a.length;c++)d.add(f,a[c],!0,!0);return}a=a.join(" ")}d.add(f,a,h,!0)}else if(a.constructor===Array)for(g=0;g<a.length;g++)Ba(a,c,b,e,d,f,g,h);else g=c[++e],Ba(a,c,b,e,d,f,g,h)};function Da(a,c,b){if(!a.length)return a;if(a.length===1)return a=a[0],a=b||a.length>c?a.slice(b,b+c):a;let e=[];for(let d=0,f,g;d<a.length;d++)if((f=a[d])&&(g=f.length)){if(b){if(b>=g){b-=g;continue}f=f.slice(b,b+c);g=f.length;b=0}g>c&&(f=f.slice(0,c),g=c);if(!e.length&&g>=c)return f;e.push(f);c-=g;if(!c)break}return e=e.length>1?[].concat.apply([],e):e[0]};function Ea(a,c,b,e,d){let f,g,h;typeof d==="string"?(f=d,d=""):f=d.template;g=f.indexOf("$1");h=f.substring(g+2);g=f.substring(0,g);let k=d&&d.boundary,n=!d||d.clip!==!1,l=d&&d.merge&&h&&g&&new RegExp(h+" "+g,"g");d=d&&d.ellipsis;var z=0;if(typeof d==="object"){var x=d.template;z=x.length-2;d=d.pattern}typeof d!=="string"&&(d=d===!1?"":"...");z&&(d=x.replace("$1",d));x=d.length-z;let u,p;typeof k==="object"&&(u=k.before,u===0&&(u=-1),p=k.after,p===0&&(p=-1),k=k.total||9E5);z=new Map;for(let sa=0,
V,Ha,ca;sa<c.length;sa++){let da;if(e)da=c,ca=e;else{var w=c[sa];ca=w.field;if(!ca)continue;da=w.result}Ha=b.get(ca);V=Ha.encoder;w=z.get(V);typeof w!=="string"&&(w=V.encode(a),z.set(V,w));for(let ia=0;ia<da.length;ia++){var m=da[ia].doc;if(!m)continue;m=aa(m,ca);if(!m)continue;var v=m.trim().split(/\s+/);if(!v.length)continue;m="";var r=[];let ja=[];var C=-1,A=-1,t=0;for(var y=0;y<v.length;y++){var E=v[y],D=V.encode(E);D=D.length>1?D.join(" "):D[0];let q;if(D&&E){var F=E.length,K=(V.split?E.replace(V.split,
""):E).length-D.length,L="",Q=0;for(var W=0;W<w.length;W++){var M=w[W];if(M){var H=M.length;H+=K;Q&&H<=Q||(M=D.indexOf(M),M>-1&&(L=(M?E.substring(0,M):"")+g+E.substring(M,M+H)+h+(M+H<F?E.substring(M+H):""),Q=H,q=!0))}}L&&(k&&(C<0&&(C=m.length+(m?1:0)),A=m.length+(m?1:0)+L.length,t+=F,ja.push(r.length),r.push({match:L})),m+=(m?" ":"")+L)}if(!q)E=v[y],m+=(m?" ":"")+E,k&&r.push({text:E});else if(k&&t>=k)break}t=ja.length*(f.length-2);if(u||p||k&&m.length-t>k)if(t=k+t-x*2,y=A-C,u>0&&(y+=u),p>0&&(y+=p),
y<=t)v=u?C-(u>0?u:0):C-((t-y)/2|0),r=p?A+(p>0?p:0):v+t,n||(v>0&&m.charAt(v)!==" "&&m.charAt(v-1)!==" "&&(v=m.indexOf(" ",v),v<0&&(v=0)),r<m.length&&m.charAt(r-1)!==" "&&m.charAt(r)!==" "&&(r=m.lastIndexOf(" ",r),r<A?r=A:++r)),m=(v?d:"")+m.substring(v,r)+(r<m.length?d:"");else{A=[];C={};t={};y={};E={};D={};L=K=F=0;for(W=Q=1;;){var O=void 0;for(let q=0,G;q<ja.length;q++){G=ja[q];if(L)if(K!==L){if(y[q+1])continue;G+=L;if(C[G]){F-=x;t[q+1]=1;y[q+1]=1;continue}if(G>=r.length-1){if(G>=r.length){y[q+1]=
1;G>=v.length&&(t[q+1]=1);continue}F-=x}m=r[G].text;if(H=p&&D[q])if(H>0){if(m.length>H)if(y[q+1]=1,n)m=m.substring(0,H);else continue;(H-=m.length)||(H=-1);D[q]=H}else{y[q+1]=1;continue}if(F+m.length+1<=k)m=" "+m,A[q]+=m;else if(n)O=k-F-1,O>0&&(m=" "+m.substring(0,O),A[q]+=m),y[q+1]=1;else{y[q+1]=1;continue}}else{if(y[q])continue;G-=K;if(C[G]){F-=x;y[q]=1;t[q]=1;continue}if(G<=0){if(G<0){y[q]=1;t[q]=1;continue}F-=x}m=r[G].text;if(H=u&&E[q])if(H>0){if(m.length>H)if(y[q]=1,n)m=m.substring(m.length-
H);else continue;(H-=m.length)||(H=-1);E[q]=H}else{y[q]=1;continue}if(F+m.length+1<=k)m+=" ",A[q]=m+A[q];else if(n)O=m.length+1-(k-F),O>=0&&O<m.length&&(m=m.substring(O)+" ",A[q]=m+A[q]),y[q]=1;else{y[q]=1;continue}}else{m=r[G].match;u&&(E[q]=u);p&&(D[q]=p);q&&F++;let ta;G?!q&&x&&(F+=x):(t[q]=1,y[q]=1);G>=v.length-1?ta=1:G<r.length-1&&r[G+1].match?ta=1:x&&(F+=x);F-=f.length-2;if(!q||F+m.length<=k)A[q]=m;else{O=Q=W=t[q]=0;break}ta&&(t[q+1]=1,y[q+1]=1)}F+=m.length;O=C[G]=1}if(O)K===L?L++:K++;else{K===
L?Q=0:W=0;if(!Q&&!W)break;Q?(K++,L=K):L++}}m="";for(let q=0,G;q<A.length;q++)G=(q&&t[q]?" ":(q&&!d?" ":"")+d)+A[q],m+=G;d&&!t[A.length]&&(m+=d)}l&&(m=m.replace(l," "));da[ia].highlight=m}if(e)break}return c};function Fa(a,c){const b=N(),e=[];for(let d=0,f;d<c.length;d++){f=c[d];for(let g=0;g<f.length;g++)b[f[g]]=1}for(let d=0,f;d<a.length;d++)f=a[d],b[f]&&(e.push(f),b[f]=0);return e};N();X.prototype.search=function(a,c,b,e){b||(!c&&R(a)?(b=a,a=""):R(c)&&(b=c,c=0));let d=[];var f=[];let g;let h,k,n,l;let z=0,x=!0,u;if(b){b.constructor===Array&&(b={index:b});a=b.query||a;var p=b.pluck;var w=b.merge;n=p||b.field||(n=b.index)&&(n.index?null:n);l=this.tag&&b.tag;h=b.suggest;x=!0;k=b.cache;u=x&&this.store&&b.highlight;g=!!u||x&&this.store&&b.enrich;c=b.limit||c;var m=b.offset||0;c||(c=x?100:0);if(l){l.constructor!==Array&&(l=[l]);var v=[];for(let A=0,t;A<l.length;A++)if(t=l[A],t.field&&
t.tag){var r=t.tag;if(r.constructor===Array)for(var C=0;C<r.length;C++)v.push(t.field,r[C]);else v.push(t.field,r)}else{r=Object.keys(t);for(let y=0,E,D;y<r.length;y++)if(E=r[y],D=t[E],D.constructor===Array)for(C=0;C<D.length;C++)v.push(E,D[C]);else v.push(E,D)}l=v;if(!a){f=[];if(v.length)for(p=0;p<v.length;p+=2)w=Ga.call(this,v[p],v[p+1],c,m,g),d.push({field:v[p],tag:v[p+1],result:w});return f.length?Promise.all(f).then(function(A){for(let t=0;t<A.length;t++)d[t].result=A[t];return d}):d}}n&&n.constructor!==
Array&&(n=[n])}n||(n=this.field);v=!1;for(let A=0,t,y,E;A<n.length;A++){y=n[A];let D;P(y)||(D=y,y=D.field,a=D.query||a,c=J(D.limit,c),m=J(D.offset,m),h=J(D.suggest,h),u=x&&this.store&&J(D.highlight,u),g=!!u||x&&this.store&&J(D.enrich,g),k=J(D.cache,k));if(e)t=e[A];else{r=D||b||{};C=r.enrich;const F=this.index.get(y);l&&C&&(r.enrich=!1);t=k?F.searchCache(a,c,r):F.search(a,c,r);C&&(r.enrich=C);if(v){v[A]=t;continue}}E=(t=t.result||t)&&t.length;if(l&&E){r=[];C=0;for(let F=0,K,L;F<l.length;F+=2){K=this.tag.get(l[F]);
if(!K)if(h)continue;else return d;if(L=(K=K&&K.get(l[F+1]))&&K.length)C++,r.push(K);else if(!h)return d}if(C){t=Fa(t,r);E=t.length;if(!E&&!h)return t;C--}}if(E)f[z]=y,d.push(t),z++;else if(n.length===1)return d}if(v){const A=this;return Promise.all(v).then(function(t){b&&(b.resolve=x);t.length&&(t=A.search(a,c,b,t));return t})}if(!z)return d;if(p&&(!g||!this.store))return d=d[0];v=[];for(m=0;m<f.length;m++){e=d[m];g&&e.length&&typeof e[0].doc==="undefined"&&(e=Ia.call(this,e));if(p)return u?Ea(a,
e,this.index,p,u):e;d[m]={field:f[m],result:e}}u&&(d=Ea(a,d,this.index,p,u));return w?Ja(d):d};function Ja(a){const c=[],b=N(),e=N();for(let d=0,f,g,h,k,n,l,z;d<a.length;d++){f=a[d];g=f.field;h=f.result;for(let x=0;x<h.length;x++)if(n=h[x],typeof n!=="object"?n={id:k=n}:k=n.id,(l=b[k])?l.push(g):(n.field=b[k]=[g],c.push(n)),z=n.highlight)l=e[k],l||(e[k]=l={},n.highlight=l),l[g]=z}return c}
function Ga(a,c,b,e,d){a=this.tag.get(a);if(!a)return[];a=a.get(c);if(!a)return[];c=a.length-e;if(c>0){if(b&&c>b||e)a=a.slice(e,e+b);d&&(a=Ia.call(this,a))}return a}function Ia(a){if(!this||!this.store)return a;const c=Array(a.length);for(let b=0,e;b<a.length;b++)e=a[b],c[b]={id:e,doc:this.store.get(e)};return c};function X(a){if(!this||this.constructor!==X)return new X(a);const c=a.document||a.doc||a;var b;this.B=[];this.field=[];this.C=[];this.key=(b=c.key||c.id)&&Ka(b,this.C)||"id";this.reg=(this.fastupdate=!!a.fastupdate)?new Map:new Set;this.h=(b=c.store||null)&&b&&b!==!0&&[];this.store=b?new Map:null;this.cache=(b=a.cache||null)&&new T(b);a.cache=!1;this.priority=a.priority||4;b=new Map;let e=c.index||c.field||c;P(e)&&(e=[e]);for(let d=0,f,g;d<e.length;d++)f=e[d],P(f)||(g=f,f=f.field),g=R(g)?Object.assign({},
...
"string"&&(b=[b]),b.length){this.tag=new Map;this.A=[];this.D=[];for(let d=0,f,g;d<b.length;d++){f=b[d];g=f.field||f;if(!g)throw Error("The tag field from the document descriptor is undefined.");f.custom?this.A[d]=f.custom:(this.A[d]=Ka(g,this.C),f.filter&&(typeof this.A[d]==="string"&&(this.A[d]=new String(this.A[d])),this.A[d].F=f.filter));this.D[d]=g;this.tag.set(g,new Map)}}}
function Ka(a,c){const b=a.split(":");let e=0;for(let d=0;d<b.length;d++)a=b[d],a[a.length-1]==="]"&&(a=a.substring(0,a.length-2))&&(c[e]=!0),a&&(b[e++]=a);e<b.length&&(b.length=e);return e>1?b:b[0]}B=X.prototype;B.append=function(a,c){return this.add(a,c,!0)};B.update=function(a,c){return this.remove(a).add(a,c)};
...
function Ta(a,c,b,e,d,f,g=0){const h=e&&e.constructor===Array;var k=h?e.shift():e;if(!k)return this.export(a,c,d,f+1);if((k=a((c?c+".":"")+(g+1)+"."+b,JSON.stringify(k)))&&k.then){const n=this;return k.then(function(){return Ta.call(n,a,c,b,h?e:null,d,f,g+1)})}return Ta.call(this,a,c,b,h?e:null,d,f,g+1)}
...
function Ua(a,c){let b="";for(const e of a.entries()){a=e[0];const d=e[1];let f="";for(let g=0,h;g<d.length;g++){h=d[g]||[""];let k="";for(let n=0;n<h.length;n++)k+=(k?",":"")+(c==="string"?'"'+h[n]+'"':h[n]);k="["+k+"]";f+=(f?",":"")+k}f='["'+a+'",['+f+"]]";b+=(b?",":"")+f}return b};Y.prototype.remove=function(a,c){const b=this.reg.size&&(this.fastupdate?this.reg.get(a):this.reg.has(a));if(b){if(this.fastupdate)for(let e=0,d,f;e<b.length;e++){if((d=b[e])&&(f=d.length))if(d[f-1]===a)d.pop();else{const g=d.indexOf(a);g>=0&&d.splice(g,1)}}else Va(this.map,a),this.depth&&Va(this.ctx,a);c||this.reg.delete(a)}this.cache&&this.cache.remove(a);return this};
function Va(a,c){let b=0;var e=typeof c==="undefined";if(a.constructor===Array)for(let d=0,f,g,h;d<a.length;d++){if((f=a[d])&&f.length){if(e)return 1;g=f.indexOf(c);if(g>=0){if(f.length>1)return f.splice(g,1),1;delete a[d];if(b)return 1;h=1}else{if(h)return 1;b++}}}else for(let d of a.entries())e=d[0],Va(d[1],c)?b++:a.delete(e);return b};const Wa={memory:{resolution:1},performance:{resolution:3,fastupdate:!0,context:{depth:1,resolution:1}},match:{tokenize:"forward"},score:{resolution:9,context:{depth:2,resolution:3}}};Y.prototype.add=function(a,c,b,e){if(c&&(a||a===0)){if(!e&&!b&&this.reg.has(a))return this.update(a,c);e=this.depth;c=this.encoder.encode(c,!e);const n=c.length;if(n){const l=N(),z=N(),x=this.resolution;for(let u=0;u<n;u++){let p=c[this.rtl?n-1-u:u];var d=p.length;if(d&&(e||!z[p])){var f=this.score?this.score(c,p,u,null,0):Xa(x,n,u),g="";switch(this.tokenize){case "tolerant":Z(this,z,p,f,a,b);if(d>2)for(let w=1,m,v,r,C;w<d-1;w++)m=p.charAt(w),v=p.charAt(w+1),r=p.substring(0,w)+v,C=p.substring(w+2),
g=r+m+C,z[g]||Z(this,z,g,f,a,b),g=r+C,z[g]||Z(this,z,g,f,a,b);break;case "full":if(d>2){for(let w=0,m;w<d;w++)for(f=d;f>w;f--)if(g=p.substring(w,f),!z[g]){m=this.rtl?d-1-w:w;var h=this.score?this.score(c,p,u,g,m):Xa(x,n,u,d,m);Z(this,z,g,h,a,b)}break}case "bidirectional":case "reverse":if(d>1){for(h=d-1;h>0;h--)if(g=p[this.rtl?d-1-h:h]+g,!z[g]){var k=this.score?this.score(c,p,u,g,h):Xa(x,n,u,d,h);Z(this,z,g,k,a,b)}g=""}case "forward":if(d>1){for(h=0;h<d;h++)g+=p[this.rtl?d-1-h:h],z[g]||Z(this,z,g,
f,a,b);break}default:if(Z(this,z,p,f,a,b),e&&n>1&&u<n-1)for(d=N(),g=this.L,f=p,h=Math.min(e+1,this.rtl?u+1:n-u),d[f]=1,k=1;k<h;k++)if((p=c[this.rtl?n-1-u-k:u+k])&&!d[p]){d[p]=1;const w=this.score?this.score(c,f,u,p,k-1):Xa(g+(n/2>g?0:1),n,u,h-1,k-1),m=this.bidirectional&&p>f;Z(this,l,m?f:p,w,a,b,m?p:f)}}}}this.fastupdate||this.reg.add(a)}}return this};
...
(d=Ya(this,b[1],b[0]))&&d.length?Da.call(this,d,c,g):[];h=N();var n=0;if(f){var l=b[0];n=1}k||k===0||(k=l?this.L:this.resolution);for(let p,w;n<a;n++){if((w=b[n])&&!h[w]){h[w]=1;p=Ya(this,w,l);a:{f=p;var z=e,x=g,u=k;let m=[];if(f&&f.length){if(f.length<=u){z.push(f);p=void 0;break a}for(let v=0,r;v<u;v++)if(r=f[v])m[v]=r;if(m.length){z.push(m);p=void 0;break a}}p=x?void 0:m}if(p){e=p;break}l&&(g&&p&&e.length||(l=w))}g&&l&&n===a-1&&!e.length&&(k=this.resolution,l="",n=-1,h=N())}a:{b=e;e=b.length;l=
b;if(e>1)b:{e=g;l=b.length;g=[];a=N();for(let p=0,w,m,v,r;p<k;p++)for(n=0;n<l;n++)if(v=b[n],p<v.length&&(w=v[p]))for(f=0;f<w.length;f++)if(m=w[f],(h=a[m])?a[m]++:(h=0,a[m]=1),r=g[h]||(g[h]=[]),r.push(m),c&&h===l-1&&r.length-d===c){l=d?r.slice(d):r;break b}if(b=g.length)if(e){if(g.length>1)c:for(b=[],k=N(),e=g.length,h=e-1;h>=0;h--){if(a=(e=g[h])&&e.length)for(n=0;n<a;n++)if(l=e[n],!k[l])if(k[l]=1,d)d--;else if(b.push(l),b.length===c)break c}else b=(g=g[0])&&c&&g.length>c||d?g.slice(d,c+d):g;g=b}else{if(b<

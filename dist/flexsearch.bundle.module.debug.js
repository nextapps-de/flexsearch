/**!
 * FlexSearch.js v0.8.143 (Bundle/Module/Debug)
  ...
  for (let A = 0, x, D, H; A < h.length; A++) {
    ...
    if (l && H) {
      ...
      if (this.db && e) {
        ...
        for (let G = 0, L, qb; G < l.length; G += 2) {
          L = this.tag.get(l[G]);
          if (!L) {
          ...
          if (qb = (L = L && L.get(l[G + 1])) && L.length) {
            y++, w.push(L);
          } else if (!r) {
            return m ? d : new W(d);
          }
...
;export default {Index:N, Charset:cb, Encoder:ja, Document:U, Worker:P, Resolver:W, IndexedDB:pb, Language:{}};

export const Index=N;export const  Charset=cb;export const  Encoder=ja;export const  Document=U;export const  Worker=P;export const  Resolver=W;export const  IndexedDB=pb;export const  Language={};
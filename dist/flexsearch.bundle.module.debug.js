/**!
 * FlexSearch.js v0.8.123 (Bundle/Module/Debug)
...
function Q(a = {}) {
    ...
    if (this.worker) {
      ...
      if (a.config) {
        return new Promise(function(h) {
          ...
          d.worker.postMessage({id:P, task:"init", factory:c, options:a});
        });
      }
  ...
  c && (c = c.toString());
  const e = "undefined" === typeof window, d = this, f = ra(c, e, a.worker);
...
function R(a) {
  Q.prototype[a] = function() {
    ...
    e = new Promise(function(f) {
      ...
      b.h[++P] = f;
      b.worker.postMessage({task:a, id:P, args:c});
    });
...
function ua(a, b = 0) {
  ...
  b && (b = 250000 / b * 1000 | 0);
  for (const d of a.entries()) {
    e.push([d[0], sa(d[1])[0]]), e.length === b && (c.push(e), e = []);
  }
  e.length && c.push(e);
  return c;
}
function va(a, b) {
  ...
  for (let c = 0, e, d; c < a.length; c++) {
    e = a[c], d = b.get(e[0]), b.set(e[0], ta(e[1], d));
  }
  return b;
}
function wa(a) {
...
function ya(a, b, c, e, d, f, g = 0) {
  ...
  if ((h = a((b ? b + "." : "") + (g + 1) + "." + c, JSON.stringify(h))) && h.then) {
    ...
    return h.then(function() {
      return ya.call(l, a, b, c, k ? e : null, d, f, g + 1);
    });
  }
  return ya.call(this, a, b, c, k ? e : null, d, f, g + 1);
}
;function za(a, b, c, e) {
  let d = [];
...
function S(a) {
  ...
  return new Proxy([], {get(c, e) {
    ...
    if ("slice" === e) {
      return function(d, f) {
        return za(b, d || 0, f || b.length, !1);
      };
    }
    if ("splice" === e) {
      return function(d, f) {
        return za(b, d || 0, f || b.length, !0);
      };
    }
    if ("constructor" === e) {
      return Array;
...
function T(a = 8) {
  ...
  this.B = [];
  this.size = 0;
  32 < a ? (this.h = Aa, this.A = BigInt(a)) : (this.h = Ba, this.A = a);
}
...
function U(a = 8) {
  ...
  this.index = B();
  this.h = [];
  32 < a ? (this.B = Aa, this.A = BigInt(a)) : (this.B = Ba, this.A = a);
}
...
u.values = U.prototype.values = function*() {
...
u.keys = U.prototype.keys = function*() {
  for (let a = 0; a < this.h.length; a++) {
...
u.entries = U.prototype.entries = function*() {
  for (let a = 0; a < this.h.length; a++) {
  ...
  if (b && (a || 0 === a)) {
    ...
    for (let k = 0, h; k < this.field.length; k++) {
      ...
      if ("function" === typeof h) {
        ...
        if (d = h.I, !d || d(b)) {
          h.constructor === String ? h = ["" + h] : E(h) && (h = [h]), Ca(b, h, this.J, 0, e, a, h[0], c);
        }
      }
    }
    if (this.tag) {
...
function Da(a, b, c, e, d, f) {
  ...
  if (e === c.length - 1) {
    ...
    if (a.constructor === Array) {
      ...
      b = b[d] || (b[d] = B()), d = c[++e], Da(a, b, c, e, d);
    }
  }
}
function Ca(a, b, c, e, d, f, g, k) {
  if (a = a[g]) {
    if (e === b.length - 1) {
      if (a.constructor === Array) {
        if (c[e]) {
...
;function Ea(a, b, c, e, d, f, g) {
  const k = a.length;
  let h = [], l;
  var n;
  l = B();
  for (let m = 0, q, p, t, r; m < b; m++) {
    for (let v = 0; v < k; v++) {
      if (t = a[v], m < t.length && (q = t[m])) {
        for (let x = 0; x < q.length; x++) {
          p = q[x], (n = l[p]) ? l[p]++ : (n = 0, l[p] = 1), r = h[n] || (h[n] = []), g || (n = m + (v || !d ? 0 : f || 0), r = r[n] || (r[n] = [])), r.push(p);
        }
      }
    }
  }
  if (a = h.length) {
    if (d) {
      h = 1 < h.length ? Fa(h, c, e, g, f) : (h = h[0]).length > c || e ? h.slice(e, c + e) : h;
    } else {
      if (a < k) {
        return [];
      }
...
;X.prototype.or = function() {
  const {O:a, P:b, limit:c, offset:e, enrich:d, resolve:f} = Ia(this, "or", arguments);
  return Ja.call(this, a, b, c, e, d, f);
};
function Ja(a, b, c, e, d, f) {
  if (b.length) {
    const g = this;
    return Promise.all(b).then(function(k) {
      ...
      return Ja.call(g, a, [], c, e, d, f);
    });
  }
  a.length && (this.result.length && a.push(this.result), 2 > a.length ? this.result = a[0] : (this.result = Fa(a, c, e, !1, this.h), e = 0));
...
;X.prototype.and = function() {
  ...
  if (a) {
    const {O:f, P:g, limit:k, offset:h, enrich:l, resolve:n, suggest:m} = Ia(this, "and", arguments);
    return Ka.call(this, f, g, k, h, l, n, m);
  }
  return d ? this.resolve(b, c, e) : this;
};
function Ka(a, b, c, e, d, f, g) {
  if (b.length) {
    const k = this;
  ...
  if (a.length) {
    if (this.result.length && a.unshift(this.result), 2 > a.length) {
      ...
      if (b = ca(a)) {
        return this.result = Ea(a, b, c, e, g, this.h, f), f ? d ? W.call(this.index, this.result) : this.result : this;
      }
      this.result = [];
    }
  } else {
...
;X.prototype.xor = function() {
  const {O:a, P:b, limit:c, offset:e, enrich:d, resolve:f, suggest:g} = Ia(this, "xor", arguments);
  return La.call(this, a, b, c, e, d, f, g);
};
function La(a, b, c, e, d, f, g) {
  ...
  if (a.length) {
    if (this.result.length && a.unshift(this.result), 2 > a.length) {
      ...
      return this.result = Ma.call(this, a, c, e, f, this.h), f ? d ? W.call(this.index, this.result) : this.result : this;
    }
  } else {
    g || (this.result = a);
  }
...
;X.prototype.not = function() {
  const {O:a, P:b, limit:c, offset:e, enrich:d, resolve:f, suggest:g} = Ia(this, "not", arguments);
  return Na.call(this, a, b, c, e, d, f, g);
};
function Na(a, b, c, e, d, f, g) {
  if (b.length) {
    const k = this;
    return Promise.all(b).then(function(h) {
      a = [];
      ...
      return Na.call(k, a, [], c, e, d, f, g);
    });
  }
  if (a.length && this.result.length) {
    this.result = Oa.call(this, a, c, e, f);
  } else if (f) {
...
V.prototype.search = function(a, b, c, e) {
        ...
        if (v.length) {
          for (p = 0; p < v.length; p += 2) {
            if (this.db) {
              ...
              t.push(m = m.db.tag(v[p + 1], b, l, r));
            } else {
              m = Pa.call(this, v[p], v[p + 1], b, l, r);
            }
            d.push({field:v[p], tag:v[p + 1], result:m});
          }
        }
        return t.length ? Promise.all(t).then(function(z) {
  ...
  for (let z = 0, w, D, H; z < h.length; z++) {
    ...
    let C;
    E(D) || (C = D, D = C.field, a = C.query || a, b = C.limit || b, l = C.offset || l, t = C.suggest || t, r = this.store && (C.enrich || r));
    if (e) {
      w = e[z];
    } else {
      if (x = C || c, y = this.index.get(D), p && (this.db && (x.tag = p, F = y.db.support_tag_search, x.field = h), F || (x.enrich = !1)), v) {
        ...
        w = y.search(a, b, x), x && r && (x.enrich = r);
      }
    }
    ...
    if (p && H) {
      ...
      if (this.db && e) {
        ...
        for (let G = 0, K, nb; G < p.length; G += 2) {
          K = this.tag.get(p[G]);
          if (!K) {
            if (console.warn("Tag '" + p[G] + ":" + p[G + 1] + "' will be skipped because there is no field '" + p[G] + "'."), t) {
              continue;
            } else {
              return m ? d : new X(d);
            }
          }
          if (nb = (K = K && K.get(p[G + 1])) && K.length) {
            y++, x.push(K);
          } else if (!t) {
            return m ? d : new X(d);
          }
  ...
  if (v) {
    if (this.db && p && p.length && !F) {
      for (r = 0; r < p.length; r += 2) {
        e = this.index.get(p[r]);
        if (!e) {
          if (console.warn("Tag '" + p[r] + ":" + p[r + 1] + "' was not found because there is no field '" + p[r] + "'."), t) {
            continue;
          } else {
            return m ? d : new X(d);
          }
        }
        v.push(e.db.tag(p[r + 1], b, l, !1));
      }
    }
    const z = this;
  ...
  for (let z = 0, w; z < f.length; z++) {
    w = d[z];
    r && w.length && !w[0].doc && (this.db ? v.push(w = this.index.get(this.field[0]).db.enrich(w)) : w = W.call(this, w));
    if (g) {
      return m ? w : new X(w);
    }
    d[z] = {field:f[z], result:w};
  }
  if (r && this.db && v.length) {
    const z = this;
    return Promise.all(v).then(function(w) {
      for (let D = 0; D < w.length; D++) {
        d[D].result = w[D];
      }
      return k ? Qa(d, b) : q ? Ra(d, a, z.index, z.field, z.D, q) : d;
    });
  }
  return k ? Qa(d, b) : q ? Ra(d, a, this.index, this.field, this.D, q) : d;
};
function Ra(a, b, c, e, d, f) {
  let g, k, h;
  for (let n = 0, m, q, p, t, r; n < a.length; n++) {
    m = a[n].result;
    q = a[n].field;
    t = c.get(q);
    p = t.encoder;
...
;function V(a) {
  ...
  this.field = [];
  this.J = [];
  this.key = (c = b.key || b.id) && Sa(c, this.J) || "id";
  ...
  if (c = b.tag) {
    if ("string" === typeof c && (c = [c]), c.length) {
      ...
      for (let d = 0, f, g; d < c.length; d++) {
        ...
        f.custom ? this.F[d] = f.custom : (this.F[d] = Sa(g, this.J), f.filter && ("string" === typeof this.F[d] && (this.F[d] = new String(this.F[d])), this.F[d].I = f.filter));
        this.R[d] = g;
...
function Ta(a, b) {
  ...
  for (let d = 0, f, g; d < e.length; d++) {
    ...
    g.custom ? this.D[d] = g.custom : (this.D[d] = Sa(f, this.J), g.filter && ("string" === typeof this.D[d] && (this.D[d] = new String(this.D[d])), this.D[d].I = g.filter));
    this.field[d] = f;
  }
  if (this.C) {
    a = b.store;
    E(a) && (a = [a]);
    for (let d = 0, f, g; d < a.length; d++) {
      f = a[d], g = f.field || f, f.custom ? (this.C[d] = f.custom, f.custom.V = g) : (this.C[d] = Sa(g, this.J), f.filter && ("string" === typeof this.C[d] && (this.C[d] = new String(this.C[d])), this.C[d].I = f.filter));
    }
  }
  return c;
}
...
u.export = function(a, b, c = 0, e = 0) {
  ...
  return ya.call(this, a, b, d, f, c, e);
};
...
const Va = {normalize:function(a) {
  return a.toLowerCase();
}};
const Wa = new Map([["b", "p"], ["v", "f"], ["w", "f"], ["z", "s"], ["x", "s"], ["d", "t"], ["n", "m"], ["c", "k"], ["g", "k"], ["j", "k"], ["q", "k"], ["i", "e"], ["y", "e"], ["u", "o"]]);
const Xa = new Map([["ae", "a"], ["oe", "o"], ["sh", "s"], ["kh", "k"], ["th", "t"], ["ph", "f"], ["pf", "f"]]), Ya = [/([^aeo])h(.)/g, "$1$2", /([aeo])h([^aeo]|$)/g, "$1$2", /(.)\1+/g, "$1"];
const Za = {a:"", e:"", i:"", o:"", u:"", y:"", b:1, f:1, p:1, v:1, c:2, g:2, j:2, k:2, q:2, s:2, x:2, z:2, "\u00df":2, d:3, t:3, l:4, m:5, n:5, r:6};
const $a = /[\x00-\x7F]+/g;
const ab = /[\x00-\x7F]+/g;
const bb = /[\x00-\x7F]+/g;
var cb = {LatinExact:{split:/\s+/, normalize:!1}, LatinDefault:Va, LatinSimple:{normalize:!0, dedupe:!0}, LatinBalance:{normalize:!0, dedupe:!0, mapper:Wa}, LatinAdvanced:{normalize:!0, dedupe:!0, mapper:Wa, matcher:Xa, replacer:Ya}, LatinExtra:{normalize:!0, dedupe:!0, mapper:Wa, replacer:Ya.concat([/(?!^)[aeo]/g, ""]), matcher:Xa}, LatinSoundex:{normalize:!0, dedupe:!1, include:{letter:!0}, finalize:function(a) {
  for (let c = 0; c < a.length; c++) {
    var b = a[c];
    let e = b.charAt(0), d = Za[e];
    for (let f = 1, g; f < b.length && (g = b.charAt(f), "h" === g || "w" === g || !(g = Za[g]) || g === d || (e += g, d = g, 4 !== e.length)); f++) {
    }
    a[c] = e;
  }
...
O.prototype.add = function(a, b, c, e) {
  if (b && (a || 0 === a)) {
    ...
    if (e = b.length) {
      ...
      for (let p = 0; p < e; p++) {
        let t = b[this.rtl ? e - 1 - p : p];
        var d = t.length;
        if (d && (m || !n[t])) {
          var f = this.score ? this.score(b, t, p, null, 0) : eb(q, e, p), g = "";
          switch(this.tokenize) {
              ...
              if (2 < d) {
                for (let r = 0, v; r < d; r++) {
                  for (f = d; f > r; f--) {
                    g = t.substring(r, f);
                    v = this.rtl ? d - 1 - r : r;
                    var k = this.score ? this.score(b, t, p, g, v) : eb(q, e, p, d, v);
                    fb(this, n, g, k, a, c);
                  }
                }
                break;
            ...
            case "reverse":
              if (1 < d) {
                for (k = d - 1; 0 < k; k--) {
                  ...
                  var h = this.score ? this.score(b, t, p, g, k) : eb(q, e, p, d, k);
                  fb(this, n, g, h, a, c);
                }
                g = "";
              }
            case "forward":
              if (1 < d) {
                for (k = 0; k < d; k++) {
                  g += t[this.rtl ? d - 1 - k : k], fb(this, n, g, f, a, c);
                }
                break;
              }
            default:
              if (fb(this, n, t, f, a, c), m && 1 < e && p < e - 1) {
                for (d = B(), g = this.U, f = t, k = Math.min(m + 1, this.rtl ? p + 1 : e - p), d[f] = 1, h = 1; h < k; h++) {
                  if ((t = b[this.rtl ? e - 1 - p - h : p + h]) && !d[t]) {
                    d[t] = 1;
                    const r = this.score ? this.score(b, f, p, t, h - 1) : eb(g + (e / 2 > g ? 0 : 1), e, p, k - 1, h - 1), v = this.bidirectional && t > f;
                    fb(this, l, v ? f : t, r, a, c, v ? t : f);
                  }
                }
              }
          }
  ...
  this.db && (b || this.commit_task.push({del:a}), this.T && gb(this));
  return this;
};
function fb(a, b, c, e, d, f, g) {
...
;O.prototype.search = function(a, b, c) {
  ...
  b = b || (h ? 100 : 0);
  if (1 === d) {
    return hb.call(this, p[0], "", b, k, h, q, l);
  }
  f = this.depth && !1 !== f;
  if (2 === d && f && !g) {
    return hb.call(this, p[0], p[1], b, k, h, q, l);
  }
  let t = B(), r = 0, v;
  1 < d && f && (v = p[0], r = 1);
  ...
  if (this.db) {
    ...
    return async function() {
      for (let y, F; r < d; r++) {
        ...
        g && v && r === d - 1 && !e.length && (m = x.resolution, v = "", r = -1, t = B());
      }
      return kb(e, m, b, k, g, n, h);
    }();
  }
  for (let x, y; r < d; r++) {
    if ((y = p[r]) && !t[y]) {
      t[y] = 1;
      x = ib(this, y, v, 0, 0, !1, !1);
      if (x = jb(x, e, g, m)) {
        e = x;
        break;
      }
    ...
    g && v && r === d - 1 && !e.length && (m = this.resolution, v = "", r = -1, t = B());
  }
  return kb(e, m, b, k, g, n, h);
};
function kb(a, b, c, e, d, f, g) {
  let k = a.length, h = a;
  if (1 < k) {
    h = Ea(a, b, c, e, d, f, g);
  } else if (1 === k) {
    return g ? Ha.call(null, a[0], c, e) : new X(a[0]);
  }
  return g ? h : new X(h);
}
function hb(a, b, c, e, d, f, g) {
  a = ib(this, a, b, c, e, d, f, g);
  return this.db ? a.then(function(k) {
    return d ? k || [] : new X(k);
  }) : a && a.length ? d ? Ha.call(this, a, c, e) : new X(a) : d ? [] : new X();
}
function jb(a, b, c, e) {
  let d = [];
  if (a && a.length) {
...
;function O(a, b) {
  ...
  c = a.context;
  const e = !0 === c ? {depth:1} : c || {}, d = E(a.encoder) ? cb[a.encoder] : a.encode || a.encoder || Va;
...
la(O.prototype);
const ob = "undefined" !== typeof window && (window.indexedDB || window.mozIndexedDB || window.webkitIndexedDB || window.msIndexedDB), pb = ["map", "ctx", "tag", "reg", "cfg"];
function qb(a, b = {}) {
  if (!this) {
    return new qb(a, b);
  }
...
u.open = function() {
  ...
  return this.db || new Promise(function(b, c) {
    const e = ob.open(a.id + (a.field ? ":" + a.field : ""), 1);
...
u.destroy = function() {
  const a = ob.deleteDatabase(this.id + (this.field ? ":" + this.field : ""));
  return Z(a);
};
u.clear = function() {
  const a = this.db.transaction(pb, "readwrite");
  for (let b = 0; b < pb.length; b++) {
    a.objectStore(pb[b]).clear();
  }
  return Z(a);
};
u.get = function(a, b, c = 0, e = 0, d = !0, f = !1) {
...
;export default {Index:O, Charset:cb, Encoder:J, Document:V, Worker:Q, Resolver:X, IndexedDB:qb, Language:{}};

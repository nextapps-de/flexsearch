...
;const ab = {Index:O, Charset:va, Encoder:G, Document:Y, Worker:W, Resolver:S, IndexedDB:Ya, Language:{}}, cb = self;
let db;
(db = cb.define) && db.amd ? db([], function() {
  return ab;
}) : "object" === typeof cb.exports ? cb.exports = ab : cb.FlexSearch = ab;
}(this));

...
function Ma(a, b, c) {
  return b ? "undefined" !== typeof module ? new(require("worker_threads")["Worker"])(__dirname+"/node/node.js") : import("worker_threads").then(function(worker){return new worker["Worker"]((1,eval)("import.meta.dirname")+"/node/node.mjs")}) : a ? new window.Worker(URL.createObjectURL(new Blob(["onmessage=" + Ea.toString()], {type:"text/javascript"}))) : new window.Worker("string" === typeof c ? c : (0,eval)("import.meta.url").replace("/worker.js", "/worker/worker.js").replace("flexsearch.bundle.module.min.js", 
  ...
  if (b && (a || 0 === a)) {
    ...
    for (let k = 0, h; k < this.field.length; k++) {
      ...
      if ("function" === typeof h) {
        ...
        if (d = h.J, !d || d(b)) {
          h.constructor === String ? h = ["" + h] : N(h) && (h = [h]), Oa(b, h, this.K, 0, e, a, h[0], c);
        }
      }
    }
    if (this.tag) {
...
;function cb(a, b, c, e, d) {
  ...
  r = new Map();
  for (let Pa = 0, ea, gb, oa; Pa < b.length; Pa++) {
    let pa;
    if (e) {
      pa = b, oa = e;
    } else {
          ...
          for (O = L = 1;;) {
            ...
            for (let x = 0, J; x < za.length; x++) {
              ...
              if (F) {
                ...
                J >= y.length - 1 ? Qa = 1 : J < v.length - 1 && v[J + 1].match ? Qa = 1 : t && (C += t);
                C -= f.length - 2;
                if (!x || C + p.length <= h) {
                  B[x] = p;
                } else {
        ...
        if (v.length) {
          for (n = 0; n < v.length; n += 2) {
            if (this.db) {
              ...
              e = eb.call(this, v[n], v[n + 1], b, y, p);
            }
...
;const Hb = {Index:V, Charset:wa, Encoder:la, Document:Na, Worker:La, Resolver:Y, IndexedDB:Fb, Language:{}}, Ib = "undefined" !== typeof self ? self : "undefined" !== typeof global ? global : self;
let Jb;

...
window._factory:null;c&&(c=c.toString());const d="undefined"===typeof window,e=this,f=Pa(c,d,a.worker);return f.then?f.then(function(g){return b.call(e,g)}):b.call(this,f)}X("add");X("append");X("search");X("update");X("remove");

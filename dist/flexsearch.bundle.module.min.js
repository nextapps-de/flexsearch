/**!
 * FlexSearch.js v0.8.105 (Bundle/Module)
...
function I(a){return"object"===typeof a}function aa(a){const b=[];for(const c of a.keys())b.push(c);return b}function J(a,b){if(E(b))a=a[b];else for(let c=0;a&&c<b.length;c++)a=a[b[c]];return a}function ba(a){let b=0;for(let c=0,e;c<a.length;c++)(e=a[c])&&b<e.length&&(b=e.length);return b};var ca=[["\u00aa","a"],["\u00b2","2"],["\u00b3","3"],["\u00b9","1"],["\u00ba","o"],["\u00bc","1\u20444"],["\u00bd","1\u20442"],["\u00be","3\u20444"],["\u00e0","a"],["\u00e1","a"],["\u00e2","a"],["\u00e3","a"],["\u00e4","a"],["\u00e5","a"],["\u00e7","c"],["\u00e8","e"],["\u00e9","e"],["\u00ea","e"],["\u00eb","e"],["\u00ec","i"],["\u00ed","i"],["\u00ee","i"],["\u00ef","i"],["\u00f1","n"],["\u00f2","o"],["\u00f3","o"],["\u00f4","o"],["\u00f5","o"],["\u00f6","o"],["\u00f9","u"],["\u00fa","u"],["\u00fb",
...
["\u0477","\u0475"],["\u04c2","\u0436"],["\u04d1","\u0430"],["\u04d3","\u0430"],["\u04d7","\u0435"],["\u04db","\u04d9"],["\u04dd","\u0436"],["\u04df","\u0437"],["\u04e3","\u0438"],["\u04e5","\u0438"],["\u04e7","\u043e"],["\u04eb","\u04e9"],["\u04ed","\u044d"],["\u04ef","\u0443"],["\u04f1","\u0443"],["\u04f3","\u0443"],["\u04f5","\u0447"]];const da=/[^\p{L}\p{N}]+/u,ea=/(\d{3})/g,fa=/(\D)(\d{3})/g,ha=/(\d{3})(\D)/g,ia="".normalize&&/[\u0300-\u036f]/g;function L(a){if(!this||this.constructor!==L)return new L(...arguments);for(let b=0;b<arguments.length;b++)this.assign(arguments[b])}t=L.prototype;
...
this.numeric=A(a.numeric,e)}else{try{this.split=A(this.split,da)}catch(d){this.split=/\s+/}this.numeric=A(a.numeric,A(this.numeric,!0))}this.prepare=A(a.prepare,null,this.prepare);this.finalize=A(a.finalize,null,this.finalize);ia||(this.mapper=new Map(ca));this.rtl=A(a.rtl,!1,this.rtl);this.dedupe=A(a.dedupe,!1,this.dedupe);this.filter=A((c=a.filter)&&new Set(c),null,this.filter);this.matcher=A((c=a.matcher)&&new Map(c),null,this.matcher);this.mapper=A((c=a.mapper)&&new Map(c),null,this.mapper);this.stemmer=
...
t.encode=function(a){if(this.cache&&a.length<=this.K)if(this.H){if(this.B.has(a))return this.B.get(a)}else this.H=setTimeout(M,50,this);this.normalize&&("function"===typeof this.normalize?a=this.normalize(a):a=ia?a.normalize("NFKD").replace(ia,"").toLowerCase():a.toLowerCase());this.prepare&&(a=this.prepare(a));this.numeric&&3<a.length&&(a=a.replace(fa,"$1 $2").replace(ha,"$1 $2").replace(ea,"$1 "));const b=!(this.dedupe||this.mapper||this.filter||this.matcher||this.stemmer||this.replacer);let c=
[],e=this.split||""===this.split?a.split(this.split):a;for(let f=0,g,k;f<e.length;f++)if((g=k=e[f])&&!(g.length<this.minlength))if(b)c.push(g);else if(!this.filter||!this.filter.has(g)){if(this.cache&&g.length<=this.L)if(this.H){var d=this.G.get(g);if(d||""===d){d&&c.push(d);continue}}else this.H=setTimeout(M,50,this);this.stemmer&&2<g.length&&(this.N||(this.N=new RegExp("(?!^)("+this.A+")$")),g=g.replace(this.N,h=>this.stemmer.get(h)),g.length<this.minlength||this.filter&&this.filter.has(g))&&(g=
...
this.S&&(this.G.clear(),this.L=this.L/1.1|0));g&&c.push(g)}this.finalize&&(c=this.finalize(c)||c);this.cache&&a.length<=this.K&&(this.B.set(a,c),this.B.size>this.S&&(this.B.clear(),this.K=this.K/1.1|0));return c};function M(a){a.H=null;a.B.clear();a.G.clear()};async function ja(a){a=a.data;var b=self._index;const c=a.args;var e=a.task;switch(e){case "init":e=a.options||{};(b=a.factory)?(Function("return "+b)()(self),self._index=new self.FlexSearch.Index(e),delete self.FlexSearch):self._index=new N(e);postMessage({id:a.id});break;default:a=a.id,b=b[e].apply(b,c),postMessage("search"===e?{id:a,msg:b}:{id:a})}};let ka=0;
function O(a={}){function b(g){function k(h){h=h.data||h;const l=h.id,m=l&&d.h[l];m&&(m(h.msg),delete d.h[l])}this.worker=g;this.h=B();if(this.worker){e?this.worker.on("message",k):this.worker.onmessage=k;if(a.config)return new Promise(function(h){d.h[++ka]=function(){h(d)};d.worker.postMessage({id:ka,task:"init",factory:c,options:a})});this.worker.postMessage({task:"init",factory:c,options:a});return this}}if(!this||this.constructor!==O)return new O(a);let c="undefined"!==typeof self?self._factory:"undefined"!==
typeof window?window._factory:null;c&&(c=c.toString());const e="undefined"===typeof window,d=this,f=la(c,e,a.worker);return f.then?f.then(function(g){return b.call(d,g)}):b.call(this,f)}P("add");P("append");P("search");P("update");P("remove");
function P(a){O.prototype[a]=O.prototype[a+"Async"]=async function(){const b=this,c=[].slice.call(arguments);var e=c[c.length-1];let d;"function"===typeof e&&(d=e,c.splice(c.length-1,1));e=new Promise(function(f){b.h[++ka]=f;b.worker.postMessage({task:a,id:ka,args:c})});return d?(e.then(d),this):e}}
...
"module/worker/worker.js"),{type:"module"})};function ma(a){Q.call(a,"add");Q.call(a,"append");Q.call(a,"search");Q.call(a,"update");Q.call(a,"remove")}function Q(a){this[a+"Async"]=function(){var b=arguments;const c=b[b.length-1];let e;"function"===typeof c&&(e=c,delete b[b.length-1]);b=this[a].apply(this,b);e&&(b.then?b.then(e):e(b));return b}};function na(a,b=0){let c=[],e=[];b&&(b=25E4/b*5E3|0);for(const d of a.entries())e.push(d),e.length===b&&(c.push(e),e=[]);e.length&&c.push(e);return c}function oa(a,b){b||(b=new Map);for(let c=0,e;c<a.length;c++)e=a[c],b.set(e[0],e[1]);return b}function pa(a,b=0){let c=[],e=[];b&&(b=25E4/b*1E3|0);for(const d of a.entries())e.push([d[0],na(d[1])[0]]),e.length===b&&(c.push(e),e=[]);e.length&&c.push(e);return c}
function qa(a,b){b||(b=new Map);for(let c=0,e,d;c<a.length;c++)e=a[c],d=b.get(e[0]),b.set(e[0],oa(e[1],d));return b}function ra(a){let b=[],c=[];for(const e of a.keys())c.push(e),25E4===c.length&&(b.push(c),c=[]);c.length&&b.push(c);return b}function sa(a,b){b||(b=new Set);for(let c=0;c<a.length;c++)b.add(a[c]);return b}
function ta(a,b,c,e,d,f,g=0){const k=e&&e.constructor===Array;var h=k?e.shift():e;if(!h)return this.export(a,b,d,f+1);if((h=a((b?b+".":"")+(g+1)+"."+c,JSON.stringify(h)))&&h.then){const l=this;return h.then(function(){return ta.call(l,a,b,c,k?e:null,d,f,g+1)})}return ta.call(this,a,b,c,k?e:null,d,f,g+1)};function ua(a,b,c,e){let d=[];for(let f=0,g;f<a.index.length;f++)if(g=a.index[f],b>=g.length)b-=g.length;else{b=g[e?"splice":"slice"](b,c);const k=b.length;if(k&&(d=d.length?d.concat(b):b,c-=k,e&&(a.length-=k),!c))break;b=0}return d}
...
0;f<b.index.length;f++)if(b.index[f].includes(d))return!0;return!1};if("slice"===e)return function(d,f){return ua(b,d||0,f||b.length,!1)};if("splice"===e)return function(d,f){return ua(b,d||0,f||b.length,!0)};if("constructor"===e)return Array;if("symbol"!==typeof e)return(c=b.index[e/2**31|0])&&c[e]},set(c,e,d){c=e/2**31|0;(b.index[c]||(b.index[c]=[]))[e]=d;b.length++;return!0}})}R.prototype.clear=function(){this.index.length=0};R.prototype.destroy=function(){this.proxy=this.index=null};
R.prototype.push=function(){};function S(a=8){if(!this)return new S(a);this.index=B();this.B=[];this.size=0;32<a?(this.h=va,this.A=BigInt(a)):(this.h=wa,this.A=a)}S.prototype.get=function(a){const b=this.index[this.h(a)];return b&&b.get(a)};S.prototype.set=function(a,b){var c=this.h(a);let e=this.index[c];e?(c=e.size,e.set(a,b),(c-=e.size)&&this.size++):(this.index[c]=e=new Map([[a,b]]),this.B.push(e))};
function T(a=8){if(!this)return new T(a);this.index=B();this.h=[];32<a?(this.B=va,this.A=BigInt(a)):(this.B=wa,this.A=a)}T.prototype.add=function(a){var b=this.B(a);let c=this.index[b];c?(b=c.size,c.add(a),(b-=c.size)&&this.size++):(this.index[b]=c=new Set([a]),this.h.push(c))};t=S.prototype;t.has=T.prototype.has=function(a){const b=this.index[this.B(a)];return b&&b.has(a)};t.delete=T.prototype.delete=function(a){const b=this.index[this.B(a)];b&&b.delete(a)&&this.size--};
t.clear=T.prototype.clear=function(){this.index=B();this.h=[];this.size=0};t.values=T.prototype.values=function*(){for(let a=0;a<this.h.length;a++)for(let b of this.h[a].values())yield b};t.keys=T.prototype.keys=function*(){for(let a=0;a<this.h.length;a++)for(let b of this.h[a].keys())yield b};t.entries=T.prototype.entries=function*(){for(let a=0;a<this.h.length;a++)for(let b of this.h[a].entries())yield b};
function wa(a){let b=2**this.A-1;if("number"==typeof a)return a&b;let c=0,e=this.A+1;for(let d=0;d<a.length;d++)c=(c*e^a.charCodeAt(d))&b;return 32===this.A?c+2**31:c}function va(a){let b=BigInt(2)**this.A-BigInt(1);var c=typeof a;if("bigint"===c)return a&b;if("number"===c)return BigInt(a)&b;c=BigInt(0);let e=this.A+BigInt(1);for(let d=0;d<a.length;d++)c=(c*e^BigInt(a.charCodeAt(d)))&b;return c};U.prototype.add=function(a,b,c){I(a)&&(b=a,a=J(b,this.key));if(b&&(a||0===a)){if(!c&&this.reg.has(a))return this.update(a,b);for(let k=0,h;k<this.field.length;k++){h=this.D[k];var e=this.index.get(this.field[k]);if("function"===typeof h){var d=h(b);d&&e.add(a,d,!1,!0)}else if(d=h.I,!d||d(b))h.constructor===String?h=[""+h]:E(h)&&(h=[h]),xa(b,h,this.J,0,e,a,h[0],c)}if(this.tag)for(e=0;e<this.F.length;e++){var f=this.F[e];d=this.tag.get(this.R[e]);let k=B();if("function"===typeof f){if(f=f(b),!f)continue}else{var g=
f.I;if(g&&!g(b))continue;f.constructor===String&&(f=""+f);f=J(b,f)}if(d&&f){E(f)&&(f=[f]);for(let h=0,l,m;h<f.length;h++)if(l=f[h],!k[l]&&(k[l]=1,(g=d.get(l))?m=g:d.set(l,m=[]),!c||!m.includes(a))){if(m.length===2**31-1){g=new R(m);if(this.fastupdate)for(let n of this.reg.values())n.includes(m)&&(n[n.indexOf(m)]=g);d.set(l,m=g)}m.push(a);this.fastupdate&&((g=this.reg.get(a))?g.push(m):this.reg.set(a,[m]))}}}if(this.store&&(!c||!this.store.has(a))){let k;if(this.C){k=B();for(let h=0,l;h<this.C.length;h++){l=
this.C[h];if((c=l.I)&&!c(b))continue;let m;if("function"===typeof l){m=l(b);if(!m)continue;l=[l.V]}else if(E(l)||l.constructor===String){k[l]=b[l];continue}ya(b,k,l,0,l[0],m)}}this.store.set(a,k||b)}}return this};function ya(a,b,c,e,d,f){a=a[d];if(e===c.length-1)b[d]=f||a;else if(a)if(a.constructor===Array)for(b=b[d]=Array(a.length),d=0;d<a.length;d++)ya(a,b,c,e,d);else b=b[d]||(b[d]=B()),d=c[++e],ya(a,b,c,e,d)}
function xa(a,b,c,e,d,f,g,k){if(a=a[g])if(e===b.length-1){if(a.constructor===Array){if(c[e]){for(b=0;b<a.length;b++)d.add(f,a[b],!0,!0);return}a=a.join(" ")}d.add(f,a,k,!0)}else if(a.constructor===Array)for(g=0;g<a.length;g++)xa(a,b,c,e,d,f,g,k);else g=b[++e],xa(a,b,c,e,d,f,g,k);else d.db&&d.remove(f)};function za(a,b,c,e,d,f,g){const k=a.length;let h=[],l;var m;l=B();for(let n=0,p,q,r,u;n<b;n++)for(let v=0;v<k;v++)if(r=a[v],n<r.length&&(p=r[n]))for(let x=0;x<p.length;x++)q=p[x],(m=l[q])?l[q]++:(m=0,l[q]=1),u=h[m]||(h[m]=[]),g||(m=n+(v||!d?0:f||0),u=u[m]||(u[m]=[])),u.push(q);if(a=h.length)if(d)h=1<h.length?Aa(h,c,e,g,f):(h=h[0]).length>c||e?h.slice(e,c+e):h;else{if(a<k)return[];h=h[a-1];if(c||e)if(g){if(h.length>c||e)h=h.slice(e,c+e)}else{d=[];for(let n=0,p;n<h.length;n++)if(p=h[n],p.length>e)e-=
...
(this.db&&(x.tag=p,F=y.db.support_tag_search,x.field=h),F||(x.enrich=!1)),v){v[z]=y.search(a,b,x);x&&u&&(x.enrich=u);continue}else w=y.search(a,b,x),x&&u&&(x.enrich=u);G=w&&(r?w.length:w.result.length);if(p&&G){x=[];y=0;if(this.db&&e){if(!F)for(let H=h.length;H<e.length;H++){let K=e[H];if(K&&K.length)y++,x.push(K);else if(!q)return r?d:new W(d)}}else for(let H=0,K,gb;H<p.length;H+=2){K=this.tag.get(p[H]);if(!K)if(q)continue;else return r?d:new W(d);if(gb=(K=K&&K.get(p[H+1]))&&K.length)y++,x.push(K);
else if(!q)return r?d:new W(d)}if(y){w=Ba(w,x,r);G=w.length;if(!G&&!q)return r?w:new W(w);y--}}if(G)f[m]=D,d.push(w),m++;else if(1===h.length)return r?d:new W(d)}if(v){if(this.db&&p&&p.length&&!F)for(u=0;u<p.length;u+=2){e=this.index.get(p[u]);if(!e)if(q)continue;else return r?d:new W(d);v.push(e.db.tag(p[u+1],b,l,!1))}const z=this;return Promise.all(v).then(function(w){return w.length?z.search(a,b,c,w):w})}if(!m)return r?d:new W(d);if(g&&(!u||!this.store))return d[0];v=[];for(let z=0,w;z<f.length;z++){w=
d[z];u&&w.length&&!w[0].doc&&(this.db?v.push(w=this.index.get(this.field[0]).db.enrich(w)):w=V.call(this,w));if(g)return r?w:new W(w);d[z]={field:f[z],result:w}}if(u&&this.db&&v.length){const z=this;return Promise.all(v).then(function(w){for(let D=0;D<w.length;D++)d[D].result=w[D];return k?La(d,b):n?Ma(d,a,z.index,z.field,z.D,n):d})}return k?La(d,b):n?Ma(d,a,this.index,this.field,this.D,n):d};
function Ma(a,b,c,e,d,f){let g,k,h;for(let m=0,n,p,q,r,u;m<a.length;m++){n=a[m].result;p=a[m].field;r=c.get(p);q=r.encoder;h=r.tokenize;u=d[e.indexOf(p)];q!==g&&(g=q,k=g.encode(b));for(let v=0;v<n.length;v++){let x="";var l=J(n[v].doc,u);let y=g.encode(l);l=l.split(g.split);for(let F=0,z,w;F<y.length;F++){z=y[F];w=l[F];let D;for(let G=0,C;G<k.length;G++)if(C=k[G],"strict"===h){if(z===C){x+=(x?" ":"")+f.replace("$1",w);D=!0;break}}else{const H=z.indexOf(C);if(-1<H){x+=(x?" ":"")+w.substring(0,H)+f.replace("$1",
w.substring(H,C.length))+w.substring(H+C.length);D=!0;break}}D||(x+=(x?" ":"")+l[F])}n[v].highlight=x}}return a}function La(a,b){const c=[],e=B();for(let d=0,f,g;d<a.length;d++){f=a[d];g=f.result;for(let k=0,h,l,m;k<g.length;k++)if(l=g[k],h=l.id,m=e[h])m.push(f.field);else{if(c.length===b)return c;l.field=e[h]=[f.field];c.push(l)}}return c}function Ka(a,b,c,e,d){a=this.tag.get(a);if(!a)return[];if((b=(a=a&&a.get(b))&&a.length-e)&&0<b){if(b>c||e)a=a.slice(e,e+c);d&&(a=V.call(this,a));return a}}
function V(a){if(!this||!this.store)return a;const b=Array(a.length);for(let c=0,e;c<a.length;c++)e=a[c],b[c]={id:e,doc:this.store.get(e)};return b};function U(a){if(!this||this.constructor!==U)return new U(a);const b=a.document||a.doc||a;let c,e;this.D=[];this.field=[];this.J=[];this.key=(c=b.key||b.id)&&Na(c,this.J)||"id";(e=a.keystore||0)&&(this.keystore=e);this.reg=(this.fastupdate=!!a.fastupdate)?e?new S(e):new Map:e?new T(e):new Set;this.C=(c=b.store||null)&&c&&!0!==c&&[];this.store=c&&(e?new S(e):new Map);this.cache=(c=a.cache||null)&&new X(c);a.cache=!1;this.worker=a.worker;this.index=Oa.call(this,a,b);this.tag=null;if(c=b.tag)if("string"===
typeof c&&(c=[c]),c.length){this.tag=new Map;this.F=[];this.R=[];for(let d=0,f,g;d<c.length;d++){f=c[d];g=f.field||f;if(!g)throw Error("The tag field from the document descriptor is undefined.");f.custom?this.F[d]=f.custom:(this.F[d]=Na(g,this.J),f.filter&&("string"===typeof this.F[d]&&(this.F[d]=new String(this.F[d])),this.F[d].I=f.filter));this.R[d]=g;this.tag.set(g,new Map)}}if(this.worker){a=[];for(const d of this.index.values())d.then&&a.push(d);if(a.length){const d=this;return Promise.all(a).then(function(f){let g=
0;for(const k of d.index.entries()){const h=k[0];k[1].then&&d.index.set(h,f[g++])}return d})}}else a.db&&this.mount(a.db)}t=U.prototype;
...
function Oa(a,b){const c=new Map;let e=b.index||b.field||b;E(e)&&(e=[e]);for(let d=0,f,g;d<e.length;d++){f=e[d];E(f)||(g=f,f=f.field);g=I(g)?Object.assign({},a,g):a;if(this.worker){const k=new O(g);c.set(f,k)}this.worker||c.set(f,new N(g,this.reg));g.custom?this.D[d]=g.custom:(this.D[d]=Na(f,this.J),g.filter&&("string"===typeof this.D[d]&&(this.D[d]=new String(this.D[d])),this.D[d].I=g.filter));this.field[d]=f}if(this.C){a=b.store;E(a)&&(a=[a]);for(let d=0,f,g;d<a.length;d++)f=a[d],g=f.field||f,f.custom?
(this.C[d]=f.custom,f.custom.V=g):(this.C[d]=Na(g,this.J),f.filter&&("string"===typeof this.C[d]&&(this.C[d]=new String(this.C[d])),this.C[d].I=f.filter))}return c}function Na(a,b){const c=a.split(":");let e=0;for(let d=0;d<c.length;d++)a=c[d],"]"===a[a.length-1]&&(a=a.substring(0,a.length-2))&&(b[e]=!0),a&&(c[e++]=a);e<c.length&&(c.length=e);return 1<e?c:c[0]}t.append=function(a,b){return this.add(a,b,!0)};t.update=function(a,b){return this.remove(a).add(a,b)};
...
function $a(a,b,c,e,d){return c&&1<a?b+(e||0)<=a?c+(d||0):(a-1)/(b+(e||0))*(c+(d||0))+1|0:0};N.prototype.search=function(a,b,c){c||(!b&&I(a)?(c=a,a=""):I(b)&&(c=b,b=0));let e=[],d,f,g,k=0,h,l,m,n,p;c?(a=c.query||a,b=c.limit||b,k=c.offset||0,f=c.context,g=c.suggest,p=(h=!1!==c.resolve)&&c.enrich,m=c.boost,n=c.resolution,l=this.db&&c.tag):h=this.resolve;let q=this.encoder.encode(a);d=q.length;b=b||(h?100:0);if(1===d)return bb.call(this,q[0],"",b,k,h,p,l);f=this.depth&&!1!==f;if(2===d&&f&&!g)return bb.call(this,q[0],q[1],b,k,h,p,l);let r=B(),u=0,v;1<d&&f&&(v=q[0],u=1);n||0===n||(n=v?this.U:
this.resolution);if(this.db){if(this.db.search&&(a=this.db.search(this,q,b,k,g,h,p,l),!1!==a))return a;const x=this;return async function(){for(let y,F;u<d;u++){if((F=q[u])&&!r[F]){r[F]=1;y=await cb(x,F,v,0,0,!1,!1);if(y=db(y,e,g,n)){e=y;break}v&&(g&&y&&e.length||(v=F))}g&&v&&u===d-1&&!e.length&&(v="",u=-1,r=B())}return eb(e,n,b,k,g,m,h)}()}for(let x,y;u<d;u++){if((y=q[u])&&!r[y]){r[y]=1;x=cb(this,y,v,0,0,!1,!1);if(x=db(x,e,g,n)){e=x;break}v&&(g&&x&&e.length||(v=y))}g&&v&&u===d-1&&!e.length&&(v="",
u=-1,r=B())}return eb(e,n,b,k,g,m,h)};function eb(a,b,c,e,d,f,g){let k=a.length,h=a;if(1<k)h=za(a,b,c,e,d,f,g);else if(1===k)return g?Ca.call(null,a[0],c,e):new W(a[0]);return g?h:new W(h)}function bb(a,b,c,e,d,f,g){a=cb(this,a,b,c,e,d,f,g);return this.db?a.then(function(k){return d?k||[]:new W(k)}):a&&a.length?d?Ca.call(this,a,c,e):new W(a):d?[]:new W}
function db(a,b,c,e){let d=[];if(a&&a.length){if(a.length<=e){b.push(a);return}for(let f=0,g;f<e;f++)if(g=a[f])d[f]=g;if(d.length){b.push(d);return}}if(!c)return d}function cb(a,b,c,e,d,f,g,k){let h;c&&(h=a.bidirectional&&b>c)&&(h=c,c=b,b=h);if(a.db)return a.db.get(b,c,e,d,f,g,k);a=c?(a=a.ctx.get(c))&&a.get(b):a.map.get(b);return a};N.prototype.remove=function(a,b){const c=this.reg.size&&(this.fastupdate?this.reg.get(a):this.reg.has(a));if(c){if(this.fastupdate)for(let e=0,d;e<c.length;e++){if(d=c[e])if(2>d.length)d.pop();else{const f=d.indexOf(a);f===c.length-1?d.pop():d.splice(f,1)}}else fb(this.map,a),this.depth&&fb(this.ctx,a);b||this.reg.delete(a)}this.db&&(this.commit_task.push({del:a}),this.T&&ab(this));this.cache&&this.cache.remove(a);return this};
function fb(a,b){let c=0;if(a.constructor===Array)for(let e=0,d,f;e<a.length;e++){if((d=a[e])&&d.length)if(f=d.indexOf(b),0<=f){1<d.length?(d.splice(f,1),c++):delete a[e];break}else c++}else for(let e of a.entries()){const d=e[0],f=fb(e[1],b);f?c+=f:a.delete(d)}return c};function N(a,b){if(!this||this.constructor!==N)return new N(a);if(a){var c=E(a)?a:a.preset;c&&(a=Object.assign({},Za[c],a))}else a={};c=a.context;const e=!0===c?{depth:1}:c||{},d=E(a.encoder)?Ya[a.encoder]:a.encode||a.encoder||Qa;this.encoder=d.encode?d:"object"===typeof d?new L(d):{encode:d};this.resolution=a.resolution||9;this.tokenize=c=a.tokenize||"strict";this.depth="strict"===c&&e.depth||0;this.bidirectional=!1!==e.bidirectional;this.fastupdate=!!a.fastupdate;this.score=a.score||null;(c=a.keystore||
...
function hb(a){let b=0;if(a.constructor===Array)for(let c=0,e;c<a.length;c++)(e=a[c])&&(b+=e.length);else for(const c of a){const e=c[0],d=hb(c[1]);d?b+=d:a.delete(e)}return b}t.cleanup=function(){if(!this.fastupdate)return this;hb(this.map);this.depth&&hb(this.ctx);return this};t.searchCache=Pa;
t.export=function(a,b,c=0,e=0){let d,f;switch(e){case 0:d="reg";f=ra(this.reg);break;case 1:d="cfg";f={};break;case 2:d="map";f=na(this.map,this.reg.size);break;case 3:d="ctx";f=pa(this.ctx,this.reg.size);break;default:return}return ta.call(this,a,b,d,f,c,e)};
t.import=function(a,b){if(b)switch("string"===typeof b&&(b=JSON.parse(b)),a=a.split("."),"json"===a[a.length-1]&&a.pop(),a=1<a.length?a[1]:a[0],a){case "reg":this.fastupdate=!1;this.reg=sa(b,this.reg);break;case "map":this.map=oa(b,this.map);break;case "ctx":this.ctx=qa(b,this.ctx)}};
...
m[0];g=m[1];for(const n of g.entries()){g=n[0];k=n[1];h="";for(let p=0,q;p<k.length;p++){q=k[p]||[""];l="";for(let r=0;r<q.length;r++)l+=(l?",":"")+("string"===c?'"'+q[r]+'"':q[r]);l="["+l+"]";h+=(h?",":"")+l}h='new Map([["'+g+'",['+h+"]]])";h='["'+f+'",'+h+"]";d+=(d?",":"")+h}}d="index.ctx=new Map(["+d+"]);";return a?"function inject(index){"+b+e+d+"}":b+e+d};ma(N.prototype);const ib="undefined"!==typeof window&&(window.indexedDB||window.mozIndexedDB||window.webkitIndexedDB||window.msIndexedDB),jb=["map","ctx","tag","reg","cfg"];
function kb(a,b={}){if(!this)return new kb(a,b);"object"===typeof a&&(b=a,a=a.name);a||console.info("Default storage space was used, because a name was not passed.");this.id="flexsearch"+(a?":"+a.toLowerCase().replace(/[^a-z0-9_\-]/g,""):"");this.field=b.field?b.field.toLowerCase().replace(/[^a-z0-9_\-]/g,""):"";this.type=b.type;this.fastupdate=this.support_tag_search=!1;this.db=null;this.h={}}t=kb.prototype;t.mount=function(a){if(!a.encoder)return a.mount(this);a.db=this;return this.open()};
t.open=function(){let a=this;navigator.storage&&navigator.storage.persist();return this.db||new Promise(function(b,c){const e=ib.open(a.id+(a.field?":"+a.field:""),1);e.onupgradeneeded=function(){const d=a.db=this.result;jb.forEach(f=>{d.objectStoreNames.contains(f)||d.createObjectStore(f)})};e.onblocked=function(d){console.error("blocked",d);c()};e.onerror=function(d){console.error(this.error,d);c()};e.onsuccess=function(){a.db=this.result;a.db.onversionchange=function(){a.close()};b(a)}})};
t.close=function(){this.db.close();this.db=null};t.destroy=function(){const a=ib.deleteDatabase(this.id+(this.field?":"+this.field:""));return Z(a)};t.clear=function(){const a=this.db.transaction(jb,"readwrite");for(let b=0;b<jb.length;b++)a.objectStore(jb[b]).clear();return Z(a)};
...
t.transaction=function(a,b,c){let e=this.h[a+":"+b];if(e)return c.call(this,e);let d=this.db.transaction(a,b);this.h[a+":"+b]=e=d.objectStore(a);return new Promise((f,g)=>{d.onerror=k=>{this.h[a+":"+b]=null;d.abort();d=e=null;g(k)};d.oncomplete=k=>{d=e=this.h[a+":"+b]=null;f(k||!0)};return c.call(this,e)})};
...
function lb(a,b,c){const e=a.value;let d,f,g=0;for(let k=0,h;k<e.length;k++){if(h=c?e:e[k]){for(let l=0,m,n;l<b.length;l++)if(n=b[l],m=h.indexOf(f?parseInt(n,10):n),0>m&&!f&&"string"===typeof n&&!isNaN(n)&&(m=h.indexOf(parseInt(n,10)))&&(f=1),0<=m)if(d=1,1<h.length)h.splice(m,1);else{e[k]=[];break}g+=h.length}if(c)break}g?d&&a.update(e):a.delete();a.continue()}
t.remove=function(a){"object"!==typeof a&&(a=[a]);return Promise.all([this.transaction("map","readwrite",function(b){b.openCursor().onsuccess=function(){const c=this.result;c&&lb(c,a)}}),this.transaction("ctx","readwrite",function(b){b.openCursor().onsuccess=function(){const c=this.result;c&&lb(c,a)}}),this.transaction("tag","readwrite",function(b){b.openCursor().onsuccess=function(){const c=this.result;c&&lb(c,a,!0)}}),this.transaction("reg","readwrite",function(b){for(let c=0;c<a.length;c++)b.delete(a[c])})])};
function Z(a){return new Promise((b,c)=>{a.onsuccess=function(){b(this.result)};a.oncomplete=function(){b(this.result)};a.onerror=c;a=null})};export default {Index:N,Charset:Ya,Encoder:L,Document:U,Worker:O,Resolver:W,IndexedDB:kb,Language:{}};

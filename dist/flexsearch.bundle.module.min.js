/**!
 * FlexSearch.js v0.8.147 (Bundle/Module)
...
function Z(a,c){return new Promise((b,e)=>{a.onsuccess=a.oncomplete=function(){c&&c(this.result);c=null;b(this.result)};a.onerror=a.onblocked=e;a=null})};export default {Index:N,Charset:bb,Encoder:ia,Document:U,Worker:P,Resolver:W,IndexedDB:pb,Language:{}};
export const Index=N;export const Charset=bb;export const Encoder=ia;export const Document=U;export const Worker=P;export const Resolver=W;export const IndexedDB=pb;export const Language={};
/**!
 * FlexSearch.js v0.8.117 (Bundle/Module)
...
function nb(a){let b=0;if(a.constructor===Array)for(let c=0,e;c<a.length;c++)(e=a[c])&&(b+=e.length);else for(const c of a){const e=c[0],d=nb(c[1]);d?b+=d:a.delete(e)}return b}t.cleanup=function(){if(!this.fastupdate)return this;nb(this.map);this.depth&&nb(this.ctx);return this};t.searchCache=Ua;

...
h[p]=1}}return f}function Ja(a,b){const c=z(),d=z(),e=[];for(let f=0;f<a.length;f++)c[a[f]]=1;for(let f=0,g;f<b.length;f++){g=b[f];for(let h=0,k;h<g.length;h++)k=g[h],c[k]&&!d[k]&&(d[k]=1,e.push(k))}return e};let T=1;
...
d,f,p.U,b,g,2===e),f&&!1===r&&d.length||(t=x)):(r=await V(p,x),r=Ka(r,d,f,p.resolution,b,g,1===e));if(r)return r;if(f&&q===e-1){let A=d.length;if(!A){if(t){t="";q=-1;continue}return d}if(1===A)return h?R(d[0],b,g):new S(d[0])}}return h?Ia(d,b,g,f):new S(d[0])}()}for(let p,r;q<e;q++){r=a[q];t?(p=V(this,r,t),p=Ka(p,d,f,this.U,b,g,2===e),f&&!1===p&&d.length||(t=r)):(p=V(this,r),p=Ka(p,d,f,this.resolution,b,g,1===e));if(p)return p;if(f&&q===e-1){m=d.length;if(!m){if(t){t="";q=-1;continue}return d}if(1===
m)return h?R(d[0],b,g):new S(d[0])}}return h?Ia(d,b,g,f):new S(d[0])};function U(a,b,c,d,e,f,g){a=V(this,a,b,c,d,e,f,g);return this.db?a.then(function(h){return e?h:h&&h.length?e?R(h,c,d):new S(h):e?[]:new S([])}):a&&a.length?e?R(a,c,d):new S(a):e?[]:new S([])}

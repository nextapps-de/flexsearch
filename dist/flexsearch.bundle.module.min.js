...
e?new K(e):new Map;this.reg=b||(this.fastupdate?e?new K(e):new Map:e?new M(e):new Set);this.R=c.resolution||1;this.rtl=d.rtl||a.rtl||!1;this.cache=(e=a.cache||null)&&new G(e);this.resolve=!1!==a.resolve;if(e=a.db)this.db=e.mount(this);this.T=!1!==a.commit;this.commit_task=[];this.commit_timer=null}u=O.prototype;u.mount=function(a){this.commit_timer&&(clearTimeout(this.commit_timer),this.commit_timer=null);return a.mount(this)};
u.commit=function(a,b){this.commit_timer&&(clearTimeout(this.commit_timer),this.commit_timer=null);return this.db.commit(this,a,b)};function Ca(a){a.commit_timer||(a.commit_timer=setTimeout(function(){a.commit_timer=null;a.db.commit(a,void 0,void 0)},0))}u.clear=function(){this.map.clear();this.ctx.clear();this.reg.clear();this.cache&&this.cache.clear();this.db&&(this.commit_timer&&clearTimeout(this.commit_timer),this.commit_timer=null,this.commit_task=[{clear:!0}]);return this};
u.append=function(a,b){return this.add(a,b,!0)};u.contain=function(a){return this.db?this.db.has(a):this.reg.has(a)};u.update=function(a,b){if(this.async){const c=this,d=this.remove(a);return d.then?d.then(()=>c.add(a,b)):this.add(a,b)}return this.remove(a).add(a,b)};function Ma(a){let b=0;if(a.constructor===Array)for(let c=0,d;c<a.length;c++)(d=a[c])&&(b+=d.length);else for(const c of a){const d=c[0],e=Ma(c[1]);e?b+=e:a.delete(d)}return b}
u.cleanup=function(){if(!this.fastupdate)return this;Ma(this.map);this.depth&&Ma(this.ctx);return this};u.searchCache=ma;
...
function Ya(a,b={}){if(!this)return new Ya(a,b);"object"===typeof a&&(b=a=a.name);a||console.info("Default storage space was used, because a name was not passed.");this.id="flexsearch"+(a?":"+a.toLowerCase().replace(/[^a-z0-9_\-]/g,""):"");this.field=b.field?b.field.toLowerCase().replace(/[^a-z0-9_\-]/g,""):"";this.support_tag_search=!1;this.db=null;this.h={}}u=Ya.prototype;u.mount=function(a){if(a.constructor===Y)return a.mount(this);a.db=this;return this.open()};
...
u.close=function(){this.db.close();this.db=null};u.destroy=function(){this.db&&this.close();return Wa.deleteDatabase(this.id+(this.field?":"+this.field:""))};u.clear=function(){const a=this.db.transaction(Xa,"readwrite");for(let b=0;b<Xa.length;b++)a.objectStore(Xa[b]).clear();return Z(a)};

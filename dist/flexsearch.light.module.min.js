...
null,this.stemmer);this.replacer=u(a.replacer,null,this.replacer);this.minlength=u(a.minlength,1,this.minlength);this.maxlength=u(a.maxlength,1024,this.maxlength);this.rtl=u(a.rtl,!1,this.rtl);if(this.cache=b=u(a.cache,!0,this.cache))this.l=null,this.A="number"===typeof b?b:2E5,this.i=new Map,this.j=new Map,this.o=this.m=128;this.g="";this.s=null;this.h="";this.u=null;if(this.matcher)for(const c of this.matcher.keys())this.g+=(this.g?"|":"")+c;if(this.stemmer)for(const c of this.stemmer.keys())this.h+=
...
r.encode=function(a){if(this.cache&&a.length<=this.m)if(this.l){if(this.i.has(a))return this.i.get(a)}else this.l=setTimeout(G,50,this);this.normalize&&("function"===typeof this.normalize?a=this.normalize(a):a=E?a.normalize("NFKD").replace(E,"").toLowerCase():a.toLowerCase());this.prepare&&(a=this.prepare(a));this.numeric&&3<a.length&&(a=a.replace(B,"$1 $2").replace(C,"$1 $2").replace(A,"$1 "));const d=!(this.dedupe||this.mapper||this.filter||this.matcher||this.stemmer||this.replacer);let b=[],f=
this.split||""===this.split?a.split(this.split):a;for(let g=0,e,h;g<f.length;g++)if((e=h=f[g])&&!(e.length<this.minlength||e.length>this.maxlength))if(d)b.push(e);else if(!this.filter||("function"===typeof this.filter?this.filter(e):!this.filter.has(e))){if(this.cache&&e.length<=this.o)if(this.l){var c=this.j.get(e);if(c||""===c){c&&b.push(c);continue}}else this.l=setTimeout(G,50,this);this.stemmer&&2<e.length&&(this.u||(this.u=new RegExp("(?!^)("+this.h+")$")),c=e,e=e.replace(this.u,k=>this.stemmer.get(k)),
c!==e&&this.filter&&e.length>=this.minlength&&("function"===typeof this.filter?!this.filter(e):this.filter.has(e))&&(e=""));if(e&&(this.mapper||this.dedupe&&1<e.length)){c="";for(let k=0,n="",m,v;k<e.length;k++)m=e.charAt(k),m===n&&this.dedupe||((v=this.mapper&&this.mapper.get(m))||""===v?v===n&&this.dedupe||!(n=v)||(c+=v):c+=n=m);e=c}this.matcher&&1<e.length&&(this.s||(this.s=new RegExp("("+this.g+")","g")),e=e.replace(this.s,k=>this.matcher.get(k)));if(e&&this.replacer)for(c=0;e&&c<this.replacer.length;c+=
2)e=e.replace(this.replacer[c],this.replacer[c+1]);this.cache&&h.length<=this.o&&(this.j.set(h,e),this.j.size>this.A&&(this.j.clear(),this.o=this.o/1.1|0));e&&b.push(e)}this.finalize&&(b=this.finalize(b)||b);this.cache&&a.length<=this.m&&(this.i.set(a,b),this.i.size>this.A&&(this.i.clear(),this.m=this.m/1.1|0));return b};function G(a){a.l=null;a.i.clear();a.j.clear()};function H(a,d,b){if(!a.length)return a;if(1===a.length)return a=a[0],a=b||a.length>d?d?a.slice(b,b+d):a.slice(b):a;let f=[];for(let c=0,g,e;c<a.length;c++)if((g=a[c])&&(e=g.length)){if(b){if(b>=e){b-=e;continue}b<e&&(g=d?g.slice(b,b+d):g.slice(b),e=g.length,b=0)}e>d&&(g=g.slice(0,d),e=d);if(!f.length&&e>=d)return g;f.push(g);d-=e;if(!d)break}return f=1<f.length?[].concat.apply([],f):f[0]};w();I.prototype.remove=function(a,d){const b=this.reg.size&&(this.fastupdate?this.reg.get(a):this.reg.has(a));if(b){if(this.fastupdate)for(let f=0,c;f<b.length;f++){if(c=b[f])if(2>c.length)c.pop();else{const g=c.indexOf(a);g===b.length-1?c.pop():c.splice(g,1)}}else J(this.map,a),this.depth&&J(this.ctx,a);d||this.reg.delete(a)}return this};
function J(a,d){let b=0;var f="undefined"===typeof d;if(a.constructor===Array)for(let c=0,g,e;c<a.length;c++){if((g=a[c])&&g.length)if(f)b++;else if(e=g.indexOf(d),0<=e){1<g.length?(g.splice(e,1),b++):delete a[c];break}else b++}else for(let c of a.entries()){f=c[0];const g=J(c[1],d);g?b+=g:a.delete(f)}return b};const K={memory:{resolution:1},performance:{resolution:3,fastupdate:!0,context:{depth:1,resolution:1}},match:{tokenize:"forward"},score:{resolution:9,context:{depth:2,resolution:3}}};I.prototype.add=function(a,d,b,f){if(d&&(a||0===a)){if(!f&&!b&&this.reg.has(a))return this.update(a,d);d=this.encoder.encode(d);if(f=d.length){const n=w(),m=w(),v=this.depth,D=this.resolution;for(let p=0;p<f;p++){let l=d[this.rtl?f-1-p:p];var c=l.length;if(c&&(v||!m[l])){var g=this.score?this.score(d,l,p,null,0):L(D,f,p),e="";switch(this.tokenize){case "full":if(2<c){for(let q=0,t;q<c;q++)for(g=c;g>q;g--){e=l.substring(q,g);t=this.rtl?c-1-q:q;var h=this.score?this.score(d,l,p,e,t):L(D,f,p,c,t);M(this,
m,e,h,a,b)}break}case "bidirectional":case "reverse":if(1<c){for(h=c-1;0<h;h--){e=l[this.rtl?c-1-h:h]+e;var k=this.score?this.score(d,l,p,e,h):L(D,f,p,c,h);M(this,m,e,k,a,b)}e=""}case "forward":if(1<c){for(h=0;h<c;h++)e+=l[this.rtl?c-1-h:h],M(this,m,e,g,a,b);break}default:if(M(this,m,l,g,a,b),v&&1<f&&p<f-1)for(c=w(),e=this.v,g=l,h=Math.min(v+1,this.rtl?p+1:f-p),c[g]=1,k=1;k<h;k++)if((l=d[this.rtl?f-1-p-k:p+k])&&!c[l]){c[l]=1;const q=this.score?this.score(d,g,p,l,k-1):L(e+(f/2>e?0:1),f,p,h-1,k-1),
t=this.bidirectional&&l>g;M(this,n,t?g:l,q,a,b,t?l:g)}}}}this.fastupdate||this.reg.add(a)}}return this};function M(a,d,b,f,c,g,e){let h=e?a.ctx:a.map,k;if(!d[b]||e&&!(k=d[b])[e])e?(d=k||(d[b]=w()),d[e]=1,(k=h.get(e))?h=k:h.set(e,h=new Map)):d[b]=1,(k=h.get(b))?h=k:h.set(b,h=[]),h=h[f]||(h[f]=[]),g&&h.includes(c)||(h.push(c),a.fastupdate&&((d=a.reg.get(c))?d.push(h):a.reg.set(c,[h])))}function L(a,d,b,f,c){return b&&1<a?d+(f||0)<=a?b+(c||0):(a-1)/(d+(f||0))*(b+(c||0))+1|0:0};I.prototype.search=function(a,d,b){b||(d||"object"!==typeof a?"object"===typeof d&&(b=d,d=0):(b=a,a=""));var f=[],c=0;if(b){a=b.query||a;d=b.limit||d;c=b.offset||0;var g=b.context;var e=b.suggest;var h=!0;var k=b.resolution}else h=!0;a=this.encoder.encode(a);b=a.length;d=d||(h?100:0);if(1===b)return e=c,(c=N(this,a[0],""))&&c.length?H.call(this,c,d,e):[];g=this.depth&&!1!==g;if(2===b&&g&&!e)return e=c,(c=N(this,a[1],a[0]))&&c.length?H.call(this,c,d,e):[];h=w();var n=0;if(g){var m=a[0];n=1}k||0===
k||(k=m?this.v:this.resolution);for(let l,q;n<b;n++){if((q=a[n])&&!h[q]){h[q]=1;l=N(this,q,m);a:{g=l;var v=f,D=e,p=k;let t=[];if(g&&g.length){if(g.length<=p){v.push(g);l=void 0;break a}for(let x=0,y;x<p;x++)if(y=g[x])t[x]=y;if(t.length){v.push(t);l=void 0;break a}}l=D?void 0:t}if(l){f=l;break}m&&(e&&l&&f.length||(m=q))}e&&m&&n===b-1&&!f.length&&(k=this.resolution,m="",n=-1,h=w())}a:{a=f;f=a.length;m=a;if(1<f)b:{f=e;m=a.length;e=[];b=w();for(let l=0,q,t,x,y;l<k;l++)for(n=0;n<m;n++)if(x=a[n],l<x.length&&
(q=x[l]))for(g=0;g<q.length;g++)if(t=q[g],(h=b[t])?b[t]++:(h=0,b[t]=1),y=e[h]||(e[h]=[]),y.push(t),d&&h===m-1&&y.length-c===d){m=c?y.slice(c):y;break b}if(a=e.length)if(f){if(1<e.length)c:for(a=[],k=w(),f=e.length,h=f-1;0<=h;h--){if(b=(f=e[h])&&f.length)for(n=0;n<b;n++)if(m=f[n],!k[m])if(k[m]=1,c)c--;else if(a.push(m),a.length===d)break c}else a=(e=e[0]).length>d||c?e.slice(c,d+c):e;e=a}else{if(a<m){m=[];break b}e=e[a-1];if(d||c)if(e.length>d||c)e=e.slice(c,d+c)}m=e}else if(1===f){d=H.call(null,a[0],
...
r.cleanup=function(){if(!this.fastupdate)return this;J(this.map);this.depth&&J(this.ctx);return this};w();export default {Index:I,Charset:null,Encoder:F,Document:null,Worker:null,Resolver:null,IndexedDB:null,Language:{}};

...
n);m=m?Math.min(m,n):n}a=p;c=a.length}if(!c)return d;r=0;let k;if(1===c)return E.call(this,a[0],"",b,f);if(2===c&&g&&!e)return E.call(this,a[0],a[1],b,f);1<c&&(g?(k=a[0],r=1):9<h&&3<h/m&&a.sort(v));for(let p,q;r<c;r++){q=a[r];k?(p=F(this,q,k),p=H(p,d,e,this.F,b,f,2===c),e&&!1===p&&d.length||(k=q)):(p=F(this,q),p=H(p,d,e,this.resolution,b,f,1===c));if(p)return p;if(e&&r===c-1){g=d.length;if(!g){if(k){k="";r=-1;continue}return d}if(1===g)return C(d[0],b,f)}}return D(d,b,f,e)};

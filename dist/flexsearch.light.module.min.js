...
1),n,p,k-1,l-1),t=this.bidirectional&&m>g;M(this,h,t?g:m,q,a,b,t?m:g)}}}}this.fastupdate||this.reg.add(a)}}return this};function M(a,c,b,e,d,g,f){let k=f?a.ctx:a.map,l;if(!c[b]||f&&!(l=c[b])[f])f?(c=l||(c[b]=x()),c[f]=1,(l=k.get(f))?k=l:k.set(f,k=new Map)):c[b]=1,(l=k.get(b))?k=l:k.set(b,k=[]),k=k[e]||(k[e]=[]),g&&k.includes(d)||(k.push(d),a.fastupdate&&((c=a.reg.get(d))?c.push(k):a.reg.set(d,[k])))}function L(a,c,b,e,d){return b&&1<a?c+(e||0)<=a?b+(d||0):(a-1)/(c+(e||0))*(b+(d||0))+1|0:0};I.prototype.search=function(a,c,b){b||(c||"object"!==typeof a?"object"===typeof c&&(b=c,c=0):(b=a,a=""));var e=[],d=0;if(b){a=b.query||a;c=b.limit||c;d=b.offset||0;var g=b.context;var f=b.suggest;var k=!0;var l=b.resolution}else k=!0;g=this.depth&&!1!==g;a=this.encoder.encode(a,!g);b=a.length;c=c||(k?100:0);if(1===b)return f=d,(d=N(this,a[0],""))&&d.length?H.call(this,d,c,f):[];if(2===b&&g&&!f)return f=d,(d=N(this,a[1],a[0]))&&d.length?H.call(this,d,c,f):[];k=x();var n=0;if(g){var h=a[0];n=1}l||0===
l||(l=h?this.v:this.resolution);for(let m,q;n<b;n++){if((q=a[n])&&!k[q]){k[q]=1;m=N(this,q,h);a:{g=m;var w=e,v=f,p=l;let t=[];if(g&&g.length){if(g.length<=p){w.push(g);m=void 0;break a}for(let y=0,z;y<p;y++)if(z=g[y])t[y]=z;if(t.length){w.push(t);m=void 0;break a}}m=v?void 0:t}if(m){e=m;break}h&&(f&&m&&e.length||(h=q))}f&&h&&n===b-1&&!e.length&&(l=this.resolution,h="",n=-1,k=x())}a:{a=e;e=a.length;h=a;if(1<e)b:{e=f;h=a.length;f=[];b=x();for(let m=0,q,t,y,z;m<l;m++)for(n=0;n<h;n++)if(y=a[n],m<y.length&&
(q=y[m]))for(g=0;g<q.length;g++)if(t=q[g],(k=b[t])?b[t]++:(k=0,b[t]=1),z=f[k]||(f[k]=[]),z.push(t),c&&k===h-1&&z.length-d===c){h=d?z.slice(d):z;break b}if(a=f.length)if(e){if(1<f.length)c:for(a=[],l=x(),e=f.length,k=e-1;0<=k;k--){if(b=(e=f[k])&&e.length)for(n=0;n<b;n++)if(h=e[n],!l[h])if(l[h]=1,d)d--;else if(a.push(h),a.length===c)break c}else a=(f=f[0]).length>c||d?f.slice(d,c+d):f;f=a}else{if(a<h){h=[];break b}f=f[a-1];if(c||d)if(f.length>c||d)f=f.slice(d,c+d)}h=f}else if(1===e){c=H.call(null,a[0],

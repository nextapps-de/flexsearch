...
E.prototype.clear=function(){this.cache.clear();this.g=""};const F={normalize:function(a){return a.toLowerCase()},dedupe:!1};const G={memory:{resolution:1},performance:{resolution:6,fastupdate:!0,context:{depth:1,resolution:3}},match:{tokenize:"forward"},score:{resolution:9,context:{depth:2,resolution:9}}};u();I.prototype.add=function(a,c,b,d){if(c&&(a||0===a)){if(!d&&!b&&this.reg.has(a))return this.update(a,c);c=this.encoder.encode(c);if(d=c.length){const q=u(),p=u(),m=this.depth,r=this.resolution;for(let l=0;l<d;l++){let n=c[this.rtl?d-1-l:l];var e=n.length;if(e&&(m||!p[n])){var g=this.score?this.score(c,n,l,null,0):J(r,d,l),f="";switch(this.tokenize){case "full":if(2<e){for(g=0;g<e;g++)for(var h=e;h>g;h--){f=n.substring(g,h);var k=this.score?this.score(c,n,l,f,g):J(r,d,l,e,g);K(this,p,f,k,a,b)}break}case "reverse":if(1<
e){for(h=e-1;0<h;h--)f=n[h]+f,k=this.score?this.score(c,n,l,f,h):J(r,d,l,e,h),K(this,p,f,k,a,b);f=""}case "forward":if(1<e){for(h=0;h<e;h++)f+=n[h],K(this,p,f,g,a,b);break}default:if(K(this,p,n,g,a,b),m&&1<d&&l<d-1)for(e=u(),f=this.A,g=n,h=Math.min(m+1,d-l),e[g]=1,k=1;k<h;k++)if((n=c[this.rtl?d-1-l-k:l+k])&&!e[n]){e[n]=1;const A=this.score?this.score(c,g,l,n,k):J(f+(d/2>f?0:1),d,l,h-1,k-1),H=this.bidirectional&&n>g;K(this,q,H?g:n,A,a,b,H?n:g)}}}}this.fastupdate||this.reg.add(a)}}return this};
function K(a,c,b,d,e,g,f){let h=f?a.ctx:a.map,k;if(!c[b]||f&&!(k=c[b])[f])f?(c=k||(c[b]=u()),c[f]=1,(k=h.get(f))?h=k:h.set(f,h=new Map)):c[b]=1,(k=h.get(b))?h=k:h.set(b,h=[]),h=h[d]||(h[d]=[]),g&&h.includes(e)||(h.push(e),a.fastupdate&&((c=a.reg.get(e))?c.push(h):a.reg.set(e,[h])))}function J(a,c,b,d,e){return b&&1<a?c+(d||0)<=a?b+(e||0):(a-1)/(c+(d||0))*(b+(e||0))+1|0:0};function L(a,c,b){if(1===a.length)return a=a[0],a=b||a.length>c?c?a.slice(b,b+c):a.slice(b):a;let d=[];for(let e=0,g,f;e<a.length;e++)if((g=a[e])&&(f=g.length)){if(b){if(b>=f){b-=f;continue}b<f&&(g=c?g.slice(b,b+c):g.slice(b),f=g.length,b=0)}if(d.length)f>c&&(g=g.slice(0,c),f=g.length),d.push(g);else{if(f>=c)return f>c&&(g=g.slice(0,c)),g;d=[g]}c-=f;if(!c)break}return d.length?d=1<d.length?[].concat.apply([],d):d[0]:d};I.prototype.search=function(a,c,b){b||(c||"object"!==typeof a?"object"===typeof c&&(b=c,c=0):(b=a,a=""));var d=[],e=0;if(b){a=b.query||a;c=b.limit||c;e=b.offset||0;var g=b.context;var f=b.suggest}a=this.encoder.encode(a);b=a.length;c||(c=100);if(1===b)return M.call(this,a[0],"",c,e);g=this.depth&&!1!==g;if(2===b&&g&&!f)return M.call(this,a[0],a[1],c,e);var h=0,k=0;if(1<b){var q=u();const m=[];for(let r=0,l;r<b;r++)if((l=a[r])&&!q[l]){if(f||N(this,l))m.push(l),q[l]=1;else return d;const n=l.length;
h=Math.max(h,n);k=k?Math.min(k,n):n}a=m;b=a.length}if(!b)return d;q=0;if(1===b)return M.call(this,a[0],"",c,e);if(2===b&&g&&!f)return M.call(this,a[0],a[1],c,e);if(1<b)if(g){var p=a[0];q=1}else 9<h&&3<h/k&&a.sort(v);for(let m,r;q<b;q++){r=a[q];p?(m=N(this,r,p),m=O(m,d,f,this.A),f&&!1===m&&d.length||(p=r)):(m=N(this,r,""),m=O(m,d,f,this.resolution));if(m)return m;if(f&&q===b-1){g=d.length;if(!g){if(p){p="";q=-1;continue}return d}if(1===g)return L(d[0],c,e)}}a:{a=d;d=this.resolution;p=a.length;b=[];
g=u();for(let m=0,r,l,n,A;m<d;m++)for(k=0;k<p;k++)if(n=a[k],m<n.length&&(r=n[m]))for(q=0;q<r.length;q++)l=r[q],(h=g[l])?g[l]++:(h=0,g[l]=1),A=b[h]||(b[h]=[]),A.push(l);if(a=b.length)if(f){if(1<b.length)b:{f=b;a=[];d=u();p=f.length;for(h=p-1;0<=h;h--)for(p=f[h],g=p.length,k=0;k<g;k++)if(b=p[k],!d[b])if(d[b]=1,e)e--;else if(a.push(b),a.length===c){c=a;break b}c=a}else c=b[0];b=c}else{if(a<p){d=[];break a}b=b[a-1];if(c||e)if(b.length>c||e)b=b.slice(e,c+e)}d=b}return d};

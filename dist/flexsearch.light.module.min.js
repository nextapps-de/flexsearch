...
r.searchCache=function(a,c,b){a=("object"===typeof a?""+a.query:a).toLowerCase();this.cache||(this.cache=new I);let f=this.cache.get(a);if(!f){f=this.search(a,c,b);if(f.then){const d=this;f.then(function(g){d.cache.set(a,g);return g})}this.cache.set(a,f)}return f};export default {Index:L,Charset:null,Encoder:F,Document:null,Worker:null,Resolver:null,IndexedDB:null,Language:{}};

...
;R.prototype.search = function(a, b, c, e) {
  ...
  for (let x = 0, p; x < f.length; x++) {
    p = d[x];
    g && p.length && !p[0].doc && p.length && (p = ra.call(this, p));
    if (n) {
      return p;
    }
    d[x] = {field:f[x], result:p};
  }
  return h ? sa(d, b) : q ? ta(d, a, this.index, this.field, this.C, q) : d;
};
  ...
  if (b && (a || 0 === a)) {
    ...
    if (e = b.length) {
      ...
      for (let q = 0; q < e; q++) {
        ...
        var d = n.length;
        if (d && (r || !m[n])) {
          var f = this.score ? this.score(b, n, q, null, 0) : V(t, e, q), g = "";
          switch(this.tokenize) {
            case "full":
              if (2 < d) {
                for (f = 0; f < d; f++) {
                  for (var h = d; h > f; h--) {
                    g = n.substring(f, h);
                    var k = this.score ? this.score(b, n, q, g, f) : V(t, e, q, d, f);
                    W(this, m, g, k, a, c);
                  }
                }
                break;
            ...
            case "reverse":
              if (1 < d) {
                for (h = d - 1; 0 < h; h--) {
                  g = n[h] + g, k = this.score ? this.score(b, n, q, g, h) : V(t, e, q, d, h), W(this, m, g, k, a, c);
                }
                g = "";
              }
            case "forward":
            ...
            default:
              if (W(this, m, n, f, a, c), r && 1 < e && q < e - 1) {
                for (d = C(), g = this.P, f = n, h = Math.min(r + 1, e - q), d[f] = 1, k = 1; k < h; k++) {
                  if ((n = b[this.rtl ? e - 1 - q - k : q + k]) && !d[n]) {
                    d[n] = 1;
                    const u = this.score ? this.score(b, f, q, n, k) : V(g + (e / 2 > g ? 0 : 1), e, q, h - 1, k - 1), v = this.bidirectional && n > f;
                    W(this, l, v ? f : n, u, a, c, v ? n : f);
                  }
                }
              }
          }
...
;U.prototype.search = function(a, b, c) {
  ...
  b || !h || (b = 100);
  if (1 === c) {
    return X.call(this, l[0], "", b, d);
  }
  f = this.depth && !1 !== f;
  if (2 === c && f && !g) {
    return X.call(this, l[0], l[1], b, d);
  }
  let m = h = 0;
  if (1 < c) {
    const t = C(), q = [];
  ...
  for (let t, q; a < c; a++) {
    q = l[a];
    r ? (t = Y(this, q, r), t = Ga(t, e, g, this.P), g && !1 === t && e.length || (r = q)) : (t = Y(this, q, ""), t = Ga(t, e, g, k));
    if (t) {
      return t;
    }
    if (g && a === c - 1) {
...
ia(U.prototype);
const Ja = {Index:U, Charset:Da, Encoder:L, Document:R, Worker:null, Resolver:null, IndexedDB:null, Language:{}}, Z = self;
let Ka;

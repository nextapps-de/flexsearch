...
R.prototype.search = function(a, c, b, e) {
  ...
  for (let x = 0, r, D, F; x < l.length; x++) {
    ...
    if (m && F) {
      v = [];
      z = 0;
      for (let G = 0, H, Ta; G < m.length; G += 2) {
        H = this.tag.get(m[G]);
        if (!H) {
        ...
        if (Ta = (H = H && H.get(m[G + 1])) && H.length) {
          z++, v.push(H);
        } else if (!k) {
          return p ? d : new U(d);
        }
...
;X.prototype.search = function(a, c, b) {
  ...
  c = c || (h ? 100 : 0);
  if (1 === a) {
    return Ra.call(this, b[0], "", c, d, h);
  }
  f = this.depth && !1 !== f;
  if (2 === a && f && !g) {
    return Ra.call(this, b[0], b[1], c, d, h);
  }
  h = C();
  let l = 0;
  if (1 < a && f) {
...
ia(X.prototype);
const Wa = {Index:X, Charset:Pa, Encoder:K, Document:R, Worker:null, Resolver:null, IndexedDB:null, Language:{}}, Xa = self;
let Ya;
(Ya = Xa.define) && Ya.amd ? Ya([], function() {
  return Wa;
}) : "object" === typeof Xa.exports ? Xa.exports = Wa : Xa.FlexSearch = Wa;
}(this||self));

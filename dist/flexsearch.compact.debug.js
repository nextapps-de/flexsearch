...
X.prototype.search = function(a, c, b, f) {
  ...
  return r ? Ha(e) : x ? Da(a, e, this.index, q, x) : e;
};
function Fa(a, c) {
...
;function X(a) {
  ...
  for (let d = 0, e, g; d < f.length; d++) {
    e = f[d], L(e) || (g = e, e = e.field), g = P(g) ? Object.assign({}, a, g) : a, b.set(e, new Z(g, this.reg)), g.custom ? this.D[d] = g.custom : (this.D[d] = Ia(e, this.J), g.filter && ("string" === typeof this.D[d] && (this.D[d] = new String(this.D[d])), this.D[d].I = g.filter)), this.field[d] = e;
  }
  if (this.A) {
    a = c.store;
    L(a) && (a = [a]);
    for (let d = 0, e, g; d < a.length; d++) {
      e = a[d], g = e.field || e, e.custom ? (this.A[d] = e.custom, e.custom.S = g) : (this.A[d] = Ia(g, this.J), e.filter && ("string" === typeof this.A[d] && (this.A[d] = new String(this.A[d])), this.A[d].I = e.filter));
    }
  }
  this.index = b;
  this.tag = null;
  if (b = c.tag) {
    if ("string" === typeof b && (b = [b]), b.length) {
      ...
      for (let d = 0, e, g; d < b.length; d++) {
        ...
        e.custom ? this.B[d] = e.custom : (this.B[d] = Ia(g, this.J), e.filter && ("string" === typeof this.B[d] && (this.B[d] = new String(this.B[d])), this.B[d].I = e.filter));
        this.R[d] = g;
...
ka(Z.prototype);
J();
const Xa = {Index:Z, Charset:Ra, Encoder:S, Document:X, Worker:null, Resolver:null, IndexedDB:null, Language:{}}, Ya = "undefined" !== typeof self ? self : "undefined" !== typeof global ? global : self;
let Za;

...
;function Ca(a, c, b, f, d) {
  ...
  z = new Map();
  for (let ua = 0, T, Ja, aa; ua < c.length; ua++) {
    let ba;
    if (f) {
      ba = c, aa = f;
    } else {
          ...
          for (U = Q = 1;;) {
            ...
            for (let q = 0, F; q < ja.length; q++) {
              ...
              if (K) {
                ...
                F >= u.length - 1 ? va = 1 : F < v.length - 1 && v[F + 1].match ? va = 1 : x && (E += x);
                E -= e.length - 2;
                if (!q || E + l.length <= h) {
                  t[q] = l;
                } else {
...
X.prototype.search = function(a, c, b, f) {
  ...
  for (w = 0; w < g.length; w++) {
    f = e[w];
    d && f.length && "undefined" === typeof f[0].doc && (f = Ga.call(this, f));
    if (r) {
      return x ? Ca(a, f, this.index, r, x) : f;
    }
    e[w] = {field:g[w], result:f};
  }
  return p ? Ha(e) : x ? Ca(a, e, this.index, r, x) : e;
};
function Fa(a, c) {
...
ka(Z.prototype);
J();
const Xa = {Index:Z, Charset:Pa, Encoder:S, Document:X, Worker:null, Resolver:null, IndexedDB:null, Language:{}}, Ya = "undefined" !== typeof self ? self : "undefined" !== typeof global ? global : self;
let Za;

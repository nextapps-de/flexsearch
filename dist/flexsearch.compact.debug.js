...
function ka(a, c) {
  ...
  for (let b = 0, e, d; b < a.length; b++) {
    e = a[b], d = c.get(e[0]), c.set(e[0], ia(e[1], d));
  }
  return c;
}
function la(a) {
  ...
  if (c && (a || 0 === a)) {
    ...
    for (let h = 0, k; h < this.field.length; h++) {
      ...
      if ("function" === typeof k) {
        ...
        if (d = k.I, !d || d(c)) {
          k.constructor === String ? k = ["" + k] : E(k) && (k = [k]), na(c, k, this.J, 0, e, a, k[0], b);
        }
      }
    }
    if (this.tag) {
...
function oa(a, c, b, e, d, f) {
  ...
  if (e === b.length - 1) {
    ...
    if (a.constructor === Array) {
      ...
      c = c[d] || (c[d] = C()), d = b[++e], oa(a, c, b, e, d);
    }
  }
}
function na(a, c, b, e, d, f, g, h) {
  if (a = a[g]) {
    if (e === c.length - 1) {
      if (a.constructor === Array) {
        if (b[e]) {
...
;function pa(a, c, b, e, d) {
  ...
  if (a = g.length) {
    if (d) {
      g = 1 < g.length ? qa(g, b, e) : (g = g[0]).length > b || e ? g.slice(e, b + e) : g;
    } else {
      if (a < f) {
        return [];
      }
...
;function sa(a, c, b, e) {
  ...
  if (1 === a.length) {
    return a = a[0], a = b || a.length > c ? c ? a.slice(b, b + c) : a.slice(b) : a, e ? R.call(this, a) : a;
  }
  let d = [];
...
;T.prototype.or = function() {
  const {O:a, P:c, limit:b, offset:e, enrich:d, resolve:f} = S(this, "or", arguments);
  return ta.call(this, a, c, b, e, d, f);
};
function ta(a, c, b, e, d, f) {
  if (c.length) {
    ...
    return Promise.all(c).then(function(h) {
      ...
      return ta.call(g, a, [], b, e, d, f);
    });
  }
  a.length && (this.result.length && a.push(this.result), 2 > a.length ? this.result = a[0] : (this.result = qa(a, b, e), e = 0));
...
;T.prototype.and = function() {
  ...
  if (a) {
    const {O:f, P:g, limit:h, offset:k, enrich:l, resolve:m, suggest:n} = S(this, "and", arguments);
    return ua.call(this, f, g, h, k, l, m, n);
  }
...
function ua(a, c, b, e, d, f, g) {
  ...
  if (a.length) {
    if (this.result.length && a.unshift(this.result), 2 > a.length) {
      ...
      if (c = aa(a)) {
        return this.result = pa(a, c, b, e, g), f ? d ? R.call(this.index, this.result) : this.result : this;
      }
      this.result = [];
    }
  } else {
...
;T.prototype.xor = function() {
  const {O:a, P:c, limit:b, offset:e, enrich:d, resolve:f, suggest:g} = S(this, "xor", arguments);
  return va.call(this, a, c, b, e, d, f, g);
};
function va(a, c, b, e, d, f, g) {
  ...
  if (a.length) {
    if (this.result.length && a.unshift(this.result), 2 > a.length) {
      ...
      return this.result = wa.call(this, a, b, e, f, this.h), f ? d ? R.call(this.index, this.result) : this.result : this;
    }
  } else {
    g || (this.result = a);
  }
...
;T.prototype.not = function() {
  const {O:a, P:c, limit:b, offset:e, enrich:d, resolve:f, suggest:g} = S(this, "not", arguments);
  return xa.call(this, a, c, b, e, d, f, g);
};
function xa(a, c, b, e, d, f, g) {
  if (c.length) {
    ...
    return Promise.all(c).then(function(k) {
      ...
      return xa.call(h, a, [], b, e, d, f, g);
    });
  }
  if (a.length && this.result.length) {
    this.result = ya.call(this, a, b, e, f);
  } else if (f) {
    return this.resolve(b, e, d);
  }
  return f ? d ? R.call(this.index, this.result) : this.result : this;
}
function ya(a, c, b, e) {
  const d = [];
...
T.prototype.resolve = function(a, c, b) {
  ...
  return e.length ? ("object" === typeof a && (b = a.enrich, c = a.offset, a = a.limit), sa.call(d, e, a || 100, c, b)) : e;
};
C();
Q.prototype.search = function(a, c, b, e) {
      ...
      if (!a) {
        ...
        if (u.length) {
          for (f = 0; f < u.length; f += 2) {
            y = za.call(this, u[f], u[f + 1], c, n, g), d.push({field:u[f], tag:u[f + 1], result:y});
          }
        }
  ...
  for (let x = 0, r, D, F; x < l.length; x++) {
    ...
    if (m && F) {
      v = [];
      z = 0;
      for (let G = 0, H, Oa; G < m.length; G += 2) {
        H = this.tag.get(m[G]);
        if (!H) {
        ...
        if (Oa = (H = H && H.get(m[G + 1])) && H.length) {
          z++, v.push(H);
        } else if (!k) {
          return p ? d : new T(d);
        }
  ...
  for (let x = 0, r; x < f.length; x++) {
    r = d[x];
    g && r.length && !r[0].doc && (r = R.call(this, r));
    if (y) {
      return p ? r : new T(r);
    }
    d[x] = {field:f[x], result:r};
  }
  return h ? Aa(d, c) : q ? Ba(d, a, this.index, this.field, this.C, q) : d;
};
...
;function Q(a) {
  ...
  this.field = [];
  this.J = [];
  this.key = (b = c.key || c.id) && U(b, this.J) || "id";
  ...
  for (let d = 0, f, g; d < e.length; d++) {
    f = e[d], E(f) || (g = f, f = f.field), g = I(g) ? Object.assign({}, a, g) : a, b.set(f, new W(g, this.reg)), g.custom ? this.C[d] = g.custom : (this.C[d] = U(f, this.J), g.filter && ("string" === typeof this.C[d] && (this.C[d] = new String(this.C[d])), this.C[d].I = g.filter)), this.field[d] = f;
  }
  if (this.A) {
    a = c.store;
    E(a) && (a = [a]);
    for (let d = 0, f, g; d < a.length; d++) {
      f = a[d], g = f.field || f, f.custom ? (this.A[d] = f.custom, f.custom.U = g) : (this.A[d] = U(g, this.J), f.filter && ("string" === typeof this.A[d] && (this.A[d] = new String(this.A[d])), this.A[d].I = f.filter));
    }
  }
  this.index = b;
  this.tag = null;
  if (b = c.tag) {
    if ("string" === typeof b && (b = [b]), b.length) {
      ...
      for (let d = 0, f, g; d < b.length; d++) {
        ...
        f.custom ? this.B[d] = f.custom : (this.B[d] = U(g, this.J), f.filter && ("string" === typeof this.B[d] && (this.B[d] = new String(this.B[d])), this.B[d].I = f.filter));
        this.T[d] = g;
...
const Ea = new Map([["b", "p"], ["v", "f"], ["w", "f"], ["z", "s"], ["x", "s"], ["d", "t"], ["n", "m"], ["c", "k"], ["g", "k"], ["j", "k"], ["q", "k"], ["i", "e"], ["y", "e"], ["u", "o"]]);
const Fa = new Map([["ae", "a"], ["oe", "o"], ["sh", "s"], ["kh", "k"], ["th", "t"], ["pf", "f"]]), Ga = [/([^aeo])h(.)/g, "$1$2", /([aeo])h([^aeo]|$)/g, "$1$2", /([^0-9])\1+/g, "$1"];
const Ha = {a:"", e:"", i:"", o:"", u:"", y:"", b:1, f:1, p:1, v:1, c:2, g:2, j:2, k:2, q:2, s:2, x:2, z:2, "\u00df":2, d:3, t:3, l:4, m:5, n:5, r:6};
const Ia = /[\x00-\x7F]+/g;
const Ja = /[\x00-\x7F]+/g;
const Ka = /[\x00-\x7F]+/g;
var La = {LatinExact:{normalize:!1, dedupe:!1}, LatinDefault:Da, LatinSimple:{normalize:!0, dedupe:!0}, LatinBalance:{normalize:!0, dedupe:!0, mapper:Ea}, LatinAdvanced:{normalize:!0, dedupe:!0, mapper:Ea, matcher:Fa, replacer:Ga}, LatinExtra:{normalize:!0, dedupe:!0, mapper:Ea, replacer:Ga.concat([/(?!^)[aeo]/g, ""]), matcher:Fa}, LatinSoundex:{normalize:!0, dedupe:!1, include:{letter:!0}, finalize:function(a) {
  for (let b = 0; b < a.length; b++) {
    var c = a[b];
    let e = c.charAt(0), d = Ha[e];
    for (let f = 1, g; f < c.length && (g = c.charAt(f), "h" === g || "w" === g || !(g = Ha[g]) || g === d || (e += g, d = g, 4 !== e.length)); f++) {
    }
    a[b] = e;
  }
...
W.prototype.add = function(a, c, b, e) {
  if (c && (a || 0 === a)) {
    ...
    if (e = c.length) {
      ...
      for (let p = 0; p < e; p++) {
        ...
        var d = q.length;
        if (d && (n || !m[q])) {
          var f = this.score ? this.score(c, q, p, null, 0) : X(t, e, p), g = "";
          switch(this.tokenize) {
            case "full":
              if (2 < d) {
                for (f = 0; f < d; f++) {
                  for (var h = d; h > f; h--) {
                    g = q.substring(f, h);
                    var k = this.score ? this.score(c, q, p, g, f) : X(t, e, p, d, f);
                    Y(this, m, g, k, a, b);
                  }
                }
                break;
            ...
            case "reverse":
              if (1 < d) {
                for (h = d - 1; 0 < h; h--) {
                  g = q[h] + g, k = this.score ? this.score(c, q, p, g, h) : X(t, e, p, d, h), Y(this, m, g, k, a, b);
                }
                g = "";
              }
            case "forward":
              if (1 < d) {
                for (h = 0; h < d; h++) {
                  g += q[h], Y(this, m, g, f, a, b);
                }
                break;
              }
            default:
              if (Y(this, m, q, f, a, b), n && 1 < e && p < e - 1) {
                for (d = C(), g = this.S, f = q, h = Math.min(n + 1, e - p), d[f] = 1, k = 1; k < h; k++) {
                  if ((q = c[this.rtl ? e - 1 - p - k : p + k]) && !d[q]) {
                    d[q] = 1;
                    const y = this.score ? this.score(c, f, p, q, k) : X(g + (e / 2 > g ? 0 : 1), e, p, h - 1, k - 1), u = this.bidirectional && q > f;
                    Y(this, l, u ? f : q, y, a, b, u ? q : f);
                  }
                }
              }
          }
...
function X(a, c, b, e, d) {
  return b && 1 < a ? c + (e || 0) <= a ? b + (d || 0) : (a - 1) / (c + (e || 0)) * (b + (d || 0)) + 1 | 0 : 0;
}
;W.prototype.search = function(a, c, b) {
  b || (!c && I(a) ? (b = a, a = "") : I(c) && (b = c, c = 0));
  var e = [], d = 0;
  if (b) {
    a = b.query || a;
...
function Na(a, c, b, e, d) {
  a = Pa(this, a, c);
  d = !0;
  return a && a.length ? d ? sa.call(this, a, b, e) : new T(a) : d ? [] : new T();
}
function Pa(a, c, b) {
  let e;
...
;W.prototype.remove = function(a, c) {
  ...
  if (b) {
    if (this.fastupdate) {
      ...
      Qa(this.map, a), this.depth && Qa(this.ctx, a);
    }
    c || this.reg.delete(a);
  }
  this.cache && this.cache.remove(a);
...
;function W(a, c) {
  ...
  b = a.context;
  const e = !0 === b ? {depth:1} : b || {}, d = E(a.encoder) ? La[a.encoder] : a.encode || a.encoder || Da;
...
ha(W.prototype);
const Sa = {Index:W, Charset:La, Encoder:L, Document:Q, Worker:null, Resolver:null, IndexedDB:null, Language:{}}, Z = self;
let Ta;
(Ta = Z.define) && Ta.amd ? Ta([], function() {
  return Sa;
}) : "object" === typeof Z.exports ? Z.exports = Sa : Z.FlexSearch = Sa;
}(this||self));

  ...
  if (b && (a || 0 === a)) {
    ...
    for (let h = 0, k; h < this.field.length; h++) {
      ...
      if ("function" === typeof k) {
        ...
        if (d = k.H, !d || d(b)) {
          k.constructor === String ? k = ["" + k] : E(k) && (k = [k]), na(b, k, this.I, 0, e, a, k[0], c);
        }
      }
    }
    if (this.tag) {
...
function oa(a, b, c, e, d, f) {
  ...
  if (e === c.length - 1) {
    ...
    if (a.constructor === Array) {
      ...
      b = b[d] || (b[d] = C()), d = c[++e], oa(a, b, c, e, d);
    }
  }
}
function na(a, b, c, e, d, f, g, h) {
  if (a = a[g]) {
    if (e === b.length - 1) {
      if (a.constructor === Array) {
        if (c[e]) {
...
;R.prototype.search = function(a, b, c, e) {
    ...
    if (m) {
      ...
      for (let x = 0, q; x < m.length; x++) {
        ...
        if (q.field && q.tag) {
          ...
          w = Object.keys(q);
          for (let D = 0, A, z; D < w.length; D++) {
            if (A = w[D], z = q[A], z.constructor === Array) {
      ...
      if (!a) {
        ...
        if (u.length) {
          for (f = 0; f < u.length; f += 2) {
            n = qa.call(this, u[f], u[f + 1], b, r, g), d.push({field:u[f], tag:u[f + 1], result:n});
          }
        }
  ...
  for (let x = 0, q, D, A; x < l.length; x++) {
    D = l[x];
    let z;
    ...
    if (e) {
      ...
      if (w = z || c, y = this.index.get(D), m && (w.enrich = !1), u) {
        u[x] = y.search(a, b, w);
        w && g && (w.enrich = g);
        continue;
      } else {
        q = y.search(a, b, w), w && g && (w.enrich = g);
      }
    }
    A = q && q.length;
    if (m && A) {
  ...
  if (u) {
    ...
    return Promise.all(u).then(function(q) {
      return q.length ? x.search(a, b, c, q) : q;
    });
  }
  if (!t) {
    return d;
  ...
  u = [];
  for (let x = 0, q; x < f.length; x++) {
    q = d[x];
    g && q.length && !q[0].doc && q.length && (q = ra.call(this, q));
    if (n) {
      return q;
    }
    d[x] = {field:f[x], result:q};
  }
  return h ? sa(d, b) : p ? ta(d, a, this.index, this.field, this.C, p) : d;
};
function ta(a, b, c, e, d, f) {
  let g, h, k;
  for (let m = 0, r, t, p, n, u; m < a.length; m++) {
    r = a[m].result;
    t = a[m].field;
    n = c.get(t);
    p = n.encoder;
...
;function R(a) {
  ...
  this.field = [];
  this.I = [];
  this.key = (c = b.key || b.id) && S(c, this.I) || "id";
  this.reg = (this.fastupdate = !!a.fastupdate) ? new Map() : new Set();
  this.A = (c = b.store || null) && c && !0 !== c && [];
  this.store = c && new Map();
  this.cache = (c = a.cache || null) && new T(c);
  a.cache = !1;
  c = new Map();
  let e = b.index || b.field || b;
  E(e) && (e = [e]);
  for (let d = 0, f, g; d < e.length; d++) {
    f = e[d], E(f) || (g = f, f = f.field), g = H(g) ? Object.assign({}, a, g) : a, c.set(f, new U(g, this.reg)), g.custom ? this.C[d] = g.custom : (this.C[d] = S(f, this.I), g.filter && ("string" === typeof this.C[d] && (this.C[d] = new String(this.C[d])), this.C[d].H = g.filter)), this.field[d] = f;
  }
  if (this.A) {
    a = b.store;
    E(a) && (a = [a]);
    for (let d = 0, f, g; d < a.length; d++) {
      f = a[d], g = f.field || f, f.custom ? (this.A[d] = f.custom, f.custom.S = g) : (this.A[d] = S(g, this.I), f.filter && ("string" === typeof this.A[d] && (this.A[d] = new String(this.A[d])), this.A[d].H = f.filter));
    }
  }
  this.index = c;
  this.tag = null;
  if (c = b.tag) {
    if ("string" === typeof c && (c = [c]), c.length) {
      ...
      for (let d = 0, f, g; d < c.length; d++) {
        ...
        f.custom ? this.B[d] = f.custom : (this.B[d] = S(g, this.I), f.filter && ("string" === typeof this.B[d] && (this.B[d] = new String(this.B[d])), this.B[d].H = f.filter));
        this.R[d] = g;
...
const Ea = {memory:{resolution:1}, performance:{resolution:6, fastupdate:!0, context:{depth:1, resolution:3}}, match:{tokenize:"forward"}, score:{resolution:9, context:{depth:2, resolution:9}}};
C();
U.prototype.add = function(a, b, c, e) {
  if (b && (a || 0 === a)) {
    ...
    if (e = b.length) {
      ...
      for (let p = 0; p < e; p++) {
        let n = b[this.rtl ? e - 1 - p : p];
        var d = n.length;
        if (d && (r || !m[n])) {
          var f = this.score ? this.score(b, n, p, null, 0) : V(t, e, p), g = "";
          switch(this.tokenize) {
            case "full":
              if (2 < d) {
                for (f = 0; f < d; f++) {
                  for (var h = d; h > f; h--) {
                    g = n.substring(f, h);
                    var k = this.score ? this.score(b, n, p, g, f) : V(t, e, p, d, f);
                    W(this, m, g, k, a, c);
                  }
                }
                break;
            ...
            case "reverse":
              if (1 < d) {
                for (h = d - 1; 0 < h; h--) {
                  g = n[h] + g, k = this.score ? this.score(b, n, p, g, h) : V(t, e, p, d, h), W(this, m, g, k, a, c);
                }
                g = "";
              }
            case "forward":
              if (1 < d) {
                for (h = 0; h < d; h++) {
                  g += n[h], W(this, m, g, f, a, c);
                }
                break;
              }
            default:
              if (W(this, m, n, f, a, c), r && 1 < e && p < e - 1) {
                for (d = C(), g = this.P, f = n, h = Math.min(r + 1, e - p), d[f] = 1, k = 1; k < h; k++) {
                  if ((n = b[this.rtl ? e - 1 - p - k : p + k]) && !d[n]) {
                    d[n] = 1;
                    const u = this.score ? this.score(b, f, p, n, k) : V(g + (e / 2 > g ? 0 : 1), e, p, h - 1, k - 1), w = this.bidirectional && n > f;
                    W(this, l, w ? f : n, u, a, c, w ? n : f);
                  }
                }
              }
          }
...
;U.prototype.search = function(a, b, c) {
  ...
  c = this.encoder.encode(a);
  a = c.length;
  b || !h || (b = 100);
  if (1 === a) {
    return X.call(this, c[0], "", b, d);
  }
  f = this.depth && !1 !== f;
  if (2 === a && f && !g) {
    return X.call(this, c[0], c[1], b, d);
  }
  var l = h = 0;
  if (1 < a) {
    var m = C();
  ...
  for (let t, p; m < a; m++) {
    p = c[m];
    r ? (t = Y(this, p, r), t = Ga(t, e, g, this.P), g && !1 === t && e.length || (r = p)) : (t = Y(this, p, ""), t = Ga(t, e, g, k));
    if (t) {
      return t;
    }
    if (g && m === a - 1) {
  ...
  a: {
    ...
    g = [];
    a = C();
    for (let t = 0, p, n, u, w; t < k; t++) {
      for (h = 0; h < f; h++) {
        if (u = e[h], t < u.length && (p = u[t])) {
          for (l = 0; l < p.length; l++) {
            n = p[l], (c = a[n]) ? a[n]++ : (c = 0, a[n] = 1), w = g[c] || (g[c] = []), w.push(n);
          }
        }
      }
    }
    if (k = g.length) {
      if (r) {
        if (1 < g.length) {
          b: {
            for (k = [], e = C(), r = g.length, c = r - 1; 0 <= c; c--) {
              for (r = g[c], a = r.length, h = 0; h < a; h++) {
                if (f = r[h], !e[f]) {
                  if (e[f] = 1, d) {
                    d--;
                  } else {
                    if (k.push(f), k.length === b) {
                      break b;
                    }
                  }
                }
...
;U.prototype.remove = function(a, b) {
  ...
  if (c) {
    if (this.fastupdate) {
      ...
      Ha(this.map, a), this.depth && Ha(this.ctx, a);
    }
    b || this.reg.delete(a);
  }
  this.cache && this.cache.remove(a);
...
;function U(a, b) {
  ...
  if (a) {
    ...
    c && (Ea[c] || console.warn("Preset not found: " + c), a = Object.assign({}, Ea[c], a));
  } else {
    a = {};
  }
  c = a.context;
  const e = !0 === c ? {depth:1} : c || {}, d = E(a.encoder) ? Da[a.encoder] : a.encode || a.encoder || va;
...
v.cleanup = function() {
  ...
  Ia(this.map);
  this.depth && Ia(this.ctx);
  return this;
};
v.searchCache = ua;
v.export = function(a, b, c, e = 0) {
  let d, f;
  switch(e) {
    case 0:
      d = "reg";
...
ia(U.prototype);
const Ja = {Index:U, Charset:Da, Encoder:K, Document:R, Worker:null, Resolver:null, IndexedDB:null, Language:{}}, Z = self;
let Ka;
(Ka = Z.define) && Ka.amd ? Ka([], function() {
  return Ja;
}) : "object" === typeof Z.exports ? Z.exports = Ja : Z.FlexSearch = Ja;
}(this||self));

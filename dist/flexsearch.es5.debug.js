...
function qa(a) {
  this.next = function(b) {
    ka(a.h);
    a.h.A ? b = oa(a, a.h.A.next, b, a.h.J) : (a.h.J(b), b = pa(a));
    return b;
  };
  this.throw = function(b) {
    ka(a.h);
    a.h.A ? b = oa(a, a.h.A["throw"], b, a.h.J) : (la(a.h, b), b = pa(a));
    return b;
  };
...
B("Promise", function(a) {
  ...
  b.prototype.va = function(f) {
    ...
    "function" == typeof h ? this.za(h, f) : this.J(f);
  };
...
;var Ba = /[^\p{L}\p{N}]+/u, Ca = /(\d{3})/g, Da = /(\D)(\d{3})/g, Ea = /(\d{3})(\D)/g, Fa = "".normalize && /[\u0300-\u036f]/g, Ga = !Fa && [["\u00aa", "a"], ["\u00b2", "2"], ["\u00b3", "3"], ["\u00b9", "1"], ["\u00ba", "o"], ["\u00bc", "1\u20444"], ["\u00bd", "1\u20442"], ["\u00be", "3\u20444"], ["\u00e0", "a"], ["\u00e1", "a"], ["\u00e2", "a"], ["\u00e3", "a"], ["\u00e4", "a"], ["\u00e5", "a"], ["\u00e7", "c"], ["\u00e8", "e"], ["\u00e9", "e"], ["\u00ea", "e"], ["\u00eb", "e"], ["\u00ec", "i"], 
...
function M(a) {
  ...
  if (!(this instanceof M)) {
    ...
    return new (c.call(b, M, e.call(d, g)))();
  }
...
M.prototype.encode = function(a) {
  ...
  for (var c = !(this.H || this.K || this.filter || this.N || this.U || this.P), d = [], e = this.split || "" === this.split ? a.split(this.split) : a, g = 0, f = void 0, h = void 0; g < e.length; g++) {
    if ((f = h = e[g]) && !(f.length < this.ka)) {
      if (c) {
        ...
        if (!this.filter || !this.filter.has(f)) {
          ...
          k = void 0;
          this.U && 2 < f.length && (this.J || (this.J = new RegExp("(?!^)(" + this.D + ")$")), f = f.replace(this.J, function(q) {
            return b.U.get(q);
          }), k = 1);
          ...
          if (f && (this.K || this.H && 1 < f.length)) {
            k = "";
            for (var l = 0, m = "", n = void 0, p = void 0; l < f.length; l++) {
              n = f.charAt(l), n === m && this.H || ((p = this.K && this.K.get(n)) || "" === p ? p === m && this.H || !(m = p) || (k += p) : k += m = n);
            }
            f = k;
          }
          if (f && this.P) {
...
function Q(a) {
  ...
  return new Proxy([], {get:function(c, d) {
    ...
    if ("slice" === d) {
      return function(e, g) {
        return Ja(b, e || 0, g || b.length, !1);
      };
    }
    if ("splice" === d) {
      return function(e, g) {
        return Ja(b, e || 0, g || b.length, !0);
      };
    }
    if ("constructor" === d) {
      return Array;
...
function R(a) {
  ...
  this.C = [];
  this.size = 0;
  32 < a ? (this.h = Ka, this.A = BigInt(a)) : (this.h = La, this.A = a);
}
...
function S(a) {
  ...
  this.index = I();
  this.h = [];
  32 < a ? (this.C = Ka, this.A = BigInt(a)) : (this.C = La, this.A = a);
}
...
w.values = S.prototype.values = function Ma() {
  var b, c = this, d, e, g;
  return ra(Ma, function(f) {
    switch(f.h) {
      case 1:
        b = 0;
      case 2:
...
w.keys = S.prototype.keys = function Na() {
  var b, c = this, d, e, g;
  return ra(Na, function(f) {
    switch(f.h) {
      case 1:
        b = 0;
      case 2:
...
w.entries = S.prototype.entries = function Oa() {
  var b, c = this, d, e, g;
  return ra(Oa, function(f) {
    switch(f.h) {
      case 1:
        b = 0;
      case 2:
...
;function Pa(a, b, c, d, e, g, f, h) {
  (d = a(c ? c + "." + d : d, JSON.stringify(f))) && d.then ? d.then(function() {
    b.export(a, b, c, e, g + 1, h);
  }) : b.export(a, b, c, e, g + 1, h);
}
;var Qa = {normalize:function(a) {
  return a.toLowerCase();
}, H:!1};
var Ra = {memory:{resolution:1}, performance:{resolution:6, fastupdate:!0, context:{depth:1, resolution:3}}, match:{tokenize:"forward"}, score:{resolution:9, context:{depth:2, resolution:9}}};
function Sa(a) {
  Ta.call(a, "add");
  Ta.call(a, "append");
  Ta.call(a, "search");
...
T.prototype.add = function(a, b, c, d) {
  if (b && (a || 0 === a)) {
    ...
    if (d = b.length) {
      for (var e = I(), g = I(), f = this.depth, h = this.resolution, k = 0; k < d; k++) {
        ...
        if (m && (f || !g[l])) {
          var n = this.score ? this.score(b, l, k, null, 0) : Ua(h, d, k), p = "";
          switch(this.tokenize) {
            case "full":
              if (2 < m) {
                for (n = 0; n < m; n++) {
                  for (var q = m; q > n; q--) {
                    p = l.substring(n, q);
                    var r = this.score ? this.score(b, l, k, p, n) : Ua(h, d, k, m, n);
                    Va(this, g, p, r, a, c);
                  }
                }
                break;
            ...
            case "reverse":
              if (1 < m) {
                for (q = m - 1; 0 < q; q--) {
                  p = l[q] + p, r = this.score ? this.score(b, l, k, p, q) : Ua(h, d, k, m, q), Va(this, g, p, r, a, c);
                }
                p = "";
              }
            case "forward":
              if (1 < m) {
                for (q = 0; q < m; q++) {
                  p += l[q], Va(this, g, p, n, a, c);
                }
                break;
              }
            default:
              if (Va(this, g, l, n, a, c), f && 1 < d && k < d - 1) {
                for (m = I(), p = this.na, n = l, q = Math.min(f + 1, d - k), r = m[n] = 1; r < q; r++) {
                  if ((l = b[this.rtl ? d - 1 - k - r : k + r]) && !m[l]) {
                    m[l] = 1;
                    var x = this.score ? this.score(b, n, k, l, r) : Ua(p + (d / 2 > p ? 0 : 1), d, k, q - 1, r - 1), u = this.bidirectional && l > n;
                    Va(this, e, u ? n : l, x, a, c, u ? l : n);
                  }
                }
              }
          }
  ...
  this.db && (b || this.X.push({del:a}), this.qa && Wa(this));
  return this;
};
function Va(a, b, c, d, e, g, f) {
  var h = f ? a.M : a.map, k;
  if (!b[c] || !f || !(k = b[c])[f]) {
  ...
  for (var e = [], g = 0, f = void 0, h = void 0; g < a.length; g++) {
    if ((f = a[g]) && (h = f.length)) {
      ...
      if (e.length) {
        ...
        if (h >= b) {
          return h > b && (f = f.slice(0, b)), d ? Xa(f) : f;
        }
        e = [f];
      }
      b -= h;
...
;V.prototype.or = function() {
  ...
  if (c.length) {
    return Promise.all(c).then(function() {
      ...
      a.result = Ya(d, e, g, f, h, a.V);
      return h ? a.result : a;
    });
  }
  this.result.length && (d = [this.result].concat(d));
  this.result = Ya(d, e, g, f, h, a.V);
...
function Ya(a, b, c, d, e, g) {
  ...
  if (2 > a.length) {
    return e ? U(a[0], b, c, d) : a[0];
  }
  d = [];
  for (var f = 0, h = I(), k = Aa(a), l = 0, m; l < k; l++) {
...
;V.prototype.and = function() {
  if (this.result.length) {
    ...
    if (c.length) {
      return Promise.all(c).then(function() {
        d = [a.result].concat(d);
        a.result = Za(d, e, g, f, a.V);
        return f ? a.result : a;
      });
    }
    d = [this.result].concat(d);
    this.result = Za(d, e, g, f, a.V);
...
;V.prototype.I = function() {
  ...
  if (c instanceof Promise) {
    return c.then(function() {
      return a.I.apply(a, b);
    });
  }
  if (c[0] && c[0].index) {
    return this.I.apply(this, c);
  }
  var d = [];
  c = [];
  ...
  if (c.length) {
    return Promise.all(c).then(function() {
      a.result = ab.call(a, d, e);
      return e ? a.result : a;
    });
  }
  this.result = ab.call(this, d, e);
...
V.prototype.resolve = function(a, b, c) {
  bb = 1;
  var d = this.result;
  this.result = this.index = null;
  return d.length ? ("object" === typeof a && (c = a.enrich, b = a.offset, a = a.limit), U(d, a || 100, b, c)) : d;
};
function cb(a, b, c, d) {
...
;var bb = 1;
T.prototype.search = function(a, b, c) {
  ...
  b || !g || (b = 100);
  if (1 === m) {
    return eb.call(this, a[0], "", b, e, g, k, l);
  }
  f = this.depth && !1 !== f;
  if (2 === m && f && !h) {
    return eb.call(this, a[0], a[1], b, e, g, k, l);
  }
  var n = c = 0;
  if (1 < m) {
    for (var p = I(), q = [], r = 0, x = void 0; r < m; r++) {
      if ((x = a[r]) && !p[x]) {
        if (h || this.db || W(this, x)) {
          q.push(x), p[x] = 1;
        } else {
          return g ? d : new V(d);
        }
      ...
      return ta(function(E) {
        switch(E.h) {
          ...
          case 2:
            ...
            D = a[u];
            return t ? F(E, W(v, D, t), 8) : F(E, W(v, D), 7);
          case 7:
            A = E.G;
            A = fb(A, d, h, v.resolution, b, e, 1 === m);
            E.h = 6;
            break;
          case 8:
            A = E.G, A = fb(A, d, h, v.na, b, e, 2 === m), h && !1 === A && d.length || (t = D);
          case 6:
            if (A) {
              return E.return(A);
            }
            if (h && u === m - 1) {
              ...
              if (1 === C) {
                return E.return(g ? U(d[0], b, e) : new V(d[0]));
              }
            }
          case 3:
            u++;
            ...
            break;
          case 4:
            return E.return(g ? cb(d, b, e, h) : new V(d[0]));
        }
      });
    }();
  }
  for (k = f = void 0; u < m; u++) {
    k = a[u];
    t ? (f = W(this, k, t), f = fb(f, d, h, this.na, b, e, 2 === m), h && !1 === f && d.length || (t = k)) : (f = W(this, k), f = fb(f, d, h, this.resolution, b, e, 1 === m));
    if (f) {
      return f;
    }
    if (h && u === m - 1) {
      ...
      if (1 === f) {
        return g ? U(d[0], b, e) : new V(d[0]);
      }
    }
  }
  return g ? cb(d, b, e, h) : new V(d[0]);
};
function eb(a, b, c, d, e, g, f) {
  a = W(this, a, b, c, d, e, g, f);
  return this.db ? a.then(function(h) {
    return e ? h : h && h.length ? e ? U(h, c, d) : new V(h) : e ? [] : new V([]);
  }) : a && a.length ? e ? U(a, c, d) : new V(a) : e ? [] : new V([]);
}
...
;T.prototype.remove = function(a, b) {
  ...
  if (c) {
    if (this.fastupdate) {
      ...
      gb(this.map, a), this.depth && gb(this.M, a);
    }
    b || this.B.delete(a);
  }
  this.db && (this.X.push({del:a}), this.qa && Wa(this));
...
;function T(a, b) {
  ...
  if (a) {
    ...
    c && (Ra[c] || console.warn("Preset not found: " + c), a = Object.assign({}, Ra[c], a));
  } else {
    a = {};
  }
  c = a.context || {};
  var d = a.encode || a.encoder || Qa;
  ...
  return ta(function(l) {
    ...
    switch(d) {
      case "init":
        e = a.options || {};
        (g = e.config) && (e = g);
        (f = a.factory) ? (Function("return " + f)()(self), self._index = new self.FlexSearch.Index(e), delete self.FlexSearch) : self._index = new T(e);
        postMessage({id:a.id});
        break;
      default:
  ...
  if (this.worker) {
    ...
    if (a.config) {
      return new Promise(function(g) {
        ...
        e.worker.postMessage({id:jb, task:"init", factory:c, options:a});
      });
    }
...
lb("remove");
function lb(a) {
  X.prototype[a] = X.prototype[a + "Async"] = function() {
    ...
    d = new Promise(function(g) {
      b.h[++jb] = g;
      b.worker.postMessage({task:a, id:jb, args:c});
    });
    return e ? (d.then(e), this) : d;
  };
}
function kb(a, b, c) {
  return b ? new (require("worker_threads")["Worker"])(__dirname + "/node/node.js") : a ? new window.Worker(URL.createObjectURL(new Blob(["onmessage=" + ib.toString()], {type:"text/javascript"}))) : new window.Worker(J(c) ? c : "worker/worker.js", {type:"module"});
}
;Y.prototype.add = function(a, b, c) {
  K(a) && (b = a, a = za(b, this.key));
  if (b && (a || 0 === a)) {
    if (!c && this.B.has(a)) {
      return this.update(a, b);
    }
    for (var d = 0, e; d < this.field.length; d++) {
      ...
      if ("function" === typeof e) {
        ...
        var f = e.aa;
        if (!f || f(b)) {
          e instanceof String ? e = ["" + e] : J(e) && (e = [e]), mb(b, e, this.da, 0, g, a, e[0], c);
        }
      }
    }
    if (this.tag) {
...
function nb(a, b, c, d, e, g) {
  ...
  if (d === c.length - 1) {
    ...
    if (a.constructor === Array) {
      ...
      b = b[e] || (b[e] = I()), e = c[++d], nb(a, b, c, d, e);
    }
  }
}
...
;Y.prototype.search = function(a, b, c, d) {
          ...
          if (r.length) {
            for (k = 0; k < r.length; k += 2) {
              ...
              if (this.db) {
                ...
                p = ob.call(this, r[k], r[k + 1], b, q, n);
              }
    ...
    if (u = h[x], !this.db || !this.tag || this.T[x]) {
      ...
      if (m && v) {
        ...
        if (this.db && d) {
          ...
          C = 0;
          for (var Db = L = void 0; C < m.length; C += 2) {
            L = this.tag.get(m[C]);
            if (!L) {
            ...
            if (Db = (L = L && L.get(m[C + 1])) && L.length) {
              D++, A.push(L);
            } else if (!p) {
              return e;
            }
  ...
  if (r) {
    ...
    return Promise.all(r).then(function(O) {
      return O.length ? Eb.search(a, b, c, O) : O;
    });
  }
  if (!f) {
    return e;
  ...
  for (p = void 0; q < g.length; q++) {
    p = e[q];
    n && p.length && !p[0].doc && (this.db ? r.push(p = this.index.get(this.field[0]).db.enrich(p)) : p.length && (p = pb.call(this, p)));
    if (k) {
      return p;
    }
...
;function Y(a) {
  ...
  this.field = [];
  this.da = [];
  this.key = (c = b.key || b.id) && rb(c, this.da) || "id";
  ...
  for (var e = 0, g, f = void 0; e < d.length; e++) {
    ...
    this.worker || c.set(g, new T(f, this.B));
    f.Y ? this.T[e] = f.Y : (this.T[e] = rb(g, this.da), f.filter && ("string" === typeof this.T[e] && (this.T[e] = new String(this.T[e])), this.T[e].aa = f.filter));
    this.field[e] = g;
  }
  if (this.L) {
    for (d = b.store, J(d) && (d = [d]), e = 0; e < d.length; e++) {
      g = d[e], f = g.field || g, g.Y ? (this.L[e] = g.Y, g.Y.Aa = f) : (this.L[e] = rb(f, this.da), g.filter && ("string" === typeof this.L[e] && (this.L[e] = new String(this.L[e])), this.L[e].aa = g.filter));
    }
  }
  this.index = c;
  this.tag = null;
  if (c = b.tag) {
    if ("string" === typeof c && (c = [c]), c.length) {
      for (this.tag = new Map(), this.S = [], this.ma = [], b = 0; b < c.length; b++) {
        ...
        d.Y ? this.S[b] = d.Y : (this.S[b] = rb(e, this.da), d.filter && ("string" === typeof this.S[b] && (this.S[b] = new String(this.S[b])), this.S[b].aa = d.filter));
        this.ma[b] = e;
...
w.mount = function(a) {
  ...
  if (this.tag) {
    for (var c = 0, d; c < this.ma.length; c++) {
      ...
      e || (this.index.set(d, e = new T({}, this.B)), b === this.field && (b = b.slice(0)), b.push(d));
...
;var Z = I();
var yb = new Map([["b", "p"], ["v", "f"], ["w", "f"], ["z", "s"], ["x", "s"], ["d", "t"], ["n", "m"], ["c", "k"], ["g", "k"], ["j", "k"], ["q", "k"], ["i", "e"], ["y", "e"], ["u", "o"]]), zb = {normalize:!0, H:!0, K:yb};
var Ab = new Map([["ai", "ei"], ["ae", "a"], ["oe", "o"], ["ue", "u"], ["sh", "s"], ["ch", "c"], ["th", "t"], ["ph", "f"], ["pf", "f"]]), Bb = [/([^aeo])h([aeo$])/g, "$1$2", /([aeo])h([^aeo]|$)/g, "$1$2"], Cb = {normalize:!0, H:!0, K:yb, P:Bb, N:Ab};
var Fb = {normalize:!0, H:!0, K:yb, P:Bb.concat([/(?!^)[aeoy]/g, ""]), N:Ab};
var Gb = {a:"", e:"", i:"", o:"", u:"", y:"", b:1, f:1, p:1, v:1, c:2, g:2, j:2, k:2, q:2, s:2, x:2, z:2, "\u00df":2, d:3, t:3, l:4, m:5, n:5, r:6};
Z["latin:exact"] = {normalize:!1, H:!1};
Z["latin:default"] = Qa;
Z["latin:simple"] = {normalize:!0, H:!0};
Z["latin:balance"] = zb;
Z["latin:advanced"] = Cb;
Z["latin:extra"] = Fb;
Z["latin:soundex"] = {normalize:!0, H:!1, ra:{Ea:!0}, ca:function(a) {
  for (var b = 0; b < a.length; b++) {
    for (var c = a[b], d = c.charAt(0), e = Gb[d], g = 1, f; g < c.length && (f = c.charAt(g), "h" === f || "w" === f || !(f = Gb[f]) || f === e || (d += f, e = f, 4 !== d.length)); g++) {
    }
    a[b] = d;
  }
}};
var Hb = {Index:T, Charset:Z, Encoder:M, Document:Y, Worker:X, Resolver:V, IndexedDB:ub}, Ib = self, Jb;
